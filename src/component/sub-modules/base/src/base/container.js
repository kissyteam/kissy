 ...
 */
KISSY.add('component/base/container', function (S, Controller, createComponent, ContainerRender) {
    ...
    return Controller.extend({
        ...
        'deriveComponent': function (c) {
            return createComponent(c, this);
        },
        ...
        createChild: function (c, childIndex) {
            ...
            contentEl = self.get('view').getChildrenContainerEl();
