...
if (! _$jscoverage['/shim.js']) {
  _$jscoverage['/shim.js'] = {};
...
if (! _$jscoverage['/shim.js'].functionData) {
  ...
  _$jscoverage['/shim.js'].functionData[0] = 0;
  _$jscoverage['/shim.js'].functionData[1] = 0;
  _$jscoverage['/shim.js'].functionData[2] = 0;
}
