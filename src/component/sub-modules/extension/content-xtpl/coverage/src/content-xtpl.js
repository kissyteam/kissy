...
if (! _$jscoverage['/content-xtpl.js']) {
  ...
  _$jscoverage['/content-xtpl.js'].lineData[20] = 0;
  _$jscoverage['/content-xtpl.js'].lineData[21] = 0;
...
if (! _$jscoverage['/content-xtpl.js'].branchData) {
  ...
  _$jscoverage['/content-xtpl.js'].branchData['20'] = [];
  _$jscoverage['/content-xtpl.js'].branchData['20'][1] = new BranchData();
  _$jscoverage['/content-xtpl.js'].branchData['32'] = [];
  _$jscoverage['/content-xtpl.js'].branchData['32'][1] = new BranchData();
}
_$jscoverage['/content-xtpl.js'].branchData['32'][1].init(1348, 29, 'callRet2 && callRet2.isBuffer');
function visit2_32_1(result) {
  _$jscoverage['/content-xtpl.js'].branchData['32'][1].ranCondition(result);
  return result;
}_$jscoverage['/content-xtpl.js'].branchData['20'][1].init(802, 21, '"5.0.0" !== S.version');
function visit1_20_1(result) {
  _$jscoverage['/content-xtpl.js'].branchData['20'][1].ranCondition(result);
  return result;
