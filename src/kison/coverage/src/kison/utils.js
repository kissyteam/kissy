...
if (! _$jscoverage['/kison/utils.js']) {
  ...
  _$jscoverage['/kison/utils.js'].lineData[8] = 0;
...
_$jscoverage['/kison/utils.js'].branchData['76'][1].init(273, 11, 't === false');
function visit158_76_1(result) {
  _$jscoverage['/kison/utils.js'].branchData['76'][1].ranCondition(result);
  return result;
}_$jscoverage['/kison/utils.js'].branchData['72'][2].init(77, 48, 'util.isRegExp(excludeReg) && i.match(excludeReg)');
function visit157_72_2(result) {
  _$jscoverage['/kison/utils.js'].branchData['72'][2].ranCondition(result);
  return result;
}_$jscoverage['/kison/utils.js'].branchData['72'][1].init(63, 62, 'excludeReg && util.isRegExp(excludeReg) && i.match(excludeReg)');
function visit156_72_1(result) {
  _$jscoverage['/kison/utils.js'].branchData['72'][1].ranCondition(result);
  return result;
}_$jscoverage['/kison/utils.js'].branchData['66'][1].init(1245, 23, 'typeof obj === \'object\'');
function visit155_66_1(result) {
...
function visit154_59_1(result) {
  _$jscoverage['/kison/utils.js'].branchData['59'][1].ranCondition(result);
  return result;
}_$jscoverage['/kison/utils.js'].branchData['54'][1].init(793, 17, 'util.isArray(obj)');
function visit153_54_1(result) {
  _$jscoverage['/kison/utils.js'].branchData['54'][1].ranCondition(result);
  return result;
}_$jscoverage['/kison/utils.js'].branchData['48'][1].init(529, 18, 'util.isRegExp(obj)');
function visit152_48_1(result) {
...
KISSY.add(function(S, require) {
  ...
  _$jscoverage['/kison/utils.js'].lineData[8]++;
  ...
  if (visit145_32_1(excludeReg && visit146_33_1((visit147_33_2(typeof excludeReg === 'function')) && visit148_34_1((r = excludeReg(obj)) === false)))) {
    _$jscoverage['/kison/utils.js'].lineData[35]++;
    return false;
  }
  _$jscoverage['/kison/utils.js'].lineData[38]++;
  if (visit149_38_1(r !== undefined)) {
  ...
  if (visit150_44_1(typeof obj === 'string')) {
    ...
    if (visit151_46_1(typeof obj === 'number')) {
      ...
      if (visit152_48_1(util.isRegExp(obj))) {
        ...
        if (visit153_54_1(util.isArray(obj))) {
  ...
  if (visit154_59_1(t !== false)) {
    ...
    sub.push(t);
          ...
          if (visit155_66_1(typeof obj === 'object')) {
            ...
            for (var i in obj) {
              ...
              if (visit156_72_1(excludeReg && visit157_72_2(util.isRegExp(excludeReg) && i.match(excludeReg)))) {
