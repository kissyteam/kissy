 ...
 */
KISSY.add('grid/paggingbar', function (S,UIBase,Component,Bar) {
    ...
    * @memberOf Grid
	*/
	var PaggingBar = UIBase.create(Bar,
	...
	Component.UIStore.setUIConstructorByCssClass('paggingbar', {
