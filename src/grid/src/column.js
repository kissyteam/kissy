 ...
 */
KISSY.add('grid/column',function(S,UIBase,Component,Template){
	...
	* render of column
	*/
	var columnRender = UIBase.create(Component.Render,{
		/**
		* @override
		*/
		renderUI : function(){
     ...
     */
	var column = UIBase.create(Component.Container,
	/**
	...
	Component.UIStore.setUIConstructorByCssClass("grid-hd", {
	...
	requires:['uibase','component','template']
});
