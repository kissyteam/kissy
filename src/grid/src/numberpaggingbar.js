 ...
 */
KISSY.add('grid/numberpaggingbar', function (S,UIBase,Component,PBar,Bar) {
	...
	*/
	var numberPaggingBar = UIBase.create(PBar,{
		/**
	...
	Component.UIStore.setUIConstructorByCssClass('number-paggingbar', {
	...
	return numberPaggingBar;
	 ...
	 requires:['uibase','component','./paggingbar','./bar']
});