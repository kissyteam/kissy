...
describe('create', function () {
    ...
    it('html option works', function () {
        ...
        expect(Dom.children(s).length).toBe(2);
    });
    ...
    it('remove should works', function () {
        ...
        document.body.appendChild(n = Dom.create('<div class="test-remove">' +
            ...
            '</div>'));
        expect(Dom.query('.test-remove').length).toBe(1);
        Dom.remove(n);
        expect(Dom.query('.test-remove').length).toBe(0);
        expect(Dom.query('.test-remove-inner').length).toBe(0);
    });
    ...
    it('outerHtml works', function () {
        ...
        expect(window.outerHTMLTest).toBeUndefined();
        ...
        expect(window.outerHTMLTest).toBe(1);
