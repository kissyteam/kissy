...
_$jscoverage['/ie/attr.js'].branchData['130'][3].init(282, 39, 'nodeType == NodeType.CDATA_SECTION_NODE');
function visit17_130_3(result) {
  _$jscoverage['/ie/attr.js'].branchData['130'][3].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['130'][2].init(248, 30, 'nodeType == NodeType.TEXT_NODE');
function visit16_130_2(result) {
  _$jscoverage['/ie/attr.js'].branchData['130'][2].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['130'][1].init(248, 73, 'nodeType == NodeType.TEXT_NODE || nodeType == NodeType.CDATA_SECTION_NODE');
function visit15_130_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['130'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['126'][1].init(72, 38, 'nodeType === Dom.NodeType.ELEMENT_NODE');
function visit14_126_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['126'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['116'][1].init(498, 1, 'b');
function visit13_116_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['116'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['110'][1].init(302, 7, 'allText');
function visit12_110_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['110'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['106'][1].init(17, 46, 'childNodes[len].nodeType != NodeType.TEXT_NODE');
