...
if (! _$jscoverage['/ie/attr.js']) {
  ...
  _$jscoverage['/ie/attr.js'].lineData[9] = 0;
...
if (! _$jscoverage['/ie/attr.js'].branchData) {
  ...
  _$jscoverage['/ie/attr.js'].branchData['18'] = [];
  _$jscoverage['/ie/attr.js'].branchData['18'][1] = new BranchData();
...
_$jscoverage['/ie/attr.js'].branchData['130'][3].init(291, 40, 'nodeType === NodeType.CDATA_SECTION_NODE');
function visit17_130_3(result) {
  _$jscoverage['/ie/attr.js'].branchData['130'][3].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['130'][2].init(256, 31, 'nodeType === NodeType.TEXT_NODE');
function visit16_130_2(result) {
  _$jscoverage['/ie/attr.js'].branchData['130'][2].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['130'][1].init(256, 75, 'nodeType === NodeType.TEXT_NODE || nodeType === NodeType.CDATA_SECTION_NODE');
...
function visit14_126_1(result) {
  ...
  return result;
}_$jscoverage['/ie/attr.js'].branchData['117'][1].init(515, 1, 'b');
function visit13_117_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['117'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['111'][1].init(313, 7, 'allText');
function visit12_111_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['111'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['107'][1].init(18, 47, 'childNodes[len].nodeType !== NodeType.TEXT_NODE');
...
function visit9_105_1(result) {
  ...
  return result;
}_$jscoverage['/ie/attr.js'].branchData['99'][1].init(3714, 21, 'attrHooks[HREF] || {}');
...
function visit4_38_1(result) {
  ...
  return result;
}_$jscoverage['/ie/attr.js'].branchData['30'][1].init(-1, 30, 'ret.specified || ret.nodeValue');
function visit3_30_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['30'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['28'][1].init(-1, 94, 'ret && (ret.specified || ret.nodeValue)');
function visit2_28_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['28'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/attr.js'].branchData['18'][1].init(349, 14, 'IE_VERSION < 8');
function visit1_18_1(result) {
  _$jscoverage['/ie/attr.js'].branchData['18'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, require) {
  ...
  _$jscoverage['/ie/attr.js'].lineData[9]++;
