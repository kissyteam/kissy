...
if (! _$jscoverage['/ie/style.js']) {
  ...
  _$jscoverage['/ie/style.js'].lineData[5] = 0;
  _$jscoverage['/ie/style.js'].lineData[7] = 0;
  _$jscoverage['/ie/style.js'].lineData[25] = 0;
  ...
  _$jscoverage['/ie/style.js'].lineData[41] = 0;
  _$jscoverage['/ie/style.js'].lineData[42] = 0;
  _$jscoverage['/ie/style.js'].lineData[44] = 0;
  _$jscoverage['/ie/style.js'].lineData[50] = 0;
  _$jscoverage['/ie/style.js'].lineData[59] = 0;
  _$jscoverage['/ie/style.js'].lineData[61] = 0;
  _$jscoverage['/ie/style.js'].lineData[67] = 0;
  _$jscoverage['/ie/style.js'].lineData[71] = 0;
  _$jscoverage['/ie/style.js'].lineData[76] = 0;
  _$jscoverage['/ie/style.js'].lineData[78] = 0;
  _$jscoverage['/ie/style.js'].lineData[82] = 0;
  _$jscoverage['/ie/style.js'].lineData[88] = 0;
...
if (! _$jscoverage['/ie/style.js'].branchData) {
  ...
  _$jscoverage['/ie/style.js'].branchData['11'] = [];
  _$jscoverage['/ie/style.js'].branchData['11'][1] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['30'] = [];
  _$jscoverage['/ie/style.js'].branchData['30'][1] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['42'] = [];
  _$jscoverage['/ie/style.js'].branchData['42'][1] = new BranchData();
  ...
  _$jscoverage['/ie/style.js'].branchData['64'] = [];
  _$jscoverage['/ie/style.js'].branchData['64'][1] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['64'][2] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['64'][3] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['71'] = [];
  _$jscoverage['/ie/style.js'].branchData['71'][1] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['71'][2] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['71'][3] = new BranchData();
  _$jscoverage['/ie/style.js'].branchData['79'] = [];
  _$jscoverage['/ie/style.js'].branchData['79'][1] = new BranchData();
...
_$jscoverage['/ie/style.js'].branchData['170'][1].init(1483, 10, 'ret === \'\'');
...
function visit83_162_1(result) {
  ...
  return result;
}_$jscoverage['/ie/style.js'].branchData['152'][1].init(807, 49, 'Dom._RE_NUM_NO_PX.test(ret) && !RE_POS.test(name)');
...
function visit74_120_1(result) {
  ...
  return result;
}_$jscoverage['/ie/style.js'].branchData['104'][1].init(3860, 13, 'UA[\'ie\'] == 8');
function visit73_104_1(result) {
  _$jscoverage['/ie/style.js'].branchData['104'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['81'][1].init(143, 37, 'currentStyle && !currentStyle[FILTER]');
function visit72_81_1(result) {
  _$jscoverage['/ie/style.js'].branchData['81'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['79'][1].init(56, 181, '!opacity || currentStyle && !currentStyle[FILTER]');
function visit71_79_1(result) {
  _$jscoverage['/ie/style.js'].branchData['79'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['71'][3].init(647, 8, 'val >= 1');
function visit70_71_3(result) {
  _$jscoverage['/ie/style.js'].branchData['71'][3].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['71'][2].init(647, 20, 'val >= 1 || !opacity');
function visit69_71_2(result) {
  _$jscoverage['/ie/style.js'].branchData['71'][2].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['71'][1].init(647, 61, '(val >= 1 || !opacity) && !S.trim(filter.replace(R_ALPHA, \'\'))');
function visit68_71_1(result) {
  _$jscoverage['/ie/style.js'].branchData['71'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['64'][3].init(39, 19, 'style[FILTER] || \'\'');
function visit67_64_3(result) {
  _$jscoverage['/ie/style.js'].branchData['64'][3].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['64'][2].init(16, 36, 'currentStyle && currentStyle[FILTER]');
function visit66_64_2(result) {
  _$jscoverage['/ie/style.js'].branchData['64'][2].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['64'][1].init(227, 59, 'currentStyle && currentStyle[FILTER] || style[FILTER] || \'\'');
function visit65_64_1(result) {
  _$jscoverage['/ie/style.js'].branchData['64'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['51'][1].init(-1, 31, 'computed && elem[CURRENT_STYLE]');
function visit64_51_1(result) {
  _$jscoverage['/ie/style.js'].branchData['51'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['50'][1].init(41, 148, '(computed && elem[CURRENT_STYLE] ? elem[CURRENT_STYLE][FILTER] : elem[STYLE][FILTER]) || \'\'');
function visit63_50_1(result) {
  _$jscoverage['/ie/style.js'].branchData['50'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['42'][1].init(14, 30, 'docElem.style[OPACITY] == null');
function visit62_42_1(result) {
  _$jscoverage['/ie/style.js'].branchData['42'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['30'][1].init(18, 8, 'computed');
function visit61_30_1(result) {
  _$jscoverage['/ie/style.js'].branchData['30'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].branchData['11'][1].init(128, 26, 'doc && doc.documentElement');
function visit60_11_1(result) {
  _$jscoverage['/ie/style.js'].branchData['11'][1].ranCondition(result);
  return result;
}_$jscoverage['/ie/style.js'].lineData[5]++;
KISSY.add('dom/ie/style', function(S, Dom) {
  _$jscoverage['/ie/style.js'].functionData[0]++;
  _$jscoverage['/ie/style.js'].lineData[7]++;
  var cssProps = Dom._cssProps, UA = S.UA, HUNDRED = 100, doc = S.Env.host.document, docElem = visit60_11_1(doc && doc.documentElement), OPACITY = 'opacity', STYLE = 'style', RE_POS = /^(top|right|bottom|left)$/, FILTER = 'filter', CURRENT_STYLE = 'currentStyle', RUNTIME_STYLE = 'runtimeStyle', LEFT = 'left', PX = 'px', cssHooks = Dom._cssHooks, backgroundPosition = 'backgroundPosition', R_OPACITY = /opacity\s*=\s*([^)]*)/, R_ALPHA = /alpha\([^)]*\)/i;
  _$jscoverage['/ie/style.js'].lineData[25]++;
  ...
  _$jscoverage['/ie/style.js'].lineData[41]++;
  try {
    _$jscoverage['/ie/style.js'].lineData[42]++;
    if (visit62_42_1(docElem.style[OPACITY] == null)) {
      _$jscoverage['/ie/style.js'].lineData[44]++;
      cssHooks[OPACITY] = {
  get: function(elem, computed) {
  _$jscoverage['/ie/style.js'].functionData[2]++;
  _$jscoverage['/ie/style.js'].lineData[50]++;
  return R_OPACITY.test(visit63_50_1((visit64_51_1(computed && elem[CURRENT_STYLE]) ? elem[CURRENT_STYLE][FILTER] : elem[STYLE][FILTER]) || '')) ? (parseFloat(RegExp.$1) / HUNDRED) + '' : computed ? '1' : '';
}, 
  set: function(elem, val) {
  _$jscoverage['/ie/style.js'].functionData[3]++;
  _$jscoverage['/ie/style.js'].lineData[59]++;
  val = parseFloat(val);
  _$jscoverage['/ie/style.js'].lineData[61]++;
  var style = elem[STYLE], currentStyle = elem[CURRENT_STYLE], opacity = isNaN(val) ? '' : 'alpha(' + OPACITY + '=' + val * HUNDRED + ')', filter = S.trim(visit65_64_1(visit66_64_2(currentStyle && currentStyle[FILTER]) || visit67_64_3(style[FILTER] || '')));
  _$jscoverage['/ie/style.js'].lineData[67]++;
  style.zoom = 1;
  _$jscoverage['/ie/style.js'].lineData[71]++;
  if (visit68_71_1((visit69_71_2(visit70_71_3(val >= 1) || !opacity)) && !S.trim(filter.replace(R_ALPHA, '')))) {
    _$jscoverage['/ie/style.js'].lineData[76]++;
    style.removeAttribute(FILTER);
    _$jscoverage['/ie/style.js'].lineData[78]++;
    if (visit71_79_1(!opacity || visit72_81_1(currentStyle && !currentStyle[FILTER]))) {
      _$jscoverage['/ie/style.js'].lineData[82]++;
      return;
    }
  }
  _$jscoverage['/ie/style.js'].lineData[88]++;
