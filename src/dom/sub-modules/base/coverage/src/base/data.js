...
function visit227_266_1(result) {
...
function visit226_264_2(result) {
...
function visit225_264_1(result) {
...
function visit217_210_1(result) {
...
function visit216_209_1(result) {
...
function visit213_173_1(result) {
...
function visit212_171_1(result) {
...
KISSY.add(function(S, require) {
  ...
  if (visit215_201_1(S.isPlainObject(name))) {
  ...
  if (visit216_209_1(data === undefined)) {
    _$jscoverage['/base/data.js'].lineData[210]++;
    if (visit217_210_1(elem)) {
      _$jscoverage['/base/data.js'].lineData[211]++;
      if (visit218_211_1(elem.nodeType)) {
    ...
    for (var i = elems.length - 1; visit219_221_1(i >= 0); i--) {
      _$jscoverage['/base/data.js'].lineData[222]++;
      elem = elems[i];
      _$jscoverage['/base/data.js'].lineData[223]++;
      if (visit220_223_1(elem.nodeType)) {
  ...
  for (i = els.length - 1; visit223_261_1(i >= 0); i--) {
    ...
    if (visit224_263_1(elem.nodeType)) {
      _$jscoverage['/base/data.js'].lineData[264]++;
      var descendants = visit225_264_1(visit226_264_2(deep && S.makeArray(elem.getElementsByTagName('*'))) || []);
      _$jscoverage['/base/data.js'].lineData[265]++;
      descendants.push(elem);
      _$jscoverage['/base/data.js'].lineData[266]++;
      for (var j = 0, len = descendants.length; visit227_266_1(j < len); j++) {
