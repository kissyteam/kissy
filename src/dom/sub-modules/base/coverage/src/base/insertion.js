...
function visit260_230_1(result) {
...
function visit259_201_2(result) {
...
function visit258_201_1(result) {
...
function visit257_197_1(result) {
...
function visit256_158_1(result) {
...
function visit255_144_1(result) {
...
function visit254_119_1(result) {
...
function visit253_116_1(result) {
...
function visit252_114_1(result) {
...
function visit251_112_1(result) {
...
function visit250_107_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function isJs(el) {
    ...
    return visit230_18_1(!el.type || R_SCRIPT_TYPE.test(el.type));
  }
  ...
  function evalScript(el) {
    ...
    if (visit240_61_1(el.src)) {
      _$jscoverage['/base/insertion.js'].lineData[62]++;
      S.getScript(el.src);
    } else {
      _$jscoverage['/base/insertion.js'].lineData[64]++;
      var code = S.trim(visit241_64_1(el.text || visit242_64_2(el.textContent || visit243_64_3(el.innerHTML || ''))));
      _$jscoverage['/base/insertion.js'].lineData[65]++;
      if (visit244_65_1(code)) {
  ...
  function insertion(newNodes, refNodes, fn, scripts) {
    ...
    if (visit246_84_1(Dom._fixInsertionChecked)) {
    ...
    if (visit247_98_1((visit248_98_2(!newNodesLength && (visit249_98_3(!scripts || !scripts.length)))) || !refNodesLength)) {
    ...
    if (visit250_107_1(refNodesLength > 1)) {
  ...
  if (visit255_144_1(refNode[PARENT_NODE])) {
  ...
  if (visit256_158_1(refNode[PARENT_NODE])) {
  ...
  if (visit257_197_1(wrappedNodes[0].parentNode)) {
  ...
  while (visit258_201_1((c = wrapperNode.firstChild) && visit259_201_2(c.nodeType === 1))) {
  ...
  if (visit260_230_1(contents.length)) {
