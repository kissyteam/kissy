...
function visit268_230_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['230'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['201'][2].init(378, 16, 'c.nodeType === 1');
function visit267_201_2(result) {
  _$jscoverage['/base/insertion.js'].branchData['201'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['201'][1].init(347, 47, '(c = wrapperNode.firstChild) && c.nodeType === 1');
function visit266_201_1(result) {
...
function visit265_197_1(result) {
...
function visit264_158_1(result) {
...
function visit263_144_1(result) {
...
function visit262_119_1(result) {
...
function visit261_116_1(result) {
...
function visit260_114_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['114'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['112'][1].init(1217, 18, 'i < refNodesLength');
function visit259_112_1(result) {
...
function visit258_107_1(result) {
...
function visit246_45_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['45'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['38'][2].init(22, 37, 'el.nodeType === NodeType.ELEMENT_NODE');
function visit245_38_2(result) {
  _$jscoverage['/base/insertion.js'].branchData['38'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['38'][1].init(22, 160, 'el.nodeType === NodeType.ELEMENT_NODE && !RE_FORM_EL.test(nodeName)');
function visit244_38_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['38'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['34'][1].init(210, 7, 'scripts');
...
function visit242_31_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['31'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['29'][2].init(251, 21, 'nodeName === \'script\'');
function visit241_29_2(result) {
  _$jscoverage['/base/insertion.js'].branchData['29'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['29'][1].init(251, 33, 'nodeName === \'script\' && isJs(el)');
function visit240_29_1(result) {
  _$jscoverage['/base/insertion.js'].branchData['29'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/insertion.js'].branchData['27'][1].init(87, 47, 'el.nodeType === NodeType.DOCUMENT_FRAGMENT_NODE');
function visit239_27_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function isJs(el) {
    ...
    return visit238_18_1(!el.type || R_SCRIPT_TYPE.test(el.type));
  }
  ...
  function evalScript(el) {
    ...
    if (visit248_61_1(el.src)) {
      _$jscoverage['/base/insertion.js'].lineData[62]++;
      S.getScript(el.src);
    } else {
      _$jscoverage['/base/insertion.js'].lineData[64]++;
      var code = S.trim(visit249_64_1(el.text || visit250_64_2(el.textContent || visit251_64_3(el.innerHTML || ''))));
      _$jscoverage['/base/insertion.js'].lineData[65]++;
      if (visit252_65_1(code)) {
  ...
  function insertion(newNodes, refNodes, fn, scripts) {
    ...
    if (visit254_84_1(Dom._fixInsertionChecked)) {
    ...
    if (visit255_98_1((visit256_98_2(!newNodesLength && (visit257_98_3(!scripts || !scripts.length)))) || !refNodesLength)) {
    ...
    if (visit258_107_1(refNodesLength > 1)) {
  ...
  if (visit263_144_1(refNode[PARENT_NODE])) {
  ...
  if (visit264_158_1(refNode[PARENT_NODE])) {
  ...
  if (visit265_197_1(wrappedNodes[0].parentNode)) {
  ...
  while (visit266_201_1((c = wrapperNode.firstChild) && visit267_201_2(c.nodeType === 1))) {
  ...
  if (visit268_230_1(contents.length)) {
