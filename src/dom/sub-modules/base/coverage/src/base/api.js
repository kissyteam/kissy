...
if (! _$jscoverage['/base/api.js']) {
  ...
  _$jscoverage['/base/api.js'].lineData[100] = 0;
...
_$jscoverage['/base/api.js'].branchData['175'][2].init(90, 20, 'scopeName !== \'HTML\'');
function visit19_175_2(result) {
  _$jscoverage['/base/api.js'].branchData['175'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/api.js'].branchData['175'][1].init(77, 33, 'scopeName && scopeName !== \'HTML\'');
function visit18_175_1(result) {
  _$jscoverage['/base/api.js'].branchData['175'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/api.js'].branchData['173'][1].init(207, 5, 'UA.ie');
...
function visit14_161_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['150'][1].init(80, 40, 'elem.nodeType === NodeType.DOCUMENT_NODE');
...
function visit12_144_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['135'][1].init(419, 35, 'doc.defaultView || doc.parentWindow');
function visit11_135_1(result) {
  _$jscoverage['/base/api.js'].branchData['135'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/api.js'].branchData['131'][1].init(284, 39, 'doc.nodeType !== NodeType.DOCUMENT_NODE');
function visit10_131_1(result) {
  _$jscoverage['/base/api.js'].branchData['131'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/api.js'].branchData['125'][1].init(150, 19, 'util.isWindow(elem)');
...
function visit8_119_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['98'][1].init(97, 32, 'UA.ie && Dom.isCustomDomain(win)');
...
function visit6_96_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['86'][1].init(43, 33, 'domain !== (\'[\' + hostname + \']\')');
function visit5_86_1(result) {
  _$jscoverage['/base/api.js'].branchData['86'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/api.js'].branchData['85'][2].init(206, 19, 'domain !== hostname');
...
function visit2_81_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['8'][1].init(52, 16, 'S.Env.host || {}');
...
KISSY.add(function(S, require) {
  ...
  var WINDOW = visit1_8_1(S.Env.host || {}), DOCUMENT = WINDOW.document, UA = require('ua'), RE_NUM = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source, NodeType = {
  ELEMENT_NODE: 1, 
  ATTRIBUTE_NODE: 2, 
  TEXT_NODE: 3, 
  ...
  if (visit7_98_1(UA.ie && Dom.isCustomDomain(win))) {
    _$jscoverage['/base/api.js'].lineData[100]++;
  ...
  if (visit9_125_1(util.isWindow(elem))) {
  ...
  return util.isWindow(elem) ? elem.document : (visit13_150_1(elem.nodeType === NodeType.DOCUMENT_NODE) ? elem : elem.ownerDocument);
}, 
