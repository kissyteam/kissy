...
function visit6_95_1(result) {
  ...
  return result;
}_$jscoverage['/base/api.js'].branchData['85'][1].init(42, 33, 'domain !== (\'[\' + hostname + \']\')');
