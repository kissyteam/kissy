...
if (! _$jscoverage['/base/selector.js']) {
  ...
  _$jscoverage['/base/selector.js'].lineData[297] = 0;
  _$jscoverage['/base/selector.js'].lineData[309] = 0;
...
if (! _$jscoverage['/base/selector.js'].branchData) {
  ...
  _$jscoverage['/base/selector.js'].branchData['163'] = [];
  _$jscoverage['/base/selector.js'].branchData['163'][1] = new BranchData();
  ...
  _$jscoverage['/base/selector.js'].branchData['297'] = [];
  _$jscoverage['/base/selector.js'].branchData['297'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['322'] = [];
  _$jscoverage['/base/selector.js'].branchData['322'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['336'] = [];
  _$jscoverage['/base/selector.js'].branchData['336'][1] = new BranchData();
  ...
  _$jscoverage['/base/selector.js'].branchData['368'][2] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['369'] = [];
  _$jscoverage['/base/selector.js'].branchData['369'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['374'] = [];
  _$jscoverage['/base/selector.js'].branchData['374'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['380'] = [];
  _$jscoverage['/base/selector.js'].branchData['380'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['385'] = [];
  _$jscoverage['/base/selector.js'].branchData['385'][1] = new BranchData();
  ...
  _$jscoverage['/base/selector.js'].branchData['391'][2] = new BranchData();
  ...
  _$jscoverage['/base/selector.js'].branchData['417'] = [];
  _$jscoverage['/base/selector.js'].branchData['417'][1] = new BranchData();
  _$jscoverage['/base/selector.js'].branchData['417'][2] = new BranchData();
}
_$jscoverage['/base/selector.js'].branchData['417'][2].init(101, 64, 'Dom.filter(elements, filter, context).length === elements.length');
function visit394_417_2(result) {
  _$jscoverage['/base/selector.js'].branchData['417'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['417'][1].init(81, 85, 'elements.length && (Dom.filter(elements, filter, context).length === elements.length)');
function visit393_417_1(result) {
  _$jscoverage['/base/selector.js'].branchData['417'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['398'][1].init(1314, 28, 'typeof filter === \'function\'');
function visit392_398_1(result) {
  _$jscoverage['/base/selector.js'].branchData['398'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['393'][1].init(36, 26, 'getAttr(elem, \'id\') === id');
function visit391_393_1(result) {
  _$jscoverage['/base/selector.js'].branchData['393'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['391'][2].init(752, 12, '!tag && !cls');
function visit390_391_2(result) {
  _$jscoverage['/base/selector.js'].branchData['391'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['391'][1].init(746, 18, 'id && !tag && !cls');
function visit389_391_1(result) {
  _$jscoverage['/base/selector.js'].branchData['391'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['389'][1].init(482, 14, 'clsRe && tagRe');
function visit388_389_1(result) {
  _$jscoverage['/base/selector.js'].branchData['389'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['385'][1].init(342, 3, 'cls');
function visit387_385_1(result) {
  _$jscoverage['/base/selector.js'].branchData['385'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['380'][1].init(170, 3, 'tag');
function visit386_380_1(result) {
  _$jscoverage['/base/selector.js'].branchData['380'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['374'][1].init(132, 3, '!id');
function visit385_374_1(result) {
  _$jscoverage['/base/selector.js'].branchData['374'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['369'][1].init(50, 84, '(filter = trim(filter)) && (match = rSimpleSelector.exec(filter))');
function visit384_369_1(result) {
  _$jscoverage['/base/selector.js'].branchData['369'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['368'][2].init(207, 26, 'typeof filter === \'string\'');
function visit383_368_2(result) {
  _$jscoverage['/base/selector.js'].branchData['368'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['368'][1].init(207, 135, 'typeof filter === \'string\' && (filter = trim(filter)) && (match = rSimpleSelector.exec(filter))');
function visit382_368_1(result) {
  _$jscoverage['/base/selector.js'].branchData['368'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['339'][1].init(33, 33, 'elements[i] === elements[i - 1]');
function visit381_339_1(result) {
  _$jscoverage['/base/selector.js'].branchData['339'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['338'][1].init(90, 7, 'i < len');
function visit380_338_1(result) {
  _$jscoverage['/base/selector.js'].branchData['338'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['336'][1].init(126, 12, 'hasDuplicate');
function visit379_336_1(result) {
  _$jscoverage['/base/selector.js'].branchData['336'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['322'][1].init(25, 7, 'a === b');
function visit378_322_1(result) {
  _$jscoverage['/base/selector.js'].branchData['322'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['297'][1].init(24, 35, 'query(selector, context)[0] || null');
function visit377_297_1(result) {
  _$jscoverage['/base/selector.js'].branchData['297'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['264'][1].init(59, 20, 'matches.call(n, str)');
function visit376_264_1(result) {
...
function visit375_262_1(result) {
...
function visit374_235_1(result) {
...
function visit373_224_3(result) {
...
function visit372_224_2(result) {
...
function visit371_224_1(result) {
...
function visit370_217_1(result) {
...
function visit368_212_1(result) {
  _$jscoverage['/base/selector.js'].branchData['212'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['211'][1].init(25, 127, '(className = className.replace(/[\\r\\t\\n]/g, SPACE)) && (SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1');
function visit367_211_1(result) {
  _$jscoverage['/base/selector.js'].branchData['211'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['210'][1].init(149, 153, 'className && (className = className.replace(/[\\r\\t\\n]/g, SPACE)) && (SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1');
function visit366_210_1(result) {
  _$jscoverage['/base/selector.js'].branchData['210'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['209'][1].init(106, 26, 'el && getAttr(el, \'class\')');
function visit365_209_1(result) {
  _$jscoverage['/base/selector.js'].branchData['209'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['191'][1].init(29, 35, 'Dom._contains(contexts[ci], tmp[i])');
function visit364_191_1(result) {
  _$jscoverage['/base/selector.js'].branchData['191'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['190'][1].init(34, 16, 'ci < contextsLen');
function visit363_190_1(result) {
  _$jscoverage['/base/selector.js'].branchData['190'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['189'][1].init(148, 7, 'i < len');
function visit362_189_1(result) {
  _$jscoverage['/base/selector.js'].branchData['189'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['184'][1].init(954, 14, '!simpleContext');
function visit361_184_1(result) {
  _$jscoverage['/base/selector.js'].branchData['184'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['173'][1].init(567, 23, 'isDomNodeList(selector)');
function visit360_173_1(result) {
  _$jscoverage['/base/selector.js'].branchData['173'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['168'][1].init(376, 17, 'isArray(selector)');
function visit359_168_1(result) {
  _$jscoverage['/base/selector.js'].branchData['168'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['165'][1].init(233, 20, 'selector.getDOMNodes');
function visit358_165_1(result) {
  _$jscoverage['/base/selector.js'].branchData['165'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['163'][1].init(131, 40, 'selector.nodeType || selector.setTimeout');
function visit357_163_1(result) {
  _$jscoverage['/base/selector.js'].branchData['163'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['155'][3].init(260, 15, 'contextsLen > 1');
function visit356_155_3(result) {
...
function visit355_155_2(result) {
...
function visit353_151_1(result) {
  _$jscoverage['/base/selector.js'].branchData['151'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['149'][1].init(2322, 4, '!ret');
function visit352_149_1(result) {
  _$jscoverage['/base/selector.js'].branchData['149'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['145'][2].init(1182, 18, 'parents.length > 1');
function visit351_145_2(result) {
  _$jscoverage['/base/selector.js'].branchData['145'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['145'][1].init(1171, 29, 'parents && parents.length > 1');
function visit350_145_1(result) {
  _$jscoverage['/base/selector.js'].branchData['145'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['141'][1].init(557, 15, '!parents.length');
function visit349_141_1(result) {
...
function visit348_134_1(result) {
...
function visit346_124_1(result) {
  _$jscoverage['/base/selector.js'].branchData['124'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['116'][1].init(909, 59, 'isSimpleSelector(selector) && supportGetElementsByClassName');
function visit345_116_1(result) {
  _$jscoverage['/base/selector.js'].branchData['116'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['113'][1].init(761, 27, 'rTagSelector.test(selector)');
function visit344_113_1(result) {
  _$jscoverage['/base/selector.js'].branchData['113'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['109'][1].init(563, 26, 'rIdSelector.test(selector)');
function visit343_109_1(result) {
...
function visit342_108_2(result) {
...
function visit341_108_1(result) {
  ...
  return result;
}_$jscoverage['/base/selector.js'].branchData['105'][1].init(325, 29, 'rTagIdSelector.test(selector)');
function visit340_105_1(result) {
...
function visit339_102_1(result) {
...
function visit338_100_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var doc = S.Env.host.document, docElem = doc.documentElement, matches = visit322_10_1(docElem.matches || visit323_11_1(docElem.webkitMatchesSelector || visit324_12_1(docElem.mozMatchesSelector || visit325_13_1(docElem.oMatchesSelector || docElem.msMatchesSelector)))), supportGetElementsByClassName = 'getElementsByClassName' in doc, isArray = S.isArray, makeArray = S.makeArray, isDomNodeList = Dom.isDomNodeList, SPACE = ' ', push = Array.prototype.push, rClassSelector = /^\.([\w-]+)$/, rIdSelector = /^#([\w-]+)$/, rTagSelector = /^([\w-])+$/, rTagIdSelector = /^([\w-]+)#([\w-]+)$/, rSimpleSelector = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/, trim = S.trim;
  ...
  function queryEach(f) {
    ...
    for (i = 0; visit326_32_1(i < l); i++) {
      _$jscoverage['/base/selector.js'].lineData[33]++;
      if (visit327_33_1(f(self[i], i) === false)) {
  ...
  return visit331_61_1(match && Dom._contains(elem, match)) ? [match] : [];
};
  }
  ...
  function query(selector, context) {
    ...
    var ret, i, el, simpleContext, isSelectorString = visit332_88_1(typeof selector === 'string'), contexts = visit333_89_1(context !== undefined) ? query(context) : visit334_89_2((simpleContext = 1) && [doc]), contextsLen = contexts.length;
    _$jscoverage['/base/selector.js'].lineData[93]++;
    if (visit335_93_1(!selector)) {
      _$jscoverage['/base/selector.js'].lineData[94]++;
      ret = [];
    } else {
      _$jscoverage['/base/selector.js'].lineData[95]++;
      if (visit336_95_1(isSelectorString)) {
        _$jscoverage['/base/selector.js'].lineData[96]++;
        selector = trim(selector);
        _$jscoverage['/base/selector.js'].lineData[98]++;
        if (visit337_98_1(simpleContext)) {
          _$jscoverage['/base/selector.js'].lineData[100]++;
          if (visit338_100_1(selector === 'body')) {
            _$jscoverage['/base/selector.js'].lineData[101]++;
            ret = [doc.body];
          } else {
            _$jscoverage['/base/selector.js'].lineData[102]++;
            if (visit339_102_1(rClassSelector.test(selector) && supportGetElementsByClassName)) {
              ...
              if (visit340_105_1(rTagIdSelector.test(selector))) {
                _$jscoverage['/base/selector.js'].lineData[107]++;
                el = Dom._getElementById(RegExp.$2, doc);
                _$jscoverage['/base/selector.js'].lineData[108]++;
                ret = visit341_108_1(el && visit342_108_2(el.nodeName.toLowerCase() === RegExp.$1)) ? [el] : [];
              } else {
                _$jscoverage['/base/selector.js'].lineData[109]++;
                if (visit343_109_1(rIdSelector.test(selector))) {
                  ...
                  if (visit344_113_1(rTagSelector.test(selector))) {
                    ...
                    if (visit345_116_1(isSimpleSelector(selector) && supportGetElementsByClassName)) {
                      ...
                      for (i = 0 , partsLen = parts.length; visit347_128_1(i < partsLen); i++) {
                        ...
                        if (visit349_141_1(!parents.length)) {
                          _$jscoverage['/base/selector.js'].lineData[142]++;
                          break;
                        }
                      }
                      _$jscoverage['/base/selector.js'].lineData[145]++;
                      ret = visit350_145_1(parents && visit351_145_2(parents.length > 1)) ? Dom.unique(parents) : parents;
                    }
                  }
                }
              }
        ...
        if (visit352_149_1(!ret)) {
          ...
          if (visit354_155_1(visit355_155_2(ret.length > 1) && visit356_155_3(contextsLen > 1))) {
        ...
        if (visit361_184_1(!simpleContext)) {
          ...
          for (i = 0; visit362_189_1(i < len); i++) {
            _$jscoverage['/base/selector.js'].lineData[190]++;
            for (ci = 0; visit363_190_1(ci < contextsLen); ci++) {
              _$jscoverage['/base/selector.js'].lineData[191]++;
              if (visit364_191_1(Dom._contains(contexts[ci], tmp[i]))) {
  ...
  function hasSingleClass(el, cls) {
    ...
    var className = visit365_209_1(el && getAttr(el, 'class'));
    _$jscoverage['/base/selector.js'].lineData[210]++;
    return visit366_210_1(className && visit367_211_1((className = className.replace(/[\r\t\n]/g, SPACE)) && visit368_212_1((SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1)));
  }
  ...
  function getAttr(el, name) {
    ...
    var ret = visit369_216_1(el && el.getAttributeNode(name));
    _$jscoverage['/base/selector.js'].lineData[217]++;
    if (visit370_217_1(ret && ret.specified)) {
  ...
  function isTag(el, value) {
    ...
    return visit371_224_1(visit372_224_2(value === '*') || visit373_224_3(el.nodeName.toLowerCase() === value.toLowerCase()));
  }
  ...
  if (visit374_235_1(!a.compareDocumentPosition || !b.compareDocumentPosition)) {
  ...
  _$jscoverage['/base/selector.js'].lineData[297]++;
  return visit377_297_1(query(selector, context)[0] || null);
}, 
  unique: (function() {
  _$jscoverage['/base/selector.js'].functionData[21]++;
  _$jscoverage['/base/selector.js'].lineData[309]++;
  ...
  if (visit382_368_1(visit383_368_2(typeof filter === 'string') && visit384_369_1((filter = trim(filter)) && (match = rSimpleSelector.exec(filter))))) {
  ...
  return visit391_393_1(getAttr(elem, 'id') === id);
};
      }
    }
  }
  _$jscoverage['/base/selector.js'].lineData[398]++;
  if (visit392_398_1(typeof filter === 'function')) {
  ...
  return visit393_417_1(elements.length && (visit394_417_2(Dom.filter(elements, filter, context).length === elements.length)));
}});
