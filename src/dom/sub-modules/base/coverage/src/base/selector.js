...
function visit394_425_2(result) {
...
function visit393_425_1(result) {
  _$jscoverage['/base/selector.js'].branchData['425'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['406'][1].init(1314, 28, 'typeof filter === \'function\'');
function visit392_406_1(result) {
  _$jscoverage['/base/selector.js'].branchData['406'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['401'][1].init(36, 26, 'getAttr(elem, \'id\') === id');
function visit391_401_1(result) {
  _$jscoverage['/base/selector.js'].branchData['401'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['399'][2].init(752, 12, '!tag && !cls');
function visit390_399_2(result) {
  _$jscoverage['/base/selector.js'].branchData['399'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['399'][1].init(746, 18, 'id && !tag && !cls');
function visit389_399_1(result) {
...
function visit387_393_1(result) {
...
function visit386_388_1(result) {
...
function visit385_382_1(result) {
  _$jscoverage['/base/selector.js'].branchData['382'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['377'][1].init(50, 84, '(filter = trim(filter)) && (match = rSimpleSelector.exec(filter))');
function visit384_377_1(result) {
  _$jscoverage['/base/selector.js'].branchData['377'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['376'][2].init(207, 26, 'typeof filter === \'string\'');
function visit383_376_2(result) {
  _$jscoverage['/base/selector.js'].branchData['376'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['376'][1].init(207, 135, 'typeof filter === \'string\' && (filter = trim(filter)) && (match = rSimpleSelector.exec(filter))');
function visit382_376_1(result) {
...
function visit380_346_1(result) {
...
function visit379_344_1(result) {
  _$jscoverage['/base/selector.js'].branchData['344'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['330'][1].init(25, 7, 'a === b');
function visit378_330_1(result) {
...
function visit377_305_1(result) {
...
function visit376_272_1(result) {
...
function visit375_270_1(result) {
...
function visit374_243_1(result) {
  _$jscoverage['/base/selector.js'].branchData['243'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['232'][3].init(33, 49, 'el.nodeName.toLowerCase() === value.toLowerCase()');
function visit373_232_3(result) {
  _$jscoverage['/base/selector.js'].branchData['232'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['232'][2].init(16, 13, 'value === \'*\'');
function visit372_232_2(result) {
  _$jscoverage['/base/selector.js'].branchData['232'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['232'][1].init(16, 66, 'value === \'*\' || el.nodeName.toLowerCase() === value.toLowerCase()');
function visit371_232_1(result) {
...
function visit369_224_1(result) {
...
function visit367_219_1(result) {
  ...
  return result;
}_$jscoverage['/base/selector.js'].branchData['218'][1].init(92, 153, 'className && (className = className.replace(/[\\r\\t\\n]/g, SPACE)) && (SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1');
function visit366_218_1(result) {
  _$jscoverage['/base/selector.js'].branchData['218'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/selector.js'].branchData['217'][1].init(49, 26, 'el && getAttr(el, \'class\')');
function visit365_217_1(result) {
...
function visit364_200_1(result) {
...
function visit363_199_1(result) {
...
function visit362_198_1(result) {
...
function visit361_193_1(result) {
...
function visit360_187_1(result) {
...
function visit359_179_1(result) {
...
function visit358_173_1(result) {
...
function visit357_169_1(result) {
...
function visit356_160_3(result) {
...
function visit355_160_2(result) {
...
function visit354_160_1(result) {
...
function visit353_156_1(result) {
...
function visit352_154_1(result) {
...
function visit351_150_2(result) {
...
function visit349_146_1(result) {
...
function visit348_139_1(result) {
...
function visit347_133_1(result) {
...
function visit346_129_1(result) {
...
function visit345_122_1(result) {
...
function visit344_118_1(result) {
...
function visit343_113_1(result) {
...
function visit342_110_2(result) {
...
function visit341_110_1(result) {
...
function visit340_108_1(result) {
...
function visit339_104_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function queryEach(f) {
    ...
    for (i = 0; visit326_32_1(i < l); i++) {
      ...
      if (visit327_33_1(f(els[i], i) === false)) {
      ...
      if (visit336_95_1(isSelectorString)) {
        ...
        if (visit337_98_1(simpleContext)) {
          ...
          if (visit338_100_1(selector === 'body')) {
            ...
            if (visit339_104_1(rClassSelector.test(selector) && supportGetElementsByClassName)) {
              ...
              if (visit340_108_1(rTagIdSelector.test(selector))) {
                _$jscoverage['/base/selector.js'].lineData[109]++;
                el = Dom._getElementById(RegExp.$2, doc);
                _$jscoverage['/base/selector.js'].lineData[110]++;
                ret = visit341_110_1(el && visit342_110_2(el.nodeName.toLowerCase() === RegExp.$1)) ? [el] : [];
              } else {
                _$jscoverage['/base/selector.js'].lineData[113]++;
                if (visit343_113_1(rIdSelector.test(selector))) {
                  ...
                  if (visit344_118_1(rTagSelector.test(selector))) {
                    ...
                    if (visit345_122_1(isSimpleSelector(selector) && supportGetElementsByClassName)) {
                      ...
                      for (i = 0 , partsLen = parts.length; visit347_133_1(i < partsLen); i++) {
                        ...
                        if (visit349_146_1(!parents.length)) {
                          _$jscoverage['/base/selector.js'].lineData[147]++;
                          break;
                        }
                      }
                      _$jscoverage['/base/selector.js'].lineData[150]++;
                      ret = visit350_150_1(parents && visit351_150_2(parents.length > 1)) ? Dom.unique(parents) : parents;
                    }
                  }
                }
              }
        ...
        if (visit352_154_1(!ret)) {
          ...
          if (visit354_160_1(visit355_160_2(ret.length > 1) && visit356_160_3(contextsLen > 1))) {
        ...
        if (visit361_193_1(!simpleContext)) {
          ...
          for (i = 0; visit362_198_1(i < len); i++) {
            _$jscoverage['/base/selector.js'].lineData[199]++;
            for (ci = 0; visit363_199_1(ci < contextsLen); ci++) {
              _$jscoverage['/base/selector.js'].lineData[200]++;
              if (visit364_200_1(Dom._contains(contexts[ci], tmp[i]))) {
  ...
  function hasSingleClass(el, cls) {
    ...
    var className = visit365_217_1(el && getAttr(el, 'class'));
    _$jscoverage['/base/selector.js'].lineData[218]++;
    return visit366_218_1(className && visit367_219_1((className = className.replace(/[\r\t\n]/g, SPACE)) && visit368_220_1((SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1)));
  }
  ...
  function getAttr(el, name) {
    ...
    var ret = visit369_224_1(el && el.getAttributeNode(name));
    _$jscoverage['/base/selector.js'].lineData[225]++;
    if (visit370_225_1(ret && ret.specified)) {
  ...
  function isTag(el, value) {
    ...
    return visit371_232_1(visit372_232_2(value === '*') || visit373_232_3(el.nodeName.toLowerCase() === value.toLowerCase()));
  }
  ...
  if (visit374_243_1(!a.compareDocumentPosition || !b.compareDocumentPosition)) {
  ...
  return visit377_305_1(query(selector, context)[0] || null);
}, 
  unique: (function() {
  ...
  if (visit382_376_1(visit383_376_2(typeof filter === 'string') && visit384_377_1((filter = trim(filter)) && (match = rSimpleSelector.exec(filter))))) {
  ...
  return visit391_401_1(getAttr(elem, 'id') === id);
};
      }
    }
  }
  _$jscoverage['/base/selector.js'].lineData[406]++;
  if (visit392_406_1(typeof filter === 'function')) {
  ...
  return visit393_425_1(elements.length && (visit394_425_2(Dom.filter(elements, filter, context).length === elements.length)));
}});
