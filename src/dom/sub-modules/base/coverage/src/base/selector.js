...
function visit388_416_2(result) {
...
function visit387_416_1(result) {
...
function visit386_397_1(result) {
...
function visit385_392_1(result) {
...
function visit384_390_2(result) {
...
function visit383_390_1(result) {
...
function visit382_388_1(result) {
...
function visit381_384_1(result) {
...
function visit380_379_1(result) {
...
function visit379_373_1(result) {
...
function visit378_368_1(result) {
...
function visit377_367_2(result) {
...
function visit376_367_1(result) {
...
function visit375_338_1(result) {
...
function visit374_337_1(result) {
...
function visit373_335_1(result) {
...
function visit372_321_1(result) {
...
function visit371_296_1(result) {
...
function visit370_263_1(result) {
...
function visit369_261_1(result) {
...
function visit368_234_1(result) {
...
function visit367_223_3(result) {
...
function visit366_223_2(result) {
...
function visit365_223_1(result) {
...
function visit363_215_1(result) {
...
function visit362_211_1(result) {
...
function visit361_210_1(result) {
...
function visit360_209_1(result) {
...
function visit359_208_2(result) {
...
function visit358_208_1(result) {
...
function visit357_191_1(result) {
...
function visit356_190_1(result) {
...
function visit354_184_1(result) {
...
function visit353_178_1(result) {
...
function visit352_170_1(result) {
...
function visit351_164_1(result) {
...
function visit350_160_1(result) {
...
function visit349_151_3(result) {
...
function visit348_151_2(result) {
...
function visit347_151_1(result) {
...
function visit346_147_1(result) {
...
function visit345_145_1(result) {
...
function visit344_141_2(result) {
...
function visit343_141_1(result) {
...
function visit342_137_1(result) {
...
function visit341_130_1(result) {
...
function visit340_124_1(result) {
...
function visit339_120_1(result) {
...
function visit338_113_1(result) {
...
function visit337_109_1(result) {
...
function visit336_104_1(result) {
...
function visit335_101_2(result) {
...
function visit334_101_1(result) {
...
KISSY.add('dom/base/selector', function(S, Dom, undefined) {
  ...
  var doc = S.Env.host.document, docElem = doc.documentElement, matches = visit316_9_1(docElem.matches || visit317_10_1(docElem['webkitMatchesSelector'] || visit318_11_1(docElem['mozMatchesSelector'] || visit319_12_1(docElem['oMatchesSelector'] || docElem['msMatchesSelector'])))), supportGetElementsByClassName = 'getElementsByClassName' in doc, isArray = S.isArray, makeArray = S.makeArray, isDomNodeList = Dom.isDomNodeList, SPACE = ' ', push = Array.prototype.push, rClassSelector = /^\.([\w-]+)$/, rIdSelector = /^#([\w-]+)$/, rTagSelector = /^([\w-])+$/, rTagIdSelector = /^([\w-]+)#([\w-]+)$/, rSimpleSelector = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/, trim = S.trim;
  ...
  function query_each(f) {
    ...
    for (i = 0; visit320_31_1(i < l); i++) {
      _$jscoverage['/base/selector.js'].lineData[32]++;
      if (visit321_32_1(f(els[i], i) === false)) {
  ...
  return visit324_52_1(match && Dom._contains(elem, match)) ? [match] : [];
};
  }
  ...
  function query(selector, context) {
    ...
    var ret, i, el, simpleContext, isSelectorString = visit325_79_1(typeof selector == 'string'), contexts = visit326_80_1(context !== undefined) ? query(context) : visit327_80_2((simpleContext = 1) && [doc]), contextsLen = contexts.length;
    _$jscoverage['/base/selector.js'].lineData[84]++;
    if (visit328_84_1(!selector)) {
      _$jscoverage['/base/selector.js'].lineData[85]++;
      ret = [];
    } else {
      _$jscoverage['/base/selector.js'].lineData[86]++;
      if (visit329_86_1(isSelectorString)) {
        _$jscoverage['/base/selector.js'].lineData[87]++;
        selector = trim(selector);
        _$jscoverage['/base/selector.js'].lineData[89]++;
        if (visit330_89_1(simpleContext)) {
          _$jscoverage['/base/selector.js'].lineData[91]++;
          if (visit331_91_1(selector == 'body')) {
            _$jscoverage['/base/selector.js'].lineData[92]++;
            ret = [doc.body];
          } else {
            _$jscoverage['/base/selector.js'].lineData[95]++;
            if (visit332_95_1(rClassSelector.test(selector) && supportGetElementsByClassName)) {
              ...
              if (visit333_99_1(rTagIdSelector.test(selector))) {
                ...
                if (visit336_104_1(rIdSelector.test(selector))) {
                  ...
                  if (visit337_109_1(rTagSelector.test(selector))) {
                    ...
                    if (visit338_113_1(isSimpleSelector(selector) && supportGetElementsByClassName)) {
                      ...
                      for (i = 0 , partsLen = parts.length; visit340_124_1(i < partsLen); i++) {
                        ...
                        if (visit342_137_1(!parents.length)) {
                          _$jscoverage['/base/selector.js'].lineData[138]++;
                          break;
                        }
                      }
                      _$jscoverage['/base/selector.js'].lineData[141]++;
                      ret = visit343_141_1(parents && visit344_141_2(parents.length > 1)) ? Dom.unique(parents) : parents;
                    }
                  }
                }
              }
        ...
        if (visit345_145_1(!ret)) {
          ...
          if (visit347_151_1(visit348_151_2(ret.length > 1) && visit349_151_3(contextsLen > 1))) {
        ...
        if (visit354_184_1(!simpleContext)) {
          ...
          for (i = 0; visit355_189_1(i < len); i++) {
            _$jscoverage['/base/selector.js'].lineData[190]++;
            for (ci = 0; visit356_190_1(ci < contextsLen); ci++) {
              _$jscoverage['/base/selector.js'].lineData[191]++;
              if (visit357_191_1(Dom._contains(contexts[ci], tmp[i]))) {
  ...
  function hasSingleClass(el, cls) {
    ...
    var className = visit358_208_1(el && (visit359_208_2(el.className || getAttr(el, 'class'))));
    _$jscoverage['/base/selector.js'].lineData[209]++;
    return visit360_209_1(className && visit361_210_1((className = className.replace(/[\r\t\n]/g, SPACE)) && visit362_211_1((SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1)));
  }
  ...
  function getAttr(el, name) {
    ...
    var ret = visit363_215_1(el && el.getAttributeNode(name));
    _$jscoverage['/base/selector.js'].lineData[216]++;
    if (visit364_216_1(ret && ret.specified)) {
  ...
  function isTag(el, value) {
    ...
    return visit365_223_1(visit366_223_2(value == '*') || visit367_223_3(el.nodeName.toLowerCase() === value.toLowerCase()));
  }
  ...
  if (visit368_234_1(!a.compareDocumentPosition || !b.compareDocumentPosition)) {
  ...
  return visit371_296_1(query(selector, context)[0] || null);
}, 
  unique: (function() {
  ...
  if (visit376_367_1(visit377_367_2(typeof filter == 'string') && visit378_368_1((filter = trim(filter)) && (match = rSimpleSelector.exec(filter))))) {
  ...
  return visit385_392_1(getAttr(elem, 'id') == id);
};
      }
    }
  }
  _$jscoverage['/base/selector.js'].lineData[397]++;
  if (visit386_397_1(typeof filter === 'function')) {
  ...
  return visit387_416_1(elements.length && (visit388_416_2(Dom.filter(elements, filter, context).length === elements.length)));
}});
