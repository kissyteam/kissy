...
function visit403_418_2(result) {
...
function visit402_418_1(result) {
...
function visit401_399_1(result) {
...
function visit400_394_1(result) {
...
function visit399_392_2(result) {
...
function visit398_392_1(result) {
...
function visit397_390_1(result) {
...
function visit396_386_1(result) {
...
function visit395_381_1(result) {
...
function visit394_375_1(result) {
...
function visit393_370_1(result) {
...
function visit392_369_2(result) {
...
function visit391_369_1(result) {
...
function visit390_340_1(result) {
...
function visit389_339_1(result) {
...
function visit388_337_1(result) {
...
function visit387_323_1(result) {
...
function visit386_298_1(result) {
...
function visit385_264_1(result) {
...
function visit384_262_1(result) {
...
function visit383_235_1(result) {
...
function visit382_224_3(result) {
...
function visit381_224_2(result) {
...
function visit380_224_1(result) {
...
function visit379_217_1(result) {
...
function visit378_216_1(result) {
...
function visit377_212_1(result) {
...
function visit376_211_2(result) {
...
function visit375_211_1(result) {
...
function visit374_210_1(result) {
...
function visit373_192_1(result) {
...
function visit372_191_1(result) {
...
function visit371_190_1(result) {
...
function visit370_185_1(result) {
...
function visit369_174_1(result) {
...
function visit365_155_3(result) {
...
function visit364_155_2(result) {
...
function visit363_155_1(result) {
...
function visit361_149_1(result) {
...
function visit360_145_2(result) {
...
function visit359_145_1(result) {
...
function visit358_141_1(result) {
...
function visit357_134_1(result) {
...
function visit356_128_1(result) {
...
function visit355_124_1(result) {
...
function visit354_116_1(result) {
...
function visit353_113_1(result) {
...
function visit352_109_1(result) {
...
function visit351_108_2(result) {
...
function visit350_108_1(result) {
...
function visit349_105_1(result) {
...
function visit348_102_1(result) {
...
function visit347_100_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var doc = S.Env.host.document, docElem = doc.documentElement, matches = visit331_10_1(docElem.matches || visit332_11_1(docElem.webkitMatchesSelector || visit333_12_1(docElem.mozMatchesSelector || visit334_13_1(docElem.oMatchesSelector || docElem.msMatchesSelector)))), supportGetElementsByClassName = 'getElementsByClassName' in doc, isArray = S.isArray, makeArray = S.makeArray, isDomNodeList = Dom.isDomNodeList, SPACE = ' ', push = Array.prototype.push, rClassSelector = /^\.([\w-]+)$/, rIdSelector = /^#([\w-]+)$/, rTagSelector = /^([\w-])+$/, rTagIdSelector = /^([\w-]+)#([\w-]+)$/, rSimpleSelector = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/, trim = S.trim;
  ...
  function queryEach(f) {
    ...
    for (i = 0; visit335_32_1(i < l); i++) {
      _$jscoverage['/base/selector.js'].lineData[33]++;
      if (visit336_33_1(f(self[i], i) === false)) {
  ...
  return visit340_61_1(match && Dom._contains(elem, match)) ? [match] : [];
};
  }
  ...
  function query(selector, context) {
    ...
    var ret, i, el, simpleContext, isSelectorString = visit341_88_1(typeof selector === 'string'), contexts = visit342_89_1(context !== undefined) ? query(context) : visit343_89_2((simpleContext = 1) && [doc]), contextsLen = contexts.length;
    _$jscoverage['/base/selector.js'].lineData[93]++;
    if (visit344_93_1(!selector)) {
      _$jscoverage['/base/selector.js'].lineData[94]++;
      ret = [];
    } else {
      _$jscoverage['/base/selector.js'].lineData[95]++;
      if (visit345_95_1(isSelectorString)) {
        _$jscoverage['/base/selector.js'].lineData[96]++;
        selector = trim(selector);
        _$jscoverage['/base/selector.js'].lineData[98]++;
        if (visit346_98_1(simpleContext)) {
          _$jscoverage['/base/selector.js'].lineData[100]++;
          if (visit347_100_1(selector === 'body')) {
            _$jscoverage['/base/selector.js'].lineData[101]++;
            ret = [doc.body];
          } else {
            _$jscoverage['/base/selector.js'].lineData[102]++;
            if (visit348_102_1(rClassSelector.test(selector) && supportGetElementsByClassName)) {
              ...
              if (visit349_105_1(rTagIdSelector.test(selector))) {
                _$jscoverage['/base/selector.js'].lineData[107]++;
                el = Dom._getElementById(RegExp.$2, doc);
                _$jscoverage['/base/selector.js'].lineData[108]++;
                ret = visit350_108_1(el && visit351_108_2(el.nodeName.toLowerCase() === RegExp.$1)) ? [el] : [];
              } else {
                _$jscoverage['/base/selector.js'].lineData[109]++;
                if (visit352_109_1(rIdSelector.test(selector))) {
                  ...
                  if (visit353_113_1(rTagSelector.test(selector))) {
                    ...
                    if (visit354_116_1(isSimpleSelector(selector) && supportGetElementsByClassName)) {
                      ...
                      for (i = 0 , partsLen = parts.length; visit356_128_1(i < partsLen); i++) {
                        ...
                        if (visit358_141_1(!parents.length)) {
                          _$jscoverage['/base/selector.js'].lineData[142]++;
                          break;
                        }
                      }
                      _$jscoverage['/base/selector.js'].lineData[145]++;
                      ret = visit359_145_1(parents && visit360_145_2(parents.length > 1)) ? Dom.unique(parents) : parents;
                    }
                  }
                }
              }
        ...
        if (visit361_149_1(!ret)) {
          ...
          if (visit363_155_1(visit364_155_2(ret.length > 1) && visit365_155_3(contextsLen > 1))) {
        ...
        if (visit370_185_1(!simpleContext)) {
          ...
          for (i = 0; visit371_190_1(i < len); i++) {
            _$jscoverage['/base/selector.js'].lineData[191]++;
            for (ci = 0; visit372_191_1(ci < contextsLen); ci++) {
              _$jscoverage['/base/selector.js'].lineData[192]++;
              if (visit373_192_1(Dom._contains(contexts[ci], tmp[i]))) {
  ...
  function hasSingleClass(el, cls) {
    ...
    var className = visit374_210_1(el && getAttr(el, 'class'));
    _$jscoverage['/base/selector.js'].lineData[211]++;
    return visit375_211_1(className && visit376_211_2((className = className.replace(/[\r\t\n]/g, SPACE)) && visit377_212_1((SPACE + className + SPACE).indexOf(SPACE + cls + SPACE) > -1)));
  }
  ...
  function getAttr(el, name) {
    ...
    var ret = visit378_216_1(el && el.getAttributeNode(name));
    _$jscoverage['/base/selector.js'].lineData[217]++;
    if (visit379_217_1(ret && ret.specified)) {
  ...
  function isTag(el, value) {
    ...
    return visit380_224_1(visit381_224_2(value === '*') || visit382_224_3(el.nodeName.toLowerCase() === value.toLowerCase()));
  }
  ...
  if (visit383_235_1(!a.compareDocumentPosition || !b.compareDocumentPosition)) {
  ...
  return visit386_298_1(query(selector, context)[0] || null);
}, 
  unique: (function() {
  ...
  if (visit391_369_1(visit392_369_2(typeof filter === 'string') && visit393_370_1((filter = trim(filter)) && (match = rSimpleSelector.exec(filter))))) {
  ...
  return visit400_394_1(getAttr(elem, 'id') === id);
};
      }
    }
  }
  _$jscoverage['/base/selector.js'].lineData[399]++;
  if (visit401_399_1(typeof filter === 'function')) {
  ...
  return visit402_418_1(elements.length && (visit403_418_2(Dom.filter(elements, filter, context).length === elements.length)));
}});
