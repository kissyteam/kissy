...
function visit4_31_1(result) {
  ...
  return result;
}_$jscoverage['/cookie.js'].branchData['14'][3].init(46, 10, 'val !== \'\'');
function visit3_14_3(result) {
  _$jscoverage['/cookie.js'].branchData['14'][3].ranCondition(result);
  return result;
}_$jscoverage['/cookie.js'].branchData['14'][2].init(18, 23, 'typeof val === \'string\'');
function visit2_14_2(result) {
  _$jscoverage['/cookie.js'].branchData['14'][2].ranCondition(result);
  return result;
}_$jscoverage['/cookie.js'].branchData['14'][1].init(18, 38, '(typeof val === \'string\') && val !== \'\'');
