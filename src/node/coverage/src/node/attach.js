...
KISSY.add(function(S, require) {
  ...
  function accessNorm(fn, self, args) {
    ...
    if (visit18_111_1(ret === undefined)) {
  ...
  function accessNormIf(fn, self, index, args) {
    ...
    if (visit21_130_1(visit22_130_2(args[index] === undefined) && !S.isObject(args[0]))) {
