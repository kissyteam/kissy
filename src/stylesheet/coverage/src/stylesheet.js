...
if (! _$jscoverage['/stylesheet.js']) {
  ...
  _$jscoverage['/stylesheet.js'].lineData[173] = 0;
  ...
  _$jscoverage['/stylesheet.js'].lineData[182] = 0;
  ...
  _$jscoverage['/stylesheet.js'].lineData[189] = 0;
  _$jscoverage['/stylesheet.js'].lineData[190] = 0;
  ...
  _$jscoverage['/stylesheet.js'].lineData[199] = 0;
}
...
if (! _$jscoverage['/stylesheet.js'].branchData) {
  ...
  _$jscoverage['/stylesheet.js'].branchData['176'] = [];
  _$jscoverage['/stylesheet.js'].branchData['176'][1] = new BranchData();
  _$jscoverage['/stylesheet.js'].branchData['182'] = [];
  _$jscoverage['/stylesheet.js'].branchData['182'][1] = new BranchData();
  _$jscoverage['/stylesheet.js'].branchData['184'] = [];
  _$jscoverage['/stylesheet.js'].branchData['184'][1] = new BranchData();
  _$jscoverage['/stylesheet.js'].branchData['190'] = [];
  _$jscoverage['/stylesheet.js'].branchData['190'][1] = new BranchData();
...
KISSY.add(function(S, require) {
  ...
  if (visit5_113_1(multiSelector.length > 1)) {
    _$jscoverage['/stylesheet.js'].lineData[114]++;
    for (i = 0; visit6_114_1(i < multiSelector.length - 1); i++) {
  ...
  if (visit7_120_1(rule)) {
    ...
    if (visit8_122_1(css)) {
      ...
      for (i = sheet[rulesName].length - 1; visit9_127_1(i >= 0); i--) {
        _$jscoverage['/stylesheet.js'].lineData[128]++;
        if (visit10_128_1(sheet[rulesName][i] === rule)) {
  ...
  _$jscoverage['/stylesheet.js'].lineData[173]++;
  ...
  function toCssText(css, base) {
    ...
    workerElement.style.cssText = visit13_176_1(base || '');
