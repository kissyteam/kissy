...
if (! _$jscoverage['/transition.js'].branchData) {
  ...
  _$jscoverage['/transition.js'].branchData['128'] = [];
  _$jscoverage['/transition.js'].branchData['128'][1] = new BranchData();
  _$jscoverage['/transition.js'].branchData['144'] = [];
  _$jscoverage['/transition.js'].branchData['144'][1] = new BranchData();
  _$jscoverage['/transition.js'].branchData['154'] = [];
  _$jscoverage['/transition.js'].branchData['154'][1] = new BranchData();
}
_$jscoverage['/transition.js'].branchData['154'][1].init(7, 213, 'S.trim(elStyle[TRANSITION].replace(new RegExp(\'(^|,)\' + \'\\\\s*(?:\' + propList.join(\'|\') + \')\\\\s+[^,]+\', \'gi\'), \'$1\')).replace(/^,|,,|,$/g, \'\') || \'none\'');
function visit13_154_1(result) {
  _$jscoverage['/transition.js'].branchData['154'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['144'][1].init(21, 7, '!finish');
function visit12_144_1(result) {
  _$jscoverage['/transition.js'].branchData['144'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['128'][1].init(569, 12, 'allCompleted');
function visit11_128_1(result) {
  _$jscoverage['/transition.js'].branchData['128'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['122'][1].init(21, 18, 'propData.pos !== 1');
...
function visit7_97_1(result) {
  ...
  return result;
}_$jscoverage['/transition.js'].branchData['75'][1].init(1420, 8, 'original');
function visit6_75_1(result) {
  _$jscoverage['/transition.js'].branchData['75'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['73'][1].init(1331, 30, 'original.indexOf(\'none\') != -1');
function visit5_73_1(result) {
  _$jscoverage['/transition.js'].branchData['73'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['59'][1].init(240, 17, 'currentValue == v');
function visit4_59_1(result) {
  _$jscoverage['/transition.js'].branchData['59'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['56'][1].init(117, 20, 'typeof v == \'number\'');
function visit3_56_1(result) {
  _$jscoverage['/transition.js'].branchData['56'][1].ranCondition(result);
  return result;
}_$jscoverage['/transition.js'].branchData['48'][1].init(270, 32, 'transform = _propsData.transform');
...
KISSY.add(function(S) {
  ...
  if (visit2_48_1(transform = _propsData.transform)) {
  ...
  if (visit7_97_1(propData.delay >= tRunTime)) {
    ...
    if (visit8_102_1(propData.duration >= tRunTime)) {
  ...
  if (visit9_117_1(!propsData[e.propertyName])) {
  ...
  if (visit10_122_1(propData.pos !== 1)) {
  ...
  clear = visit13_154_1(S.trim(elStyle[TRANSITION].replace(new RegExp('(^|,)' + '\\s*(?:' + propList.join('|') + ')\\s+[^,]+', 'gi'), '$1')).replace(/^,|,,|,$/g, '') || 'none');
