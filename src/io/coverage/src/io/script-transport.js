...
if (! _$jscoverage['/io/script-transport.js']) {
  ...
  _$jscoverage['/io/script-transport.js'].lineData[94] = 0;
}
...
KISSY.add(function(S, require) {
  ...
  _$jscoverage['/io/script-transport.js'].lineData[94]++;
  return IO;
});
