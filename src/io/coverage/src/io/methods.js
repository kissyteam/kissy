...
_$jscoverage['/io/methods.js'].branchData['281'][1].init(89, 38, 'S.Uri.getComponents(c.url).query || \'\'');
function visit111_281_1(result) {
  _$jscoverage['/io/methods.js'].branchData['281'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/methods.js'].branchData['210'][1].init(25, 10, 'status < 0');
function visit110_210_1(result) {
  _$jscoverage['/io/methods.js'].branchData['210'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/methods.js'].branchData['206'][1].init(100, 27, 'e.message || \'parser error\'');
function visit109_206_1(result) {
...
KISSY.add(function(S, require) {
  ...
  statusText = visit109_206_1(e.message || 'parser error');
}
    }
  } else {
    _$jscoverage['/io/methods.js'].lineData[210]++;
    if (visit110_210_1(status < 0)) {
  ...
  var c = this.config, uri = c.uri, originalQuery = visit111_281_1(S.Uri.getComponents(c.url).query || ''), url = uri.toString.call(uri, c.serializeArray);
