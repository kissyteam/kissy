...
function visit109_284_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var c = this.config, uri = c.uri, originalQuery = visit109_284_1(S.Uri.getComponents(c.url).query || ''), url = uri.toString.call(uri, c.serializeArray);
