...
function visit185_300_1(result) {
...
function visit184_293_1(result) {
...
function visit183_290_2(result) {
...
function visit182_290_1(result) {
...
function visit181_266_1(result) {
...
function visit180_264_1(result) {
...
function visit179_262_1(result) {
...
function visit178_255_1(result) {
...
function visit177_247_1(result) {
...
function visit176_244_1(result) {
...
function visit175_239_1(result) {
...
function visit174_235_1(result) {
...
function visit173_226_1(result) {
...
function visit172_224_1(result) {
...
function visit171_216_1(result) {
...
function visit170_214_2(result) {
...
function visit169_214_1(result) {
...
function visit168_176_1(result) {
...
function visit167_172_2(result) {
...
function visit166_172_1(result) {
...
function visit165_160_1(result) {
...
function visit164_154_1(result) {
...
function visit163_151_1(result) {
...
function visit162_148_2(result) {
...
function visit160_142_1(result) {
...
function visit158_130_1(result) {
...
function visit157_117_1(result) {
...
function visit156_116_1(result) {
...
function visit155_114_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var OK_CODE = 200, win = S.Env.host, XDomainRequest_ = visit142_12_1(visit143_12_2(S.UA.ieMode > 7) && win.XDomainRequest), NO_CONTENT_CODE = 204, NOT_FOUND_CODE = 404, NO_CONTENT_CODE2 = 1223, XhrTransportBase = {
  ...
  function createStandardXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit144_26_1(refWin || win)).XMLHttpRequest();
    }    catch (e) {
}
  ...
  function createActiveXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit145_34_1(refWin || win)).ActiveXObject('Microsoft.XMLHTTP');
    }    catch (e) {
}
  ...
  if (visit146_42_1(!supportCORS && visit147_42_2(crossDomain && XDomainRequest_))) {
  ...
  return visit148_46_1(visit149_46_2(!IO.isLocal && createStandardXHR(crossDomain, refWin)) || createActiveXHR(crossDomain, refWin));
} : createStandardXHR;
  ...
  function isInstanceOfXDomainRequest(xhr) {
    ...
    return visit150_56_1(XDomainRequest_ && (xhr instanceof XDomainRequest_));
  }
  ...
  var self = this, io = self.io, c = io.config, nativeXhr = self.nativeXhr, files = c.files, type = files ? 'post' : c.type, async = c.async, username, mimeType = io.mimeType, requestHeaders = visit153_86_1(io.requestHeaders || {}), url = io._getUrlForSend(), xhrFields, ifModifiedKey = getIfModifiedKey(c), cacheValue, i;
  _$jscoverage['/io/xhr-transport-base.js'].lineData[93]++;
  if (visit154_93_1(ifModifiedKey)) {
  ...
  xhrFields = visit155_114_1(c.xhrFields || {});
  _$jscoverage['/io/xhr-transport-base.js'].lineData[116]++;
  if (visit156_116_1('withCredentials' in xhrFields)) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[117]++;
    if (visit157_117_1(!supportCORS)) {
  ...
  if (visit158_130_1(mimeType && nativeXhr.overrideMimeType)) {
  ...
  var sendContent = visit161_148_1(visit162_148_2(c.hasContent && c.data) || null);
  _$jscoverage['/io/xhr-transport-base.js'].lineData[151]++;
  if (visit163_151_1(files)) {
    ...
    if (visit164_154_1(originalSentContent)) {
  ...
  if (visit165_160_1(S.isArray(vs))) {
  ...
  if (visit166_172_1(!async || visit167_172_2(nativeXhr.readyState === 4))) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[173]++;
    self._callback();
  } else {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[176]++;
    if (visit168_176_1(isInstanceOfXDomainRequest(nativeXhr))) {
  ...
  try {
    ...
    if (visit169_214_1(abort || visit170_214_2(nativeXhr.readyState === 4))) {
      _$jscoverage['/io/xhr-transport-base.js'].lineData[216]++;
      if (visit171_216_1(isInstanceOfXDomainRequest(nativeXhr))) {
      ...
      if (visit172_224_1(abort)) {
        _$jscoverage['/io/xhr-transport-base.js'].lineData[226]++;
        if (visit173_226_1(nativeXhr.readyState !== 4)) {
        ...
        if (visit174_235_1(!isInstanceOfXDomainRequest(nativeXhr))) {
        ...
        if (visit175_239_1(ifModifiedKey)) {
          ...
          if (visit176_244_1(lastModified)) {
        ...
        if (visit178_255_1(xml && xml.documentElement)) {
        ...
        if (visit179_262_1(c.files && text)) {
          ...
          if (visit180_264_1((bodyIndex = text.indexOf('<body>')) !== -1)) {
            ...
            if (visit181_266_1(lastBodyIndex === -1)) {
  ...
  statusText = '';
        ...
        if (visit182_290_1(!status && visit183_290_2(IO.isLocal && !c.crossDomain))) {
          ...
          if (visit184_293_1(status === NO_CONTENT_CODE2)) {
  ...
  S.log(visit185_300_1(e.stack || e), 'error');
