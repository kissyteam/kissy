...
function visit176_306_1(result) {
...
function visit175_300_1(result) {
...
function visit174_293_1(result) {
...
function visit173_290_2(result) {
...
function visit172_290_1(result) {
...
function visit171_266_1(result) {
...
function visit170_264_1(result) {
...
function visit169_262_1(result) {
...
function visit168_255_1(result) {
...
function visit167_247_1(result) {
...
function visit166_244_1(result) {
...
function visit165_239_1(result) {
...
function visit164_235_1(result) {
...
function visit163_226_1(result) {
...
function visit162_224_1(result) {
...
function visit160_214_2(result) {
...
function visit159_214_1(result) {
...
function visit158_176_1(result) {
...
function visit157_172_2(result) {
...
function visit156_172_1(result) {
...
function visit155_160_1(result) {
...
function visit154_154_1(result) {
...
function visit153_151_1(result) {
...
function visit152_148_2(result) {
...
function visit151_148_1(result) {
...
function visit150_142_1(result) {
...
function visit149_137_1(result) {
...
function visit148_130_1(result) {
...
function visit146_116_1(result) {
...
function visit145_114_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var OK_CODE = 200, win = S.Env.host, XDomainRequest_ = visit132_12_1(visit133_12_2(S.UA.ieMode > 7) && win.XDomainRequest), NO_CONTENT_CODE = 204, NOT_FOUND_CODE = 404, NO_CONTENT_CODE2 = 1223, XhrTransportBase = {
  ...
  function createStandardXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit134_26_1(refWin || win)).XMLHttpRequest();
    }    catch (e) {
}
  ...
  function createActiveXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit135_34_1(refWin || win)).ActiveXObject('Microsoft.XMLHTTP');
    }    catch (e) {
}
  ...
  if (visit136_42_1(!supportCORS && visit137_42_2(crossDomain && XDomainRequest_))) {
  ...
  return visit138_46_1(visit139_46_2(!IO.isLocal && createStandardXHR(crossDomain, refWin)) || createActiveXHR(crossDomain, refWin));
} : createStandardXHR;
  ...
  function isInstanceOfXDomainRequest(xhr) {
    ...
    return visit140_56_1(XDomainRequest_ && (xhr instanceof XDomainRequest_));
  }
  ...
  var self = this, io = self.io, c = io.config, nativeXhr = self.nativeXhr, files = c.files, type = files ? 'post' : c.type, async = c.async, username, mimeType = io.mimeType, requestHeaders = visit143_86_1(io.requestHeaders || {}), url = io._getUrlForSend(), xhrFields, ifModifiedKey = getIfModifiedKey(c), cacheValue, i;
  _$jscoverage['/io/xhr-transport-base.js'].lineData[93]++;
  if (visit144_93_1(ifModifiedKey)) {
  ...
  xhrFields = visit145_114_1(c.xhrFields || {});
  _$jscoverage['/io/xhr-transport-base.js'].lineData[116]++;
  if (visit146_116_1('withCredentials' in xhrFields)) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[117]++;
    if (visit147_117_1(!supportCORS)) {
  ...
  if (visit148_130_1(mimeType && nativeXhr.overrideMimeType)) {
  ...
  var sendContent = visit151_148_1(visit152_148_2(c.hasContent && c.data) || null);
  _$jscoverage['/io/xhr-transport-base.js'].lineData[151]++;
  if (visit153_151_1(files)) {
    ...
    if (visit154_154_1(originalSentContent)) {
  ...
  if (visit155_160_1(S.isArray(vs))) {
  ...
  if (visit156_172_1(!async || visit157_172_2(nativeXhr.readyState === 4))) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[173]++;
    self._callback();
  } else {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[176]++;
    if (visit158_176_1(isInstanceOfXDomainRequest(nativeXhr))) {
  ...
  try {
    ...
    if (visit159_214_1(abort || visit160_214_2(nativeXhr.readyState === 4))) {
      _$jscoverage['/io/xhr-transport-base.js'].lineData[216]++;
      if (visit161_216_1(isInstanceOfXDomainRequest(nativeXhr))) {
      ...
      if (visit162_224_1(abort)) {
        _$jscoverage['/io/xhr-transport-base.js'].lineData[226]++;
        if (visit163_226_1(nativeXhr.readyState !== 4)) {
        ...
        if (visit164_235_1(!isInstanceOfXDomainRequest(nativeXhr))) {
        ...
        if (visit165_239_1(ifModifiedKey)) {
          ...
          if (visit166_244_1(lastModified)) {
        ...
        if (visit168_255_1(xml && xml.documentElement)) {
        ...
        if (visit169_262_1(c.files && text)) {
          ...
          if (visit170_264_1((bodyIndex = text.indexOf('<body>')) !== -1)) {
            ...
            if (visit171_266_1(lastBodyIndex === -1)) {
  ...
  statusText = '';
        ...
        if (visit172_290_1(!status && visit173_290_2(IO.isLocal && !c.crossDomain))) {
          ...
          if (visit174_293_1(status === NO_CONTENT_CODE2)) {
  ...
  S.log(visit175_300_1(e.stack || e), 'error');
