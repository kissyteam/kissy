...
_$jscoverage['/io/xhr-transport-base.js'].branchData['306'][1].init(261, 6, '!abort');
function visit192_306_1(result) {
  _$jscoverage['/io/xhr-transport-base.js'].branchData['306'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport-base.js'].branchData['300'][1].init(24, 12, 'e.stack || e');
...
function visit163_116_1(result) {
...
KISSY.add('io/xhr-transport-base', function(S, IO) {
  ...
  if (visit163_116_1(username = c['username'])) {
