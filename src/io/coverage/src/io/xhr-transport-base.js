...
function visit177_306_1(result) {
...
function visit176_300_1(result) {
...
function visit175_293_1(result) {
...
function visit174_290_2(result) {
...
function visit173_290_1(result) {
...
function visit170_262_1(result) {
...
function visit169_255_1(result) {
...
function visit168_247_1(result) {
...
function visit167_244_1(result) {
...
function visit166_239_1(result) {
...
function visit165_235_1(result) {
...
function visit163_224_1(result) {
...
function visit161_214_2(result) {
...
function visit160_214_1(result) {
...
function visit159_176_1(result) {
...
function visit158_172_2(result) {
...
function visit157_172_1(result) {
...
function visit156_160_1(result) {
...
function visit155_154_1(result) {
...
function visit154_151_1(result) {
...
function visit153_148_2(result) {
...
function visit152_148_1(result) {
...
function visit151_142_1(result) {
...
function visit150_137_1(result) {
...
function visit149_130_1(result) {
...
function visit148_117_1(result) {
...
function visit146_114_1(result) {
...
KISSY.add(function(S, require) {
  ...
  var OK_CODE = 200, win = S.Env.host, XDomainRequest_ = visit133_12_1(visit134_12_2(S.UA.ieMode > 7) && win.XDomainRequest), NO_CONTENT_CODE = 204, NOT_FOUND_CODE = 404, NO_CONTENT_CODE2 = 1223, XhrTransportBase = {
  ...
  function createStandardXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit135_26_1(refWin || win)).XMLHttpRequest();
    }    catch (e) {
}
  ...
  function createActiveXHR(_, refWin) {
    ...
    try {
      ...
      return new (visit136_34_1(refWin || win)).ActiveXObject('Microsoft.XMLHTTP');
    }    catch (e) {
}
  ...
  if (visit137_42_1(!supportCORS && visit138_42_2(crossDomain && XDomainRequest_))) {
  ...
  return visit139_46_1(visit140_46_2(!IO.isLocal && createStandardXHR(crossDomain, refWin)) || createActiveXHR(crossDomain, refWin));
} : createStandardXHR;
  ...
  function isInstanceOfXDomainRequest(xhr) {
    ...
    return visit141_56_1(XDomainRequest_ && (xhr instanceof XDomainRequest_));
  }
  ...
  var self = this, io = self.io, c = io.config, nativeXhr = self.nativeXhr, files = c.files, type = files ? 'post' : c.type, async = c.async, username, mimeType = io.mimeType, requestHeaders = visit144_86_1(io.requestHeaders || {}), url = io._getUrlForSend(), xhrFields, ifModifiedKey = getIfModifiedKey(c), cacheValue, i;
  _$jscoverage['/io/xhr-transport-base.js'].lineData[93]++;
  if (visit145_93_1(ifModifiedKey)) {
  ...
  xhrFields = visit146_114_1(c.xhrFields || {});
  _$jscoverage['/io/xhr-transport-base.js'].lineData[116]++;
  if (visit147_116_1('withCredentials' in xhrFields)) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[117]++;
    if (visit148_117_1(!supportCORS)) {
  ...
  if (visit149_130_1(mimeType && nativeXhr.overrideMimeType)) {
  ...
  var sendContent = visit152_148_1(visit153_148_2(c.hasContent && c.data) || null);
  _$jscoverage['/io/xhr-transport-base.js'].lineData[151]++;
  if (visit154_151_1(files)) {
    ...
    if (visit155_154_1(originalSentContent)) {
  ...
  if (visit156_160_1(S.isArray(vs))) {
  ...
  if (visit157_172_1(!async || visit158_172_2(nativeXhr.readyState === 4))) {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[173]++;
    self._callback();
  } else {
    _$jscoverage['/io/xhr-transport-base.js'].lineData[176]++;
    if (visit159_176_1(isInstanceOfXDomainRequest(nativeXhr))) {
  ...
  try {
    ...
    if (visit160_214_1(abort || visit161_214_2(nativeXhr.readyState === 4))) {
      _$jscoverage['/io/xhr-transport-base.js'].lineData[216]++;
      if (visit162_216_1(isInstanceOfXDomainRequest(nativeXhr))) {
      ...
      if (visit163_224_1(abort)) {
        _$jscoverage['/io/xhr-transport-base.js'].lineData[226]++;
        if (visit164_226_1(nativeXhr.readyState !== 4)) {
        ...
        if (visit165_235_1(!isInstanceOfXDomainRequest(nativeXhr))) {
        ...
        if (visit166_239_1(ifModifiedKey)) {
          ...
          if (visit167_244_1(lastModified)) {
        ...
        if (visit169_255_1(xml && xml.documentElement)) {
        ...
        if (visit170_262_1(c.files && text)) {
          ...
          if (visit171_264_1((bodyIndex = text.indexOf('<body>')) !== -1)) {
            ...
            if (visit172_266_1(lastBodyIndex === -1)) {
  ...
  statusText = '';
        ...
        if (visit173_290_1(!status && visit174_290_2(IO.isLocal && !c.crossDomain))) {
          ...
          if (visit175_293_1(status === NO_CONTENT_CODE2)) {
  ...
  S.log(visit176_300_1(e.stack || e), 'error');
