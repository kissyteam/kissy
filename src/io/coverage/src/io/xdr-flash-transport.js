...
function visit133_138_1(result) {
...
function visit131_106_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function _swf(uri, _, uid) {
    ...
    Dom.prepend(c, visit124_38_1(doc.body || doc.documentElement));
  ...
  var self = this, io = self.io, c = io.config, xdr = visit125_53_1(c.xdr || {});
  _$jscoverage['/io/xdr-flash-transport.js'].lineData[55]++;
  _swf(visit126_55_1(xdr.src || (S.Config.base + 'io/assets/io.swf')), 1, 1);
  _$jscoverage['/io/xdr-flash-transport.js'].lineData[57]++;
  if (visit127_57_1(!flash)) {
  ...
  uid: self._uid, 
  method: c.type, 
  data: visit128_71_1(visit129_71_2(c.hasContent && c.data) || {})});
}, 
  abort: function() {
  ...
  if (visit130_88_1(c && (responseText = c.responseText))) {
