...
KISSY.add('io/form-serializer', function(S, Dom) {
  ...
  return S.param(FormSerializer.getFormData(forms), undefined, undefined, visit27_29_1(serializeArray || false));
}, 
  ...
  return visit28_43_1(el.name && visit29_45_1(!el.disabled && (visit30_48_1(el.checked || visit31_50_1(rselectTextarea.test(el.nodeName) || rinput.test(el.type))))));
});
  ...
  if (visit35_78_1(vs && !S.isArray(vs))) {
