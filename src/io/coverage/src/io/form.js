  ...
  if (visit37_26_1(tmpForm)) {
    ...
    for (var i = 0, l = inputs.length; visit38_33_1(i < l); i++) {
      ...
      if (visit39_35_1(input.type.toLowerCase() === 'file')) {
        ...
        files[Dom.attr(input, 'name')] = visit41_41_1(selected.length > 1) ? selected : (visit42_41_2(selected[0] || null));
      }
    }
    _$jscoverage['/io/form.js'].lineData[45]++;
    if (visit43_45_1(isUpload && FormData)) {
      _$jscoverage['/io/form.js'].lineData[46]++;
      c.files = visit44_46_1(c.files || {});
