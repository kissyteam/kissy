...
_$jscoverage['/io/xhr-transport.js'].branchData['60'][1].init(55, 51, '_XDomainRequest && (xhr instanceof _XDomainRequest)');
function visit201_60_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['60'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['52'][2].init(491, 30, 'String(xdrCfg.use) === \'flash\'');
function visit200_52_2(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['52'][2].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['52'][1].init(491, 50, 'String(xdrCfg.use) === \'flash\' || !_XDomainRequest');
function visit199_52_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['52'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['42'][1].init(78, 25, 'subDomain.proxy !== false');
function visit198_42_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['42'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['40'][1].init(36, 32, 'isSubDomain(c.uri.getHostname())');
function visit197_40_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['40'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['38'][1].init(251, 44, 'crossDomain && !XhrTransportBase.supportCORS');
function visit196_38_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['38'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['34'][1].init(181, 22, 'xdrCfg.subDomain || {}');
function visit195_34_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['34'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['33'][1].init(122, 14, 'c[\'xdr\'] || {}');
function visit194_33_1(result) {
  _$jscoverage['/io/xhr-transport.js'].branchData['33'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/xhr-transport.js'].branchData['21'][1].init(61, 46, 'doc.domain && S.endsWith(hostname, doc.domain)');
...
KISSY.add(function(S) {
  ...
  function isSubDomain(hostname) {
    ...
    return visit193_21_1(doc.domain && S.endsWith(hostname, doc.domain));
  }
  ...
  function XhrTransport(io) {
    ...
    var c = io.config, crossDomain = c.crossDomain, self = this, xhr, xdrCfg = visit194_33_1(c['xdr'] || {}), subDomain = xdrCfg.subDomain = visit195_34_1(xdrCfg.subDomain || {});
    _$jscoverage['/io/xhr-transport.js'].lineData[36]++;
    self.io = io;
    _$jscoverage['/io/xhr-transport.js'].lineData[38]++;
    if (visit196_38_1(crossDomain && !XhrTransportBase.supportCORS)) {
      _$jscoverage['/io/xhr-transport.js'].lineData[40]++;
      if (visit197_40_1(isSubDomain(c.uri.getHostname()))) {
        _$jscoverage['/io/xhr-transport.js'].lineData[42]++;
        if (visit198_42_1(subDomain.proxy !== false)) {
          _$jscoverage['/io/xhr-transport.js'].lineData[43]++;
          return new SubDomainTransport(io);
        }
      }
      _$jscoverage['/io/xhr-transport.js'].lineData[52]++;
      if ((visit199_52_1(visit200_52_2(String(xdrCfg.use) === 'flash') || !_XDomainRequest))) {
    ...
    var msg = 'crossDomain: ' + crossDomain + ', use ' + (visit201_60_1(_XDomainRequest && (xhr instanceof _XDomainRequest)) ? 'XDomainRequest' : 'XhrTransport') + ' for: ' + c.url;
