...
KISSY.add(function(S, require) {
  ...
  function isSubDomain(hostname) {
    ...
    return visit184_21_1(doc.domain && util.endsWith(hostname, doc.domain));
  }
  ...
  function XhrTransport(io) {
    ...
    var c = io.config, crossDomain = c.crossDomain, self = this, xhr, xdrCfg = visit185_33_1(c.xdr || {}), subDomain = xdrCfg.subDomain = visit186_34_1(xdrCfg.subDomain || {});
    _$jscoverage['/io/xhr-transport.js'].lineData[36]++;
    self.io = io;
    _$jscoverage['/io/xhr-transport.js'].lineData[38]++;
    if (visit187_38_1(crossDomain && !XhrTransportBase.supportCORS)) {
      _$jscoverage['/io/xhr-transport.js'].lineData[40]++;
      if (visit188_40_1(isSubDomain(c.uri.getHostname()))) {
        _$jscoverage['/io/xhr-transport.js'].lineData[42]++;
        if (visit189_42_1(subDomain.proxy !== false)) {
          _$jscoverage['/io/xhr-transport.js'].lineData[43]++;
          return new SubDomainTransport(io);
        }
      }
      _$jscoverage['/io/xhr-transport.js'].lineData[52]++;
      if ((visit190_52_1(visit191_52_2(String(xdrCfg.use) === 'flash') || !XDomainRequest_))) {
    ...
    var msg = 'crossDomain: ' + crossDomain + ', use ' + (visit192_60_1(XDomainRequest_ && (xhr instanceof XDomainRequest_)) ? 'XDomainRequest' : 'XhrTransport') + ' for: ' + c.url;
