...
function visit133_61_1(result) {
  _$jscoverage['/io/sub-domain-transport.js'].branchData['61'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/sub-domain-transport.js'].branchData['53'][1].init(823, 11, '!iframeDesc');
function visit132_53_1(result) {
...
function visit131_45_1(result) {
  ...
  return result;
}_$jscoverage['/io/sub-domain-transport.js'].branchData['43'][1].init(448, 30, 'iframeDesc && iframeDesc.ready');
function visit130_43_1(result) {
  _$jscoverage['/io/sub-domain-transport.js'].branchData['43'][1].ranCondition(result);
  return result;
}_$jscoverage['/io/sub-domain-transport.js'].branchData['39'][2].init(308, 52, 'c[\'xdr\'][\'subDomain\'] && c[\'xdr\'][\'subDomain\'].proxy');
function visit129_39_2(result) {
  _$jscoverage['/io/sub-domain-transport.js'].branchData['39'][2].ranCondition(result);
  return result;
}_$jscoverage['/io/sub-domain-transport.js'].branchData['39'][1].init(296, 64, 'c[\'xdr\'] && c[\'xdr\'][\'subDomain\'] && c[\'xdr\'][\'subDomain\'].proxy');
function visit128_39_1(result) {
...
KISSY.add(function(S, require) {
  ...
  if (visit128_39_1(c['xdr'] && visit129_39_2(c['xdr']['subDomain'] && c['xdr']['subDomain'].proxy))) {
    _$jscoverage['/io/sub-domain-transport.js'].lineData[40]++;
    proxy = c['xdr']['subDomain'].proxy;
  }
  _$jscoverage['/io/sub-domain-transport.js'].lineData[43]++;
  if (visit130_43_1(iframeDesc && iframeDesc.ready)) {
    ...
    if (visit131_45_1(self.nativeXhr)) {
  ...
  top: '-9999px'});
    ...
    Dom.prepend(iframe, visit133_61_1(doc.body || doc.documentElement));
