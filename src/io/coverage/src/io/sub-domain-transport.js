...
KISSY.add('io/sub-domain-transport', function(S, XhrTransportBase, Event, Dom) {
  ...
  if (visit127_36_1(c['xdr'] && visit128_36_2(c['xdr']['subDomain'] && c['xdr']['subDomain'].proxy))) {
    _$jscoverage['/io/sub-domain-transport.js'].lineData[37]++;
    proxy = c['xdr']['subDomain'].proxy;
  }
  _$jscoverage['/io/sub-domain-transport.js'].lineData[40]++;
  if (visit129_40_1(iframeDesc && iframeDesc.ready)) {
    ...
    if (visit130_42_1(self.nativeXhr)) {
  ...
  top: '-9999px'});
    ...
    Dom.prepend(iframe, visit132_58_1(doc.body || doc.documentElement));
