...
function visit107_149_1(result) {
...
function visit106_148_1(result) {
...
function visit105_145_2(result) {
...
function visit104_145_1(result) {
...
(function(S) {
  ...
  if (visit101_108_1(mod.status === Loader.Status.INIT)) {
  ...
  if (visit102_119_1(!base)) {
    _$jscoverage['/configs.js'].lineData[120]++;
    return visit103_120_1(corePackage && corePackage.getBase());
  }
  ...
  function normalizePath(base, isDirectory) {
    ...
    if (visit104_145_1(isDirectory && visit105_145_2(base.charAt(base.length - 1) !== '/'))) {
      _$jscoverage['/configs.js'].lineData[146]++;
      base += '/';
    }
    _$jscoverage['/configs.js'].lineData[148]++;
    if (visit106_148_1(locationPath)) {
      _$jscoverage['/configs.js'].lineData[149]++;
      if (visit107_149_1(base.charAt(0) === '/')) {
