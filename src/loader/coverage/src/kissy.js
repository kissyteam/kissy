...
function visit209_218_1(result) {
...
function visit208_217_2(result) {
...
function visit204_205_4(result) {
...
function visit203_205_3(result) {
...
function visit202_205_2(result) {
...
function visit201_205_1(result) {
...
function visit200_204_1(result) {
...
function visit199_203_1(result) {
...
function visit198_200_1(result) {
...
function visit197_193_4(result) {
...
function visit196_193_3(result) {
...
function visit195_193_2(result) {
...
function visit194_193_1(result) {
...
function visit193_192_1(result) {
...
function visit192_191_1(result) {
...
function visit191_188_1(result) {
...
function visit182_144_1(result) {
...
function visit181_142_1(result) {
...
var KISSY = (function(undefined) {
  ...
  if (visit186_179_1('@DEBUG@')) {
    _$jscoverage['/kissy.js'].lineData[180]++;
    var matched = 1;
    _$jscoverage['/kissy.js'].lineData[181]++;
    if (visit187_181_1(logger)) {
      _$jscoverage['/kissy.js'].lineData[182]++;
      var loggerCfg = visit188_182_1(S.Config.logger || {}), list, i, l, level, minLevel, maxLevel, reg;
      _$jscoverage['/kissy.js'].lineData[184]++;
      cat = visit189_184_1(cat || 'debug');
      _$jscoverage['/kissy.js'].lineData[185]++;
      level = visit190_185_1(loggerLevel[cat] || loggerLevel.debug);
      ...
      if ((list = loggerCfg.includes)) {
        ...
        for (i = 0; visit191_188_1(i < list.length); i++) {
          _$jscoverage['/kissy.js'].lineData[189]++;
          l = list[i];
          _$jscoverage['/kissy.js'].lineData[190]++;
          reg = l.logger;
          _$jscoverage['/kissy.js'].lineData[191]++;
          maxLevel = visit192_191_1(loggerLevel[l.maxLevel] || loggerLevel.error);
          _$jscoverage['/kissy.js'].lineData[192]++;
          minLevel = visit193_192_1(loggerLevel[l.minLevel] || loggerLevel.debug);
          _$jscoverage['/kissy.js'].lineData[193]++;
          if (visit194_193_1(visit195_193_2(minLevel <= level) && visit196_193_3(visit197_193_4(maxLevel >= level) && logger.match(reg)))) {
        ...
        if ((list = loggerCfg.excludes)) {
          ...
          for (i = 0; visit198_200_1(i < list.length); i++) {
            _$jscoverage['/kissy.js'].lineData[201]++;
            l = list[i];
            _$jscoverage['/kissy.js'].lineData[202]++;
            reg = l.logger;
            _$jscoverage['/kissy.js'].lineData[203]++;
            maxLevel = visit199_203_1(loggerLevel[l.maxLevel] || loggerLevel.error);
            _$jscoverage['/kissy.js'].lineData[204]++;
            minLevel = visit200_204_1(loggerLevel[l.minLevel] || loggerLevel.debug);
            _$jscoverage['/kissy.js'].lineData[205]++;
            if (visit201_205_1(visit202_205_2(minLevel <= level) && visit203_205_3(visit204_205_4(maxLevel >= level) && logger.match(reg)))) {
      ...
      if (visit205_211_1(matched)) {
        _$jscoverage['/kissy.js'].lineData[212]++;
        msg = logger + ': ' + msg;
      }
    }
    _$jscoverage['/kissy.js'].lineData[216]++;
    if (visit206_216_1(matched)) {
      _$jscoverage['/kissy.js'].lineData[217]++;
      if (visit207_217_1(visit208_217_2(typeof console !== 'undefined') && console.log)) {
        _$jscoverage['/kissy.js'].lineData[218]++;
        console[visit209_218_1(cat && console[cat]) ? cat : 'log'](msg);
      }
  ...
  return (visit211_251_1(pre || EMPTY)) + guid++;
}};
  _$jscoverage['/kissy.js'].lineData[255]++;
  if (visit212_255_1('@DEBUG@')) {
