...
function visit168_160_1(result) {
...
function visit167_157_1(result) {
...
function visit166_152_1(result) {
...
function visit165_143_1(result) {
...
function visit164_137_1(result) {
...
function visit162_129_2(result) {
...
function visit161_129_1(result) {
...
function visit160_128_1(result) {
...
function visit159_122_2(result) {
...
function visit158_122_1(result) {
...
function visit157_120_2(result) {
...
function visit156_120_1(result) {
...
function visit155_117_3(result) {
...
function visit154_117_2(result) {
...
function visit152_116_1(result) {
...
(function(S) {
  ...
  if (visit145_54_1(typeof config === 'object')) {
  ...
  callbacks = jsCssCallbacks[url] = visit146_62_1(jsCssCallbacks[url] || []);
  _$jscoverage['/get-script.js'].lineData[64]++;
  callbacks.push([success, error]);
  _$jscoverage['/get-script.js'].lineData[66]++;
  if (visit147_66_1(callbacks.length > 1)) {
  ...
  var forceCssPoll = visit152_116_1(S.Config.forceCssPoll || visit153_117_1((visit154_117_2(webkit && visit155_117_3(webkit < 536))) || (visit156_120_1(!webkit && visit157_120_2(!Utils.trident && !Utils.gecko)))));
  _$jscoverage['/get-script.js'].lineData[122]++;
  if (visit158_122_1(css && visit159_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit160_128_1(!readyState || visit161_129_1(visit162_129_2(readyState === 'loaded') || visit163_130_1(readyState === 'complete')))) {
