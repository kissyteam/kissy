...
(function(S) {
  ...
  var doc = visit167_7_1(S.Env.host && S.Env.host.document);
  ...
  function getBaseInfoFromOneScript(script) {
    ...
    var src = visit168_25_1(script.src || '');
    _$jscoverage['/init.js'].lineData[26]++;
    if (visit169_26_1(!src.match(baseTestReg))) {
    ...
    var comboPrefix = visit171_38_1(baseInfo.comboPrefix || defaultComboPrefix);
    _$jscoverage['/init.js'].lineData[39]++;
    var comboSep = visit172_39_1(baseInfo.comboSep || defaultComboSep);
    _$jscoverage['/init.js'].lineData[41]++;
    var parts, base, index = src.indexOf(comboPrefix);
    _$jscoverage['/init.js'].lineData[46]++;
    if (visit173_46_1(index === -1)) {
      ...
      if (visit174_52_1(base.charAt(base.length - 1) !== '/')) {
  ...
  if (visit175_57_1(part.match(baseTestReg))) {
  ...
  return undefined;
    ...
    baseInfo.base = visit178_74_1(baseInfo.base || base);
  ...
  function getBaseInfo() {
    ...
    for (i = scripts.length - 1; visit179_97_1(i >= 0); i--) {
  ...
  if (visit180_122_1(doc && doc.getElementsByTagName)) {
