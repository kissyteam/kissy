...
(function(S) {
  ...
  var doc = visit174_7_1(S.Env.host && S.Env.host.document);
  ...
  function getBaseInfoFromOneScript(script) {
    ...
    var src = visit175_25_1(script.src || '');
    _$jscoverage['/init.js'].lineData[26]++;
    if (visit176_26_1(!src.match(baseTestReg))) {
    ...
    var comboPrefix = visit178_38_1(baseInfo.comboPrefix || defaultComboPrefix);
    _$jscoverage['/init.js'].lineData[39]++;
    var comboSep = visit179_39_1(baseInfo.comboSep || defaultComboSep);
    _$jscoverage['/init.js'].lineData[41]++;
    var parts, base, index = src.indexOf(comboPrefix);
    _$jscoverage['/init.js'].lineData[46]++;
    if (visit180_46_1(index === -1)) {
      ...
      if (visit181_52_1(base.charAt(base.length - 1) !== '/')) {
  ...
  if (visit182_57_1(part.match(baseTestReg))) {
  ...
  return undefined;
    ...
    baseInfo.base = visit185_74_1(baseInfo.base || base);
  ...
  function getBaseInfo() {
    ...
    for (i = scripts.length - 1; visit186_97_1(i >= 0); i--) {
  ...
  if (visit187_122_1(doc && doc.getElementsByTagName)) {
