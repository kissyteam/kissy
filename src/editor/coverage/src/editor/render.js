...
if (! _$jscoverage['/editor/render.js']) {
  _$jscoverage['/editor/render.js'] = {};
  _$jscoverage['/editor/render.js'].lineData = [];
  _$jscoverage['/editor/render.js'].lineData[5] = 0;
  _$jscoverage['/editor/render.js'].lineData[7] = 0;
  _$jscoverage['/editor/render.js'].lineData[10] = 0;
  _$jscoverage['/editor/render.js'].lineData[14] = 0;
}
if (! _$jscoverage['/editor/render.js'].functionData) {
  _$jscoverage['/editor/render.js'].functionData = [];
  _$jscoverage['/editor/render.js'].functionData[0] = 0;
  _$jscoverage['/editor/render.js'].functionData[1] = 0;
}
if (! _$jscoverage['/editor/render.js'].branchData) {
  _$jscoverage['/editor/render.js'].branchData = {};
}
_$jscoverage['/editor/render.js'].lineData[5]++;
KISSY.add('editor/render', function(S, Control, RenderTpl) {
  ...
  _$jscoverage['/editor/render.js'].lineData[10]++;
  S.mix(renderData, {
  mobile: S.UA.mobile});
  _$jscoverage['/editor/render.js'].lineData[14]++;
