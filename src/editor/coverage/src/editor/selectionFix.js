...
function visit821_488_1(result) {
...
function visit820_481_1(result) {
...
function visit819_475_1(result) {
...
function visit818_464_1(result) {
...
function visit817_462_1(result) {
...
function visit816_434_2(result) {
...
function visit815_434_1(result) {
...
function visit814_433_1(result) {
...
function visit813_428_2(result) {
...
function visit812_428_1(result) {
...
function visit811_427_1(result) {
...
function visit810_425_1(result) {
...
function visit808_419_1(result) {
...
function visit807_415_1(result) {
...
function visit806_414_1(result) {
...
function visit805_409_2(result) {
...
function visit804_409_1(result) {
...
function visit803_402_2(result) {
...
function visit802_402_1(result) {
...
function visit801_400_4(result) {
...
function visit800_400_3(result) {
...
function visit799_400_2(result) {
...
function visit798_400_1(result) {
...
function visit797_398_1(result) {
...
function visit795_395_1(result) {
...
function visit794_394_1(result) {
...
function visit793_393_1(result) {
...
function visit792_387_1(result) {
...
function visit790_377_1(result) {
...
function visit789_373_1(result) {
...
function visit788_361_1(result) {
...
function visit787_357_1(result) {
...
function visit786_351_2(result) {
...
function visit785_351_1(result) {
...
function visit784_297_1(result) {
...
function visit783_293_1(result) {
...
function visit782_292_1(result) {
...
function visit780_290_4(result) {
...
function visit779_290_3(result) {
...
function visit778_290_2(result) {
...
function visit777_290_1(result) {
...
function visit776_279_1(result) {
...
function visit775_274_3(result) {
...
function visit774_274_2(result) {
...
function visit773_274_1(result) {
...
function visit772_263_1(result) {
...
function visit771_262_1(result) {
...
function visit770_260_1(result) {
...
function visit769_215_1(result) {
...
function visit768_194_1(result) {
...
function visit767_189_1(result) {
...
function visit766_183_1(result) {
...
function visit765_129_1(result) {
...
function visit764_123_1(result) {
...
function visit763_101_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function fixSelectionForIEWhenDocReady(editor) {
    ...
    if (visit764_123_1(S.UA.ieMode < 8)) {
  ...
  if (visit765_129_1(t.nodeName() === 'html')) {
  ...
  if (visit769_215_1(evt.relatedTarget)) {
  ...
  saveSelection(TRUE);
    ...
    function saveSelection(testIt) {
      ...
      if (visit770_260_1(saveEnabled)) {
        _$jscoverage['/editor/selectionFix.js'].lineData[261]++;
        var sel = editor.getSelection(), type = visit771_262_1(sel && sel.getType()), nativeSel = visit772_263_1(sel && doc.selection);
        _$jscoverage['/editor/selectionFix.js'].lineData[274]++;
        if (visit773_274_1(testIt && visit774_274_2(nativeSel && visit775_274_3(type === KES.SELECTION_NONE)))) {
          _$jscoverage['/editor/selectionFix.js'].lineData[279]++;
          if (visit776_279_1(!doc.queryCommandEnabled('InsertImage'))) {
  ...
  saveSelection(TRUE);
        ...
        if (visit777_290_1(nativeSel && visit778_290_2(nativeSel.type && visit779_290_3(visit780_290_4(nativeSel.type !== 'Control') && visit781_291_1((parentTag = nativeSel.createRange()) && visit782_292_1((parentTag = parentTag.parentElement()) && visit783_293_1((parentTag = parentTag.nodeName) && parentTag.toLowerCase() in {
  input: 1, 
  textarea: 1}))))))) {
        ...
        savedRange = visit784_297_1(nativeSel && sel.getRanges()[0]);
  ...
  return visit785_351_1(isNotWhitespace(node) && visit786_351_2(node.nodeType !== 8));
};
    ...
    function cannotCursorPlaced(element) {
      ...
      return visit787_357_1(element._4eIsBlockBoundary() && dtd.$empty[element.nodeName()]);
    }
    ...
    function isNotEmpty(node) {
      ...
      return visit788_361_1(isNotWhitespace(node) && isNotBookmark(node));
    }
  ...
  var path = ev.path, editorDoc = editor.get('document')[0], body = new Node(editorDoc.body), selection = ev.selection, range = visit789_373_1(selection && selection.getRanges()[0]), blockLimit = path.blockLimit;
  _$jscoverage['/editor/selectionFix.js'].lineData[377]++;
  if (visit790_377_1(!body[0])) {
  ...
  blockLimit = visit792_387_1(blockLimit || body);
  _$jscoverage['/editor/selectionFix.js'].lineData[393]++;
  if (visit793_393_1(UA.gecko)) {
    _$jscoverage['/editor/selectionFix.js'].lineData[394]++;
    var pathBlock = visit794_394_1(path.block || path.blockLimit), lastNode = visit795_395_1(pathBlock && pathBlock.last(isNotEmpty));
    _$jscoverage['/editor/selectionFix.js'].lineData[396]++;
    if (visit796_396_1(pathBlock && visit797_398_1(pathBlock._4eIsBlockBoundary() && visit798_400_1(!(visit799_400_2(lastNode && visit800_400_3(visit801_400_4(lastNode[0].nodeType === 1) && lastNode._4eIsBlockBoundary()))) && visit802_402_1(visit803_402_2(pathBlock.nodeName() !== 'pre') && !pathBlock._4eGetBogus()))))) {
      _$jscoverage['/editor/selectionFix.js'].lineData[405]++;
      pathBlock._4eAppendBogus();
    }
  }
  _$jscoverage['/editor/selectionFix.js'].lineData[409]++;
  if (visit804_409_1(!range || visit805_409_2(!range.collapsed || path.block))) {
    _$jscoverage['/editor/selectionFix.js'].lineData[410]++;
    return;
  }
  _$jscoverage['/editor/selectionFix.js'].lineData[414]++;
  if (visit806_414_1(blockLimit.nodeName() === 'body')) {
    _$jscoverage['/editor/selectionFix.js'].lineData[415]++;
    if (visit807_415_1(range.startContainer.nodeName() === 'html')) {
    ...
    if (visit808_419_1(fixedBlock && visit809_423_1(fixedBlock[0] !== body[0].lastChild))) {
      _$jscoverage['/editor/selectionFix.js'].lineData[425]++;
      if (visit810_425_1(isBlankParagraph(fixedBlock))) {
        ...
        if (visit811_427_1(element && visit812_428_1(visit813_428_2(element[0].nodeType === Dom.NodeType.ELEMENT_NODE) && !cannotCursorPlaced[element]))) {
          ...
          if (visit814_433_1(element && visit815_434_1(visit816_434_2(element[0].nodeType === Dom.NodeType.ELEMENT_NODE) && !cannotCursorPlaced[element]))) {
  ...
  if (visit817_462_1(lastPath.blockLimit.nodeName() !== 'body')) {
  ...
  if (visit819_475_1(document.selection)) {
