...
function visit1138_359_4(result) {
...
function visit1137_359_3(result) {
...
function visit1136_359_2(result) {
...
function visit1135_359_1(result) {
...
function visit1134_357_1(result) {
...
function visit1133_349_1(result) {
...
function visit1132_348_2(result) {
...
function visit1131_348_1(result) {
...
function visit1130_347_1(result) {
...
function visit1129_346_1(result) {
...
function visit1128_335_2(result) {
...
function visit1127_335_1(result) {
...
function visit1126_334_1(result) {
...
function visit1125_318_2(result) {
...
function visit1124_318_1(result) {
...
function visit1123_305_1(result) {
...
function visit1122_302_1(result) {
...
function visit1121_301_2(result) {
...
function visit1120_301_1(result) {
...
function visit1119_294_2(result) {
...
function visit1118_294_1(result) {
...
function visit1117_278_2(result) {
...
function visit1116_278_1(result) {
...
function visit1115_237_1(result) {
...
function visit1114_226_1(result) {
...
function visit1113_140_1(result) {
...
function visit1112_137_1(result) {
...
function visit1111_136_2(result) {
...
function visit1109_134_1(result) {
...
function visit1108_128_1(result) {
...
function visit1107_124_1(result) {
...
function visit1106_123_1(result) {
...
function visit1105_116_1(result) {
...
function visit1104_112_1(result) {
...
function visit1103_110_1(result) {
...
function visit1102_108_1(result) {
...
function visit1101_103_1(result) {
...
function visit1100_94_1(result) {
...
function visit1099_92_1(result) {
...
function visit1098_83_1(result) {
...
function visit1097_78_4(result) {
...
function visit1096_78_3(result) {
...
function visit1095_78_2(result) {
...
function visit1094_78_1(result) {
...
function visit1093_73_3(result) {
...
function visit1092_73_2(result) {
...
function visit1091_73_1(result) {
...
function visit1090_70_1(result) {
...
function visit1089_64_1(result) {
...
function visit1088_59_4(result) {
...
function visit1087_59_3(result) {
...
function visit1086_59_2(result) {
...
function visit1085_59_1(result) {
...
function visit1084_52_1(result) {
...
function visit1083_45_1(result) {
...
function visit1082_37_1(result) {
...
function visit1081_25_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function iterate(rtl, breakOnFalseRetFalse) {
    ...
    if (visit1082_37_1(!self._.start)) {
      ...
      if (visit1083_45_1(range.collapsed)) {
    ...
    if (visit1084_52_1(!rtl && !self._.guardLTR)) {
  ...
  if (visit1085_59_1(movingOut && (visit1086_59_2(visit1087_59_3(limitLTR === node) || visit1088_59_4(Dom.nodeName(node) === 'body'))))) {
    _$jscoverage['/editor/walker.js'].lineData[60]++;
    return false;
  }
  _$jscoverage['/editor/walker.js'].lineData[64]++;
  return visit1089_64_1(node !== blockerLTR);
};
    }
    _$jscoverage['/editor/walker.js'].lineData[70]++;
    if (visit1090_70_1(rtl && !self._.guardRTL)) {
      _$jscoverage['/editor/walker.js'].lineData[72]++;
      var limitRTL = range.startContainer[0], blockerRTL = visit1091_73_1(visit1092_73_2((visit1093_73_3(range.startOffset > 0)) && limitRTL.childNodes[range.startOffset - 1]) || null);
  ...
  if (visit1094_78_1(movingOut && (visit1095_78_2(visit1096_78_3(limitRTL === node) || visit1097_78_4(Dom.nodeName(node) === 'body'))))) {
    _$jscoverage['/editor/walker.js'].lineData[79]++;
    return false;
  }
  _$jscoverage['/editor/walker.js'].lineData[83]++;
  return visit1098_83_1(node !== blockerRTL);
};
    }
  ...
  if (visit1100_94_1(stopGuard(node, movingOut) === FALSE)) {
    ...
    if (visit1101_103_1(self.current)) {
      ...
      if (visit1102_108_1(rtl)) {
        ...
        if (visit1103_110_1(range.endOffset > 0)) {
          ...
          if (visit1104_112_1(guard(node[0]) === FALSE)) {
            _$jscoverage['/editor/walker.js'].lineData[113]++;
            node = NULL;
          }
        } else {
          _$jscoverage['/editor/walker.js'].lineData[116]++;
          node = (visit1105_116_1(guard(node, TRUE) === FALSE)) ? NULL : node._4ePreviousSourceNode(TRUE, type, guard, undefined);
        }
      } else {
        ...
        if (visit1106_123_1(node.length)) {
          _$jscoverage['/editor/walker.js'].lineData[124]++;
          if (visit1107_124_1(guard(node[0]) === FALSE)) {
            _$jscoverage['/editor/walker.js'].lineData[125]++;
            node = NULL;
          }
        } else {
          _$jscoverage['/editor/walker.js'].lineData[128]++;
          node = (visit1108_128_1(guard(range.startContainer, TRUE) === FALSE)) ? NULL : range.startContainer._4eNextSourceNode(TRUE, type, guard, undefined);
        }
      }
    }
    _$jscoverage['/editor/walker.js'].lineData[134]++;
    while (visit1109_134_1(node && !self._.end)) {
      _$jscoverage['/editor/walker.js'].lineData[135]++;
      self.current = node;
      _$jscoverage['/editor/walker.js'].lineData[136]++;
      if (visit1110_136_1(!self.evaluator || visit1111_136_2(self.evaluator(node[0]) !== FALSE))) {
        _$jscoverage['/editor/walker.js'].lineData[137]++;
        if (visit1112_137_1(!breakOnFalseRetFalse)) {
          _$jscoverage['/editor/walker.js'].lineData[138]++;
          return node;
        }
      } else {
        _$jscoverage['/editor/walker.js'].lineData[140]++;
        if (visit1113_140_1(breakOnFalseRetFalse && self.evaluator)) {
  ...
  return visit1114_226_1(iterate.call(this, FALSE, TRUE) !== FALSE);
}, 
  checkBackward: function() {
  _$jscoverage['/editor/walker.js'].functionData[11]++;
  _$jscoverage['/editor/walker.js'].lineData[237]++;
  return visit1115_237_1(iterate.call(this, TRUE, TRUE) !== FALSE);
}, 
  ...
  return !(visit1116_278_1(visit1117_278_2(node.nodeType === Dom.NodeType.ELEMENT_NODE) && Dom._4eIsBlockBoundary(node, customNodeNames)));
};
}, 
  ...
  function isBookmarkNode(node) {
    ...
    return visit1118_294_1(visit1119_294_2(Dom.nodeName(node) === 'span') && Dom.attr(node, '_ke_bookmark'));
  }
  ...
  isBookmark = (visit1120_301_1(visit1121_301_2(node.nodeType === Dom.NodeType.TEXT_NODE) && visit1122_302_1((parent = node.parentNode) && isBookmarkNode(parent))));
  _$jscoverage['/editor/walker.js'].lineData[305]++;
  isBookmark = contentOnly ? isBookmark : visit1123_305_1(isBookmark || isBookmarkNode(node));
  ...
  var isWhitespace = visit1124_318_1(visit1125_318_2(node.nodeType === Dom.NodeType.TEXT_NODE) && !S.trim(node.nodeValue));
  ...
  var isInvisible = visit1126_334_1(whitespace(node) || visit1127_335_1(visit1128_335_2(node.nodeType === Dom.NodeType.ELEMENT_NODE) && !node.offsetHeight));
  ...
  return visit1129_346_1(isBookmark(node) || visit1130_347_1(isWhitespaces(node) || visit1131_348_1(visit1132_348_2(node.nodeType === 1) && visit1133_349_1(name in dtd.$inline && !(name in dtd.$empty)))));
};
  ...
  function getBogus(tail) {
    ...
    } while (visit1134_357_1(tail && toSkip(tail[0])));
    _$jscoverage['/editor/walker.js'].lineData[359]++;
    if (visit1135_359_1(tail && (!UA.ie ? visit1136_359_2(tail.nodeName() === 'br') : visit1137_359_3(visit1138_359_4(tail[0].nodeType === 3) && tailNbspRegex.test(tail.text()))))) {
