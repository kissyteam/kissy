...
if (! _$jscoverage['/editor/render-xtpl.js'].branchData) {
  ...
  _$jscoverage['/editor/render-xtpl.js'].branchData['8'][2] = new BranchData();
}
_$jscoverage['/editor/render-xtpl.js'].branchData['8'][2].init(165, 28, 'typeof module != "undefined"');
function visit624_8_2(result) {
  _$jscoverage['/editor/render-xtpl.js'].branchData['8'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/render-xtpl.js'].branchData['8'][1].init(165, 44, 'typeof module != "undefined" && module.kissy');
function visit623_8_1(result) {
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit623_8_1(visit624_8_2(typeof module != "undefined") && module.kissy)) {
