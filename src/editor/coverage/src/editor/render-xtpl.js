...
if (! _$jscoverage['/editor/render-xtpl.js']) {
  ...
  _$jscoverage['/editor/render-xtpl.js'].lineData[102] = 0;
  _$jscoverage['/editor/render-xtpl.js'].lineData[103] = 0;
  _$jscoverage['/editor/render-xtpl.js'].lineData[104] = 0;
  _$jscoverage['/editor/render-xtpl.js'].lineData[106] = 0;
  _$jscoverage['/editor/render-xtpl.js'].lineData[107] = 0;
}
...
if (! _$jscoverage['/editor/render-xtpl.js'].branchData) {
  ...
  _$jscoverage['/editor/render-xtpl.js'].branchData['11'] = [];
  _$jscoverage['/editor/render-xtpl.js'].branchData['11'][1] = new BranchData();
  _$jscoverage['/editor/render-xtpl.js'].branchData['11'][2] = new BranchData();
}
_$jscoverage['/editor/render-xtpl.js'].branchData['11'][2].init(358, 29, 'typeof module !== "undefined"');
function visit628_11_2(result) {
  _$jscoverage['/editor/render-xtpl.js'].branchData['11'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/render-xtpl.js'].branchData['11'][1].init(358, 45, 'typeof module !== "undefined" && module.kissy');
function visit627_11_1(result) {
  _$jscoverage['/editor/render-xtpl.js'].branchData['11'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/render-xtpl.js'].branchData['8'][1].init(154, 20, '"1.50" !== S.version');
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit627_11_1(visit628_11_2(typeof module !== "undefined") && module.kissy)) {
  ...
  _$jscoverage['/editor/render-xtpl.js'].lineData[102]++;
  ...
  _$jscoverage['/editor/render-xtpl.js'].lineData[106]++;
  t.TPL_NAME = module.name;
  _$jscoverage['/editor/render-xtpl.js'].lineData[107]++;
  return t;
});
