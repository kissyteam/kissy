...
if (! _$jscoverage['/underline.js']) {
  _$jscoverage['/underline.js'] = {};
  _$jscoverage['/underline.js'].lineData = [];
  _$jscoverage['/underline.js'].lineData[5] = 0;
  ...
  _$jscoverage['/underline.js'].lineData[29] = 0;
}
if (! _$jscoverage['/underline.js'].functionData) {
  _$jscoverage['/underline.js'].functionData = [];
  _$jscoverage['/underline.js'].functionData[0] = 0;
  _$jscoverage['/underline.js'].functionData[1] = 0;
  _$jscoverage['/underline.js'].functionData[2] = 0;
  _$jscoverage['/underline.js'].functionData[3] = 0;
  _$jscoverage['/underline.js'].functionData[4] = 0;
}
if (! _$jscoverage['/underline.js'].branchData) {
  _$jscoverage['/underline.js'].branchData = {};
  _$jscoverage['/underline.js'].branchData['20'] = [];
  _$jscoverage['/underline.js'].branchData['20'][1] = new BranchData();
  _$jscoverage['/underline.js'].branchData['20'][2] = new BranchData();
}
_$jscoverage['/underline.js'].branchData['20'][2].init(39, 29, 'e.keyCode == S.Node.KeyCode.U');
function visit2_20_2(result) {
  _$jscoverage['/underline.js'].branchData['20'][2].ranCondition(result);
  return result;
}_$jscoverage['/underline.js'].branchData['20'][1].init(26, 42, 'e.ctrlKey && e.keyCode == S.Node.KeyCode.U');
function visit1_20_1(result) {
  _$jscoverage['/underline.js'].branchData['20'][1].ranCondition(result);
  return result;
}_$jscoverage['/underline.js'].lineData[5]++;
KISSY.add("editor/plugin/underline", function(S, Editor, ui, cmd) {
  ...
  if (visit1_20_1(e.ctrlKey && visit2_20_2(e.keyCode == S.Node.KeyCode.U))) {
  ...
  _$jscoverage['/underline.js'].lineData[29]++;
  return Underline;
}, {
