...
if (! _$jscoverage['/resize.js'].branchData) {
  ...
  _$jscoverage['/resize.js'].branchData['9'] = [];
  _$jscoverage['/resize.js'].branchData['9'][1] = new BranchData();
  _$jscoverage['/resize.js'].branchData['18'] = [];
  _$jscoverage['/resize.js'].branchData['18'][1] = new BranchData();
  _$jscoverage['/resize.js'].branchData['22'] = [];
  _$jscoverage['/resize.js'].branchData['22'][1] = new BranchData();
...
_$jscoverage['/resize.js'].branchData['67'][1].init(277, 25, 'S.inArray("x", direction)');
function visit6_67_1(result) {
  _$jscoverage['/resize.js'].branchData['67'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].branchData['64'][1].init(149, 25, 'S.inArray("y", direction)');
function visit5_64_1(result) {
  _$jscoverage['/resize.js'].branchData['64'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].branchData['23'][1].init(22, 19, 'direction[0] == "x"');
function visit4_23_1(result) {
  _$jscoverage['/resize.js'].branchData['23'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].branchData['22'][1].init(314, 21, 'direction.length == 1');
function visit3_22_1(result) {
  _$jscoverage['/resize.js'].branchData['22'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].branchData['18'][1].init(207, 30, 'cfg["direction"] || ["x", "y"]');
function visit2_18_1(result) {
  _$jscoverage['/resize.js'].branchData['18'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].branchData['9'][1].init(14, 10, 'config || {}');
function visit1_9_1(result) {
  _$jscoverage['/resize.js'].branchData['9'][1].ranCondition(result);
  return result;
}_$jscoverage['/resize.js'].lineData[5]++;
KISSY.add("editor/plugin/resize", function(S, Editor, DD) {
  ...
  function Resize(config) {
    ...
    this.config = visit1_9_1(config || {});
  }
  _$jscoverage['/resize.js'].lineData[12]++;
  S.augment(Resize, {
  pluginRenderUI: function(editor) {
  _$jscoverage['/resize.js'].functionData[2]++;
  _$jscoverage['/resize.js'].lineData[14]++;
  var Draggable = DD['Draggable'], statusBarEl = editor.get("statusBarEl"), textarea = editor.get("textarea"), cfg = this.config, direction = visit2_18_1(cfg["direction"] || ["x", "y"]);
  _$jscoverage['/resize.js'].lineData[20]++;
  var cursor = 'se-resize';
  _$jscoverage['/resize.js'].lineData[22]++;
  if (visit3_22_1(direction.length == 1)) {
    _$jscoverage['/resize.js'].lineData[23]++;
    if (visit4_23_1(direction[0] == "x")) {
