...
_$jscoverage['/dialog.js'].branchData['233'][1].init(613, 18, 'self.selectedFlash');
function visit17_233_1(result) {
  _$jscoverage['/dialog.js'].branchData['233'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['227'][1].init(399, 3, '!re');
function visit16_227_1(result) {
  _$jscoverage['/dialog.js'].branchData['227'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['223'][1].init(251, 6, '!dinfo');
function visit15_223_1(result) {
  _$jscoverage['/dialog.js'].branchData['223'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['222'][1].init(170, 20, 'dinfo && dinfo.attrs');
function visit14_222_1(result) {
  _$jscoverage['/dialog.js'].branchData['222'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['221'][1].init(118, 26, 'dinfo && S.trim(dinfo.url)');
function visit13_221_1(result) {
  _$jscoverage['/dialog.js'].branchData['221'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['217'][1].init(13, 15, 'ev && ev.halt()');
function visit12_217_1(result) {
  _$jscoverage['/dialog.js'].branchData['217'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['207'][1].init(36, 33, 'parseInt(self.dMargin.val()) || 0');
function visit11_207_1(result) {
  _$jscoverage['/dialog.js'].branchData['207'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['190'][1].init(43, 15, 'ev && ev.halt()');
function visit10_190_1(result) {
  _$jscoverage['/dialog.js'].branchData['190'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['153'][1].init(146, 26, 'cfg[\'defaultHeight\'] || ""');
function visit9_153_1(result) {
  _$jscoverage['/dialog.js'].branchData['153'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['152'][1].init(85, 25, 'cfg[\'defaultWidth\'] || ""');
function visit8_152_1(result) {
  _$jscoverage['/dialog.js'].branchData['152'][1].ranCondition(result);
  return result;
}_$jscoverage['/dialog.js'].branchData['149'][1].init(531, 32, 'parseInt(r.style("margin")) || 0');
...
KISSY.add(function(S, require) {
  ...
  function FlashDialog(editor, config) {
    ...
    self.config = visit1_81_1(config || {});
  ...
  width: visit2_112_1(self._config_dwidth || "500px"), 
  mask: true}).render();
  ...
  visit12_217_1(ev && ev.halt());
  _$jscoverage['/dialog.js'].lineData[218]++;
  var self = this, editor = self.editor, dinfo = self._getDInfo(), url = visit13_221_1(dinfo && S.trim(dinfo.url)), attrs = visit14_222_1(dinfo && dinfo.attrs);
  _$jscoverage['/dialog.js'].lineData[223]++;
  if (visit15_223_1(!dinfo)) {
  ...
  if (visit17_233_1(self.selectedFlash)) {
