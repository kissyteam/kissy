...
KISSY.add(function(S, require) {
  ...
  'ul': insertUnorderedList}, KER = Editor.RangeType, ElementPath = Editor.ElementPath, Walker = Editor.Walker, UA = require('ua'), Node = require('node'), Dom = require('dom'), headerTagRegex = /^h[1-6]$/;
