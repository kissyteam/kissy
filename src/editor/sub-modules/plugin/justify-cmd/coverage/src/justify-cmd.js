...
if (! _$jscoverage['/justify-cmd.js']) {
  ...
  _$jscoverage['/justify-cmd.js'].lineData[5] = 0;
  _$jscoverage['/justify-cmd.js'].lineData[6] = 0;
  _$jscoverage['/justify-cmd.js'].lineData[9] = 0;
  ...
  _$jscoverage['/justify-cmd.js'].lineData[17] = 0;
  ...
  _$jscoverage['/justify-cmd.js'].lineData[29] = 0;
  _$jscoverage['/justify-cmd.js'].lineData[30] = 0;
  _$jscoverage['/justify-cmd.js'].lineData[31] = 0;
  _$jscoverage['/justify-cmd.js'].lineData[34] = 0;
...
if (! _$jscoverage['/justify-cmd.js'].branchData) {
  ...
  _$jscoverage['/justify-cmd.js'].branchData['17'] = [];
  _$jscoverage['/justify-cmd.js'].branchData['17'][1] = new BranchData();
  _$jscoverage['/justify-cmd.js'].branchData['22'] = [];
  _$jscoverage['/justify-cmd.js'].branchData['22'][1] = new BranchData();
  _$jscoverage['/justify-cmd.js'].branchData['36'] = [];
  _$jscoverage['/justify-cmd.js'].branchData['36'][1] = new BranchData();
...
_$jscoverage['/justify-cmd.js'].branchData['59'][2].init(271, 27, 'block.nodeName() === "body"');
function visit9_59_2(result) {
  _$jscoverage['/justify-cmd.js'].branchData['59'][2].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['59'][1].init(261, 37, '!block || block.nodeName() === "body"');
function visit8_59_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['59'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['58'][1].init(197, 29, 'path.block || path.blockLimit');
function visit7_58_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['58'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['55'][1].init(94, 33, 'selection && !selection.isInvalid');
function visit6_55_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['55'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['44'][1].init(18, 27, '!editor.hasCommand(command)');
function visit5_44_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['44'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['39'][1].init(161, 18, 'align == textAlign');
function visit4_39_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['39'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['36'][1].init(7, 121, 'block.css("text-align").replace(alignRemoveRegex, "") || default_align');
function visit3_36_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['36'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['22'][1].init(66, 25, 'isAlign(block, textAlign)');
function visit2_22_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['22'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].branchData['17'][1].init(294, 6, 'i >= 0');
function visit1_17_1(result) {
  _$jscoverage['/justify-cmd.js'].branchData['17'][1].ranCondition(result);
  return result;
}_$jscoverage['/justify-cmd.js'].lineData[5]++;
KISSY.add("editor/plugin/justify-cmd", function(S, Editor) {
  ...
  _$jscoverage['/justify-cmd.js'].lineData[9]++;
  function exec(editor, textAlign) {
    ...
    _$jscoverage['/justify-cmd.js'].lineData[17]++;
    for (var i = ranges.length - 1; visit1_17_1(i >= 0); i--) {
      ...
      while ((block = iterator.getNextParagraph())) {
        ...
        if (visit2_22_1(isAlign(block, textAlign))) {
    ...
    _$jscoverage['/justify-cmd.js'].lineData[29]++;
  ...
  _$jscoverage['/justify-cmd.js'].lineData[34]++;
  function isAlign(block, textAlign) {
    _$jscoverage['/justify-cmd.js'].functionData[2]++;
    _$jscoverage['/justify-cmd.js'].lineData[35]++;
    var align = visit3_36_1(block.css("text-align").replace(alignRemoveRegex, "") || default_align);
