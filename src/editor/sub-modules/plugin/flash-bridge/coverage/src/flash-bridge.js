...
function visit5_64_1(result) {
  ...
  return result;
}_$jscoverage['/flash-bridge.js'].branchData['50'][1].init(1192, 12, 'cfg.ajbridge');
...
function visit3_28_1(result) {
  ...
  return result;
}_$jscoverage['/flash-bridge.js'].branchData['25'][1].init(257, 16, 'cfg.params || {}');
function visit2_25_1(result) {
  _$jscoverage['/flash-bridge.js'].branchData['25'][1].ranCondition(result);
  return result;
}_$jscoverage['/flash-bridge.js'].branchData['24'][1].init(214, 15, 'cfg.attrs || {}');
