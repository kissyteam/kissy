...
function visit3_29_1(result) {
  ...
  return result;
}_$jscoverage['/cmd.js'].branchData['25'][1].init(415, 27, '!editor.hasCommand(queryUl)');
function visit2_25_1(result) {
  _$jscoverage['/cmd.js'].branchData['25'][1].ranCondition(result);
  return result;
}_$jscoverage['/cmd.js'].branchData['14'][1].init(18, 39, '!editor.hasCommand(insertUnorderedList)');
...
KISSY.add("editor/plugin/unordered-list/cmd", function(S, Editor, listCmd) {
  ...
  if (visit1_14_1(!editor.hasCommand(insertUnorderedList))) {
  ...
  if (visit2_25_1(!editor.hasCommand(queryUl))) {
