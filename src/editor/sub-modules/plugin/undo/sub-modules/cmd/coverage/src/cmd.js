...
KISSY.add("editor/plugin/undo/cmd", function(S, Editor) {
  ...
  function Snapshot(editor) {
    ...
    self.bookmarks = visit2_26_1(selection && selection.createBookmarks2(true));
  }
  ...
  return visit3_36_1(thisContents == otherContents);
}});
  ...
  if (visit4_76_1(keyCode in navigationKeyCodes || keyCode in modifierKeyCodes)) {
