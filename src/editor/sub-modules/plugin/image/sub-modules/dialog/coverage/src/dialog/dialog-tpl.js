...
if (! _$jscoverage['/dialog/dialog-tpl.js']) {
  ...
  _$jscoverage['/dialog/dialog-tpl.js'].lineData[4] = 0;
  _$jscoverage['/dialog/dialog-tpl.js'].lineData[5] = 0;
}
if (! _$jscoverage['/dialog/dialog-tpl.js'].functionData) {
  _$jscoverage['/dialog/dialog-tpl.js'].functionData = [];
  _$jscoverage['/dialog/dialog-tpl.js'].functionData[0] = 0;
}
if (! _$jscoverage['/dialog/dialog-tpl.js'].branchData) {
  _$jscoverage['/dialog/dialog-tpl.js'].branchData = {};
}
_$jscoverage['/dialog/dialog-tpl.js'].lineData[4]++;
KISSY.add(function() {
  _$jscoverage['/dialog/dialog-tpl.js'].functionData[0]++;
  _$jscoverage['/dialog/dialog-tpl.js'].lineData[5]++;
