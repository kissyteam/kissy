...
if (! _$jscoverage['/navigation-view.js'].branchData) {
  ...
  _$jscoverage['/navigation-view.js'].branchData['8'] = [];
  _$jscoverage['/navigation-view.js'].branchData['8'][1] = new BranchData();
...
function visit2_26_1(result) {
  ...
  return result;
}_$jscoverage['/navigation-view.js'].branchData['8'][1].init(130, 43, 'vendorInfo && vendorInfo.propertyNamePrefix');
function visit1_8_1(result) {
  _$jscoverage['/navigation-view.js'].branchData['8'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, require) {
  ...
  var vendorPrefix = visit1_8_1(vendorInfo && vendorInfo.propertyNamePrefix);
