...
if (! _$jscoverage['/navigation-view/bar-xtpl.js']) {
  ...
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[59] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[60] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[61] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[62] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[63] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[64] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[65] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[66] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[67] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[68] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[69] = 0;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[70] = 0;
}
if (! _$jscoverage['/navigation-view/bar-xtpl.js'].functionData) {
  ...
  _$jscoverage['/navigation-view/bar-xtpl.js'].functionData[2] = 0;
}
...
KISSY.add(function(S, require, exports, module) {
  ...
  _$jscoverage['/navigation-view/bar-xtpl.js'].functionData[2]++;
  ...
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[59]++;
  buffer += '">\r\n    <div class="';
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[60]++;
  var config16 = {};
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[61]++;
  var params17 = [];
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[62]++;
  params17.push('center');
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[63]++;
  config16.params = params17;
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[64]++;
  var id15 = runInlineCommandUtil(engine, scope, config16, "getBaseCssClasses", 7);
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[65]++;
  buffer += renderOutputUtil(id15, true);
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[66]++;
  buffer += '" id="ks-navigation-bar-center-';
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[67]++;
  var id18 = getPropertyOrRunCommandUtil(engine, scope, {}, "id", 0, 7);
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[68]++;
  buffer += renderOutputUtil(id18, true);
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[69]++;
  buffer += '"></div>\r\n</div>';
  _$jscoverage['/navigation-view/bar-xtpl.js'].lineData[70]++;
  return buffer;
};
});
