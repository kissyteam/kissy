...
if (! _$jscoverage['/mvc/view.js']) {
  ...
  _$jscoverage['/mvc/view.js'].lineData[67] = 0;
  _$jscoverage['/mvc/view.js'].lineData[74] = 0;
  _$jscoverage['/mvc/view.js'].lineData[93] = 0;
  _$jscoverage['/mvc/view.js'].lineData[94] = 0;
  _$jscoverage['/mvc/view.js'].lineData[95] = 0;
  _$jscoverage['/mvc/view.js'].lineData[97] = 0;
}
...
if (! _$jscoverage['/mvc/view.js'].branchData) {
  ...
  _$jscoverage['/mvc/view.js'].branchData['26'] = [];
  _$jscoverage['/mvc/view.js'].branchData['26'][1] = new BranchData();
  _$jscoverage['/mvc/view.js'].branchData['35'] = [];
  _$jscoverage['/mvc/view.js'].branchData['35'][1] = new BranchData();
  _$jscoverage['/mvc/view.js'].branchData['93'] = [];
  _$jscoverage['/mvc/view.js'].branchData['93'][1] = new BranchData();
}
_$jscoverage['/mvc/view.js'].branchData['93'][1].init(26, 20, 'typeof s == \'string\'');
function visit109_93_1(result) {
  _$jscoverage['/mvc/view.js'].branchData['93'][1].ranCondition(result);
  return result;
}_$jscoverage['/mvc/view.js'].branchData['35'][1].init(56, 7, 'prevVal');
function visit108_35_1(result) {
  _$jscoverage['/mvc/view.js'].branchData['35'][1].ranCondition(result);
  return result;
}_$jscoverage['/mvc/view.js'].branchData['26'][1].init(43, 27, 'events = this.get("events")');
function visit107_26_1(result) {
  _$jscoverage['/mvc/view.js'].branchData['26'][1].ranCondition(result);
  return result;
...
KISSY.add("mvc/view", function(S, Node, Base) {
  ...
  if (visit107_26_1(events = this.get("events"))) {
  ...
  _$jscoverage['/mvc/view.js'].lineData[67]++;
  return this;
}, 
  destroy: function() {
  _$jscoverage['/mvc/view.js'].functionData[7]++;
  _$jscoverage['/mvc/view.js'].lineData[74]++;
  this.get("el").remove();
}}, {
  ATTRS: {
  el: {
