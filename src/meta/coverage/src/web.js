...
if (! _$jscoverage['/web.js']) {
  ...
  _$jscoverage['/web.js'].lineData[24] = 0;
}
...
KISSY.config({
  packages: {
  gallery: {
  base: visit18_18_1(location.protocol === 'https') ? 'https://s.tbcdn.cn/s/kissy/gallery' : 'http://a.tbcdn.cn/s/kissy/gallery'}}});
