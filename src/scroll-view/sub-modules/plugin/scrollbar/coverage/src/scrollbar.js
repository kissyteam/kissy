...
KISSY.add(function(S, require) {
  ...
  function onScrollViewReflow() {
    ...
    if (visit29_18_1(!self.scrollBarX && scrollView.allowScroll.left)) {
  ...
  elBefore: scrollView.$contentEl};
    ...
    if (visit32_34_1(!self.scrollBarY && scrollView.allowScroll.top)) {
  ...
  if (visit35_67_1(self.scrollBarX)) {
  ...
  if (visit36_71_1(self.scrollBarY)) {
