...
KISSY.add(function(S, require) {
  ...
  function onScrollViewReflow() {
    ...
    if (visit30_18_1(!self.scrollBarX && scrollView.allowScroll.left)) {
  ...
  elBefore: scrollView.$contentEl};
    ...
    if (visit33_34_1(!self.scrollBarY && scrollView.allowScroll.top)) {
  ...
  if (visit36_67_1(self.scrollBarX)) {
  ...
  if (visit37_71_1(self.scrollBarY)) {
