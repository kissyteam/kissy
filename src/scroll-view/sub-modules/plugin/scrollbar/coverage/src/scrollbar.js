...
KISSY.add(function(S, require) {
  ...
  axis: 'x'};
      ...
      if (visit29_38_1(autoHideX !== undefined)) {
  ...
  if (visit30_44_1(self.scrollBarY)) {
  ...
  axis: 'y'};
      ...
      if (visit32_50_1(autoHideY !== undefined)) {
  ...
  if (visit33_59_1(self.scrollBarX)) {
  ...
  if (visit34_63_1(self.scrollBarY)) {
