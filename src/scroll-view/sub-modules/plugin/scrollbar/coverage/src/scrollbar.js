...
KISSY.add(function(S, require) {
  ...
  function onScrollViewReflow() {
    ...
    if (visit32_18_1(!self.scrollBarX && scrollView.allowScroll.left)) {
  ...
  elBefore: scrollView.$contentEl};
    ...
    if (visit35_34_1(!self.scrollBarY && scrollView.allowScroll.top)) {
  ...
  if (visit38_67_1(self.scrollBarX)) {
  ...
  if (visit39_71_1(self.scrollBarY)) {
