...
if (loc.search.indexOf('build') === -1 && loc.search.indexOf('min') === -1) {
    ...
    KISSY.config('packages', {
        ...
        'event/gesture/edge-pan': { 'base': '/kissy/src/event/sub-modules/gesture/edge-pan/src/edge-pan' },
        'event/gesture/pan': { 'base': '/kissy/src/event/sub-modules/gesture/pan/src/pan' },
