...
if (! _$jscoverage['/combobox.js']) {
  _$jscoverage['/combobox.js'] = {};
  _$jscoverage['/combobox.js'].lineData = [];
  _$jscoverage['/combobox.js'].lineData[6] = 0;
  _$jscoverage['/combobox.js'].lineData[7] = 0;
  _$jscoverage['/combobox.js'].lineData[8] = 0;
...
if (! _$jscoverage['/combobox.js'].functionData) {
  ...
  _$jscoverage['/combobox.js'].functionData[0] = 0;
}
if (! _$jscoverage['/combobox.js'].branchData) {
