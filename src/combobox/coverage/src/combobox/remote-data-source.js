...
KISSY.add(function(S, require) {
  ...
  self.caches = visit74_28_1(self.caches || {});
  _$jscoverage['/combobox/remote-data-source.js'].lineData[29]++;
  if (visit75_29_1(self.io)) {
  ...
  xhrCfg.data = visit79_43_1(xhrCfg.data || {});
