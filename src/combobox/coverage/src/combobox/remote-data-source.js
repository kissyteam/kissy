...
KISSY.add(function(S, require) {
  ...
  self.caches = visit83_28_1(self.caches || {});
  _$jscoverage['/combobox/remote-data-source.js'].lineData[29]++;
  if (visit84_29_1(self.io)) {
  ...
  xhrCfg.data = visit88_43_1(xhrCfg.data || {});
