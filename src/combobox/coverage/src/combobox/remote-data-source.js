...
KISSY.add(function(S, require) {
  ...
  self.caches = visit84_28_1(self.caches || {});
  _$jscoverage['/combobox/remote-data-source.js'].lineData[29]++;
  if (visit85_29_1(self.io)) {
  ...
  xhrCfg.data = visit89_43_1(xhrCfg.data || {});
