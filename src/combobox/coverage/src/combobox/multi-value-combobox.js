...
function visit117_245_2(result) {
...
function visit116_245_1(result) {
...
function visit115_242_1(result) {
...
function visit114_238_1(result) {
...
function visit113_233_1(result) {
...
function visit112_222_1(result) {
...
function visit107_208_1(result) {
...
function visit106_201_1(result) {
...
function visit105_197_1(result) {
...
function visit103_192_1(result) {
...
function visit101_184_1(result) {
...
KISSY.add(function(S, require) {
  ...
  function strContainsChar(str, c) {
    ...
    return visit86_14_1(c && visit87_14_2(str.indexOf(c) !== -1));
  }
  ...
  function beforeVisibleChange(e) {
    ...
    if (visit88_18_1(e.newVal && visit89_18_2(e.target === this.get('menu')))) {
  ...
  if (visit90_33_1(self.get('alignWithCursor'))) {
  ...
  if (visit91_51_1(separatorType !== SUFFIX)) {
    _$jscoverage['/combobox/multi-value-combobox.js'].lineData[52]++;
    if (visit92_52_1(strContainsChar(separator, token.charAt(0)))) {
    ...
    if (visit93_60_1(visit94_60_2(separatorType === SUFFIX) && strContainsChar(separator, token.charAt(l)))) {
  ...
  var self = this, input = self.get('input'), inputDesc = getInputDesc(self), tokens = inputDesc.tokens, tokenIndex = Math.max(0, inputDesc.tokenIndex), separator = self.get('separator'), cursorPosition, l, separatorType = self.get('separatorType'), nextToken = visit95_78_1(tokens[tokenIndex + 1] || ''), token = tokens[tokenIndex];
  _$jscoverage['/combobox/multi-value-combobox.js'].lineData[81]++;
  if (visit96_81_1(separatorType !== SUFFIX)) {
    ...
    if (visit97_83_1(value && !(visit98_83_2(nextToken && rWhitespace.test(nextToken.charAt(0)))))) {
    ...
    if (visit99_91_1(strContainsChar(separator, token.charAt(l)))) {
      ...
      if (visit100_93_1(separator.length === 1)) {
  ...
  function getInputDesc(self) {
    ...
    var input = self.get('input'), inputVal = self.get('value'), tokens = [], cache = [], literal = self.get('literal'), separator = self.get('separator'), separatorType = self.get('separatorType'), inLiteral = false, allowWhitespaceAsStandaloneToken = visit101_184_1(separatorType !== SUFFIX), cursorPosition = input.prop('selectionStart'), i, c, tokenIndex = -1;
    _$jscoverage['/combobox/multi-value-combobox.js'].lineData[190]++;
    for (i = 0; visit102_190_1(i < inputVal.length); i++) {
      _$jscoverage['/combobox/multi-value-combobox.js'].lineData[191]++;
      c = inputVal.charAt(i);
      _$jscoverage['/combobox/multi-value-combobox.js'].lineData[192]++;
      if (visit103_192_1(literal)) {
        _$jscoverage['/combobox/multi-value-combobox.js'].lineData[193]++;
        if (visit104_193_1(c === literal)) {
          _$jscoverage['/combobox/multi-value-combobox.js'].lineData[194]++;
          inLiteral = !inLiteral;
        }
      }
      _$jscoverage['/combobox/multi-value-combobox.js'].lineData[197]++;
      if (visit105_197_1(inLiteral)) {
      ...
      if (visit107_208_1(allowWhitespaceAsStandaloneToken && rWhitespace.test(c))) {
        ...
        if (visit109_214_1(strContainsChar(separator, c))) {
          ...
          if (visit110_215_1(separatorType === SUFFIX)) {
            ...
            if (visit112_222_1(cache.length)) {
