...
if (! _$jscoverage['/combobox/combobox-xtpl.js'].branchData) {
  ...
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['8'][2] = new BranchData();
}
_$jscoverage['/combobox/combobox-xtpl.js'].branchData['8'][2].init(165, 28, 'typeof module != "undefined"');
function visit2_8_2(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['8'][2].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['8'][1].init(165, 44, 'typeof module != "undefined" && module.kissy');
