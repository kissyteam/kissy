...
if (! _$jscoverage['/combobox/combobox-xtpl.js'].branchData) {
  ...
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['33'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['33'][1] = new BranchData();
  ...
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['72'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['72'][1] = new BranchData();
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['85'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['85'][1] = new BranchData();
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['103'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['103'][1] = new BranchData();
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['134'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['134'][1] = new BranchData();
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['177'] = [];
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['177'][1] = new BranchData();
}
_$jscoverage['/combobox/combobox-xtpl.js'].branchData['177'][1].init(7307, 37, 'commandRet35 && commandRet35.isBuffer');
function visit8_177_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['177'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['134'][1].init(5671, 37, 'commandRet26 && commandRet26.isBuffer');
function visit7_134_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['134'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['103'][1].init(4296, 37, 'commandRet19 && commandRet19.isBuffer');
function visit6_103_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['103'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['85'][1].init(1130, 37, 'commandRet16 && commandRet16.isBuffer');
function visit5_85_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['85'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['72'][1].init(540, 37, 'commandRet13 && commandRet13.isBuffer');
function visit4_72_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['72'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['46'][1].init(1931, 35, 'commandRet6 && commandRet6.isBuffer');
function visit3_46_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['46'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['33'][1].init(1405, 35, 'commandRet3 && commandRet3.isBuffer');
function visit2_33_1(result) {
  _$jscoverage['/combobox/combobox-xtpl.js'].branchData['33'][1].ranCondition(result);
  return result;
}_$jscoverage['/combobox/combobox-xtpl.js'].branchData['8'][1].init(142, 20, '"1.50" !== S.version');
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit4_72_1(commandRet13 && commandRet13.isBuffer)) {
  ...
  if (visit5_85_1(commandRet16 && commandRet16.isBuffer)) {
  ...
  if (visit6_103_1(commandRet19 && commandRet19.isBuffer)) {
  ...
  if (visit7_134_1(commandRet26 && commandRet26.isBuffer)) {
  ...
  if (visit8_177_1(commandRet35 && commandRet35.isBuffer)) {
