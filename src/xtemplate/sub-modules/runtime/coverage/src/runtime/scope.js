...
KISSY.add(function(S) {
  ...
  if (visit42_82_1(parts[0] === 'root')) {
    ...
    if (visit43_85_1(depth)) {
      _$jscoverage['/runtime/scope.js'].lineData[86]++;
      while (visit44_86_1(scope && depth--)) {
