...
if (! _$jscoverage['/compiler.js']) {
  ...
  _$jscoverage['/compiler.js'].lineData[69] = 0;
  ...
  _$jscoverage['/compiler.js'].lineData[298] = 0;
...
if (! _$jscoverage['/compiler.js'].branchData) {
  ...
  _$jscoverage['/compiler.js'].branchData['77'] = [];
  _$jscoverage['/compiler.js'].branchData['77'][1] = new BranchData();
  ...
  _$jscoverage['/compiler.js'].branchData['300'] = [];
  _$jscoverage['/compiler.js'].branchData['300'][1] = new BranchData();
  ...
  _$jscoverage['/compiler.js'].branchData['458'] = [];
  _$jscoverage['/compiler.js'].branchData['458'][1] = new BranchData();
}
_$jscoverage['/compiler.js'].branchData['458'][1].init(70, 12, 'config || {}');
function visit79_458_1(result) {
  _$jscoverage['/compiler.js'].branchData['458'][1].ranCondition(result);
  return result;
...
function visit57_138_1(result) {
  _$jscoverage['/compiler.js'].branchData['138'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['121'][1].init(102, 18, 'configName || \'{}\'');
function visit56_121_1(result) {
  _$jscoverage['/compiler.js'].branchData['121'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['110'][1].init(129, 14, 'configNameCode');
function visit55_110_1(result) {
  _$jscoverage['/compiler.js'].branchData['110'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['108'][1].init(39, 34, 'tplNode && self.genConfig(tplNode)');
function visit54_108_1(result) {
  _$jscoverage['/compiler.js'].branchData['108'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['107'][1].init(274, 10, 'depth == 0');
function visit53_107_1(result) {
  _$jscoverage['/compiler.js'].branchData['107'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['87'][1].init(1189, 7, '!global');
function visit52_87_1(result) {
  _$jscoverage['/compiler.js'].branchData['87'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['82'][1].init(59, 7, 'i < len');
function visit51_82_1(result) {
  _$jscoverage['/compiler.js'].branchData['82'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['81'][1].init(923, 10, 'statements');
function visit50_81_1(result) {
  _$jscoverage['/compiler.js'].branchData['81'][1].ranCondition(result);
  return result;
}_$jscoverage['/compiler.js'].branchData['77'][1].init(560, 7, 'natives');
function visit49_77_1(result) {
  _$jscoverage['/compiler.js'].branchData['77'][1].ranCondition(result);
  return result;
...
KISSY.add("xtemplate/compiler", function(S, parser, ast, XTemplateRuntime) {
  ...
  if (visit48_61_1(global)) {
    ...
    source.push('S = KISSY,' + 'config=this.config,' + 'escapeHtml = config.escapeHtml && S.escapeHtml,' + 'engine = this, ' + 'utils = config.utils;');
    _$jscoverage['/compiler.js'].lineData[69]++;
  ...
  if (visit53_107_1(depth == 0)) {
    _$jscoverage['/compiler.js'].lineData[108]++;
    var configNameCode = visit54_108_1(tplNode && self.genConfig(tplNode));
    _$jscoverage['/compiler.js'].lineData[109]++;
    var configName;
    _$jscoverage['/compiler.js'].lineData[110]++;
    if (visit55_110_1(configNameCode)) {
  ...
  source.push('var ' + idName + ' = getPropertyOrRunCommandUtil(engine,scopes,' + (visit56_121_1(configName || '{}')) + ',"' + idString + '",' + depth + ',' + idNode.lineNumber + ');');
  ...
  if (visit64_200_1(nextIdNameCode[0])) {
  ...
  if (visit66_216_1(nextIdNameCode[0])) {
  ...
  _$jscoverage['/compiler.js'].lineData[298]++;
  pushToArray(source, configNameCode[1]);
  _$jscoverage['/compiler.js'].lineData[300]++;
  if (visit68_300_1(!configName)) {
  ...
  if (visit69_308_1(programNode.inverse)) {
  ...
  if (visit70_315_1(tplNode.isInverted)) {
  ...
  var source = [], escaped = tplNode.escaped, genIdCode = this.genId(tplNode.path, tplNode);
  ...
  function outputVariable(expressionOrVariable, escaped, source) {
    ...
    source.push(tmp + ' = ' + '(' + tmp + ' === undefined ? "" : ' + tmp + ')' + ' + "";');
    _$jscoverage['/compiler.js'].lineData[408]++;
    source.push('buffer += ' + (escaped ? ('escapeHtml ? ' + 'escapeHtml(' + tmp + ') : ' + tmp) : tmp) + ';');
  }
