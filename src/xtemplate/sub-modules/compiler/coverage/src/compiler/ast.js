...
if (! _$jscoverage['/compiler/ast.js']) {
  ...
  _$jscoverage['/compiler/ast.js'].lineData[8] = 0;
  ...
  _$jscoverage['/compiler/ast.js'].lineData[21] = 0;
  _$jscoverage['/compiler/ast.js'].lineData[24] = 0;
  _$jscoverage['/compiler/ast.js'].lineData[26] = 0;
  _$jscoverage['/compiler/ast.js'].lineData[27] = 0;
  ...
  _$jscoverage['/compiler/ast.js'].lineData[40] = 0;
...
if (! _$jscoverage['/compiler/ast.js'].branchData) {
  ...
  _$jscoverage['/compiler/ast.js'].branchData['29'] = [];
  _$jscoverage['/compiler/ast.js'].branchData['29'][1] = new BranchData();
...
KISSY.add("xtemplate/compiler/ast", function(S) {
  ...
  _$jscoverage['/compiler/ast.js'].lineData[21]++;
  self.inverse = inverse;
};
  _$jscoverage['/compiler/ast.js'].lineData[24]++;
  ...
  self.tpl = tpl;
  _$jscoverage['/compiler/ast.js'].lineData[40]++;
