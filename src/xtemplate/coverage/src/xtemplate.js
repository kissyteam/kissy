...
KISSY.add(function(S, require) {
  ...
  function compile(tpl, config) {
    ...
    var cacheable = visit1_14_1(!config || visit2_14_2(config.cache !== false));
    _$jscoverage['/xtemplate.js'].lineData[16]++;
    if (visit3_16_1(cacheable && (fn = cache[tpl]))) {
      _$jscoverage['/xtemplate.js'].lineData[17]++;
      return fn;
    }
    _$jscoverage['/xtemplate.js'].lineData[20]++;
    fn = Compiler.compileToFn(tpl, visit4_20_1(config && config.name));
    _$jscoverage['/xtemplate.js'].lineData[22]++;
    if (visit5_22_1(cacheable)) {
  ...
  function XTemplate(tpl, config) {
    ...
    if (visit6_50_1(typeof tpl === 'string')) {
