...
var shopDsrHtml = function (scope, buffer, undefined) {
    ...
    option0.fn = function (scope, buffer) {
        ...
        option40.inverse = function (scope, buffer) {
            buffer.write('\r\n                ', 0);
            var option44 = { escape: 1 };
            var params45 = [];
            var id46 = scope.resolve([
                    'shopDsr',
                    'data',
...
shopDsrHtml.TPL_NAME = module.name;
shopDsrHtml.version = '5.0.0';
module.exports = shopDsrHtml;