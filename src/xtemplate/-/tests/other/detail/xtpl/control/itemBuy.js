...
var itemBuyHtml = function (scope, buffer, undefined) {
...
itemBuyHtml.TPL_NAME = module.name;
itemBuyHtml.version = '5.0.0';
module.exports = itemBuyHtml;