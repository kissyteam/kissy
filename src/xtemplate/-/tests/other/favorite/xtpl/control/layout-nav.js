...
var layoutNavXtpl = function (scope, buffer, undefined) {
    ...
    option56.fn = function (scope, buffer) {
        ...
        option60.fn = function (scope, buffer) {
            ...
            var id71 = scope.resolve([
                    'spm',
                    'quanzhansearchbutton'
                ], 0);
            buffer.write(id71, true);
            buffer.write('">\r\n                                        <a pointname="', 0);
            var id72 = scope.resolve([
                    'spm',
                    'mmstatsearchtb'
                ], 0);
    ...
    option56.inverse = function (scope, buffer) {
        buffer.write('\r\n                            ', 0);
        var option83 = { escape: 1 };
        var params84 = [];
        var id85 = scope.resolve([
                'queryData',
                'keyword'
            ], 0);
        params84.push(id85);
        ...
        option83.fn = function (scope, buffer) {
            buffer.write('\r\n                                ', 0);
            var option86 = { escape: 1 };
            var hash87 = {};
            var id88 = scope.resolve([
                    'spm',
                    'shoucangsearchbutton'
                ], 0);
        ...
        option83.inverse = function (scope, buffer) {
            buffer.write('\r\n                                ', 0);
            var option94 = { escape: 1 };
            var hash95 = {};
            var id96 = scope.resolve([
                    'spm',
                    'quanzhansearchbutton'
                ], 0);
...
layoutNavXtpl.TPL_NAME = module.name;
layoutNavXtpl.version = '5.0.0';
module.exports = layoutNavXtpl;