...
var itemPriceStepHtml = function (scope, buffer, undefined) {
...
itemPriceStepHtml.TPL_NAME = module.name;
itemPriceStepHtml.version = '5.0.0';
module.exports = itemPriceStepHtml;