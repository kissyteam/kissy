...
KISSY.add(function (S, require, exports, module) {
        ...
        var itemCollectLayout = function (scope, buffer, session, undefined) {
            var engine = this,
            ...
            var callRet5
            callRet5 = includeCommand.call(engine, scope, option3, buffer, 6, session);
            ...
            var id6 = scope.resolve(["spm", "body"], 0);
            buffer.write(id6, true);
            buffer.write('">\n\n    <script src="', 0);
            var id7 = scope.resolve(["config", "server"], 0);
            buffer.write(id7, true);
            buffer.write('/', 0);
            var id8 = scope.resolve(["config", "version"], 0);
            ...
            var callRet11
            callRet11 = callFnUtil(engine, scope, option9, buffer, ["vmcommon"], 0, 17);
            ...
            var callRet14
            callRet14 = callFnUtil(engine, scope, option12, buffer, ["tms"], 0, 21);
            ...
            var callRet17
            callRet17 = includeCommand.call(engine, scope, option15, buffer, 25, session);
            ...
            var callRet20
            callRet20 = blockCommand.call(engine, scope, option18, buffer, 27, session);
            ...
            var callRet23
            callRet23 = includeCommand.call(engine, scope, option21, buffer, 32, session);
            ...
            var callRet26
            callRet26 = callFnUtil(engine, scope, option24, buffer, ["vmcommon"], 0, 35);
            ...
            var id27 = scope.resolve(["info", "jsmod"], 0);
            ...
            var callRet30
            callRet30 = callFnUtil(engine, scope, option28, buffer, ["tms"], 0, 44);
            ...
            var id31 = scope.resolve(["spm", "appendBox"], 0);
            buffer.write(id31, true);
            buffer.write('"></div>\n\n</body>\n</html>\n', 0);
            return buffer;
        };
itemCollectLayout.TPL_NAME = module.name;
return itemCollectLayout
});