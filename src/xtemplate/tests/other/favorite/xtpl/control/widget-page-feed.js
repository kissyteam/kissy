...
var widgetPageFeedXtpl = function (scope, buffer, undefined) {
    ...
    option52.inverse = function (scope, buffer) {
        ...
        option106.fn = function (scope, buffer) {
            ...
            option113.fn = function (scope, buffer) {
                buffer.write('\r\n                        ', 0);
                var option117 = { escape: 1 };
                var params118 = [];
                var id119 = scope.resolve(['this'], 0);
                var exp121 = id119;
                var id120 = scope.resolve([
                        'root',
                        'prepage'
                    ], 0);
                exp121 = id119 === id120;
                ...
                option122.inverse = function (scope, buffer) {
                    ...
                    option144.fn = function (scope, buffer) {
                        buffer.write('\r\n                                ', 0);
                        var option149 = { escape: 1 };
                        var params150 = [];
                        var id151 = scope.resolve(['this'], 0);
                        var exp153 = id151;
                        var id152 = scope.resolve([
                                'root',
                                'currentpage'
                            ], 0);
                        exp153 = id151 === id152;
            ...
            option113.inverse = function (scope, buffer) {
                ...
                option161.fn = function (scope, buffer) {
                    buffer.write('\r\n                            ', 0);
                    var option165 = { escape: 1 };
                    var params166 = [];
                    var id167 = scope.resolve(['this'], 0);
                    var exp169 = id167;
                    var id168 = scope.resolve([
                            'root',
                            'currentpage'
                        ], 0);
                    exp169 = id167 === id168;
                    ...
                    buffer.write('\r\n                            ', 0);
                    var option177 = { escape: 1 };
                    var params178 = [];
                    var id179 = scope.resolve(['this'], 0);
                    var exp181 = id179;
                    var id180 = scope.resolve([
                            'root',
                            'nextpage'
                        ], 0);
                    exp181 = id179 === id180;
                ...
                option161.inverse = function (scope, buffer) {
                    buffer.write('\r\n                            ', 0);
                    var option182 = { escape: 1 };
                    var params183 = [];
                    var id184 = scope.resolve(['this'], 0);
                    var exp186 = id184;
                    var id185 = scope.resolve([
                            'root',
                            'nextpage'
                        ], 0);
                    exp186 = id184 === id185;
        ...
        option187.fn = function (scope, buffer) {
            buffer.write('\r\n                    ', 0);
            var option194 = { escape: 1 };
            var params195 = [];
            var id196 = scope.resolve(['this'], 0);
            var exp198 = id196;
            var id197 = scope.resolve([
                    'root',
                    'currentpage'
                ], 0);
            exp198 = id196 === id197;
...
widgetPageFeedXtpl.TPL_NAME = module.name;
widgetPageFeedXtpl.version = '5.0.0';
module.exports = widgetPageFeedXtpl;