...
KISSY.add(function (S, require, exports, module) {
        ...
        var itemPrice = function (scope, buffer, session, undefined) {
            ...
            option0.fn = function (scope, buffer) {
                ...
                var callRet8
                callRet8 = callFnUtil(engine, scope, option5, buffer, ["formatPrice"], 0, 2);
                ...
                option3.hash = hash4;
                var callRet9
                callRet9 = setCommand.call(engine, scope, option3, buffer, 2, session);
                ...
                var callRet15
                callRet15 = callFnUtil(engine, scope, option12, buffer, ["formatPrice"], 0, 3);
                ...
                var callRet16
                callRet16 = setCommand.call(engine, scope, option10, buffer, 3, session);
            ...
            option0.inverse = function (scope, buffer) {
                ...
                option17.fn = function (scope, buffer) {
                    ...
                    var callRet27
                    callRet27 = callFnUtil(engine, scope, option24, buffer, ["formatPrice"], 0, 6);
                    ...
                    var callRet28
                    callRet28 = setCommand.call(engine, scope, option22, buffer, 6, session);
                    ...
                    var callRet34
                    callRet34 = callFnUtil(engine, scope, option31, buffer, ["formatPrice"], 0, 7);
                    ...
                    var callRet35
                    callRet35 = setCommand.call(engine, scope, option29, buffer, 7, session);
                ...
                option17.inverse = function (scope, buffer) {
                    ...
                    var callRet38
                    callRet38 = setCommand.call(engine, scope, option36, buffer, 10, session);
                    ...
                    var callRet44
                    callRet44 = callFnUtil(engine, scope, option41, buffer, ["formatPrice"], 0, 11);
                    ...
                    var callRet45
                    callRet45 = setCommand.call(engine, scope, option39, buffer, 11, session);
                ...
                buffer = ifCommand.call(engine, scope, option17, buffer, 5, session);
                buffer.write('', 0);
                return buffer;
            };
            ...
            var option48 = {};
            var callRet49
            callRet49 = callFnUtil(engine, scope, option48, buffer, ["pricePromotion"], 0, 14);
            ...
            var callRet50
            callRet50 = setCommand.call(engine, scope, option46, buffer, 14, session);
            ...
            var option53 = {};
            var callRet54
            callRet54 = callFnUtil(engine, scope, option53, buffer, ["priceCssTag"], 0, 15);
            ...
            var callRet55
            callRet55 = setCommand.call(engine, scope, option51, buffer, 15, session);
            ...
            var option58 = {};
            var callRet59
            callRet59 = callFnUtil(engine, scope, option58, buffer, ["priceLabel"], 0, 16);
            ...
            var callRet60
            callRet60 = setCommand.call(engine, scope, option56, buffer, 16, session);
            ...
            var option63 = {};
            var callRet64
            callRet64 = callFnUtil(engine, scope, option63, buffer, ["priceName"], 0, 17);
            ...
            var callRet65
            callRet65 = setCommand.call(engine, scope, option61, buffer, 17, session);
            ...
            option66.fn = function (scope, buffer) {
                ...
                buffer = ifCommand.call(engine, scope, option69, buffer, 21, session);
                buffer.write('\n        <div class="g_price">\n            <span>&yen;</span>\n            <strong>', 0);
            ...
            buffer = ifCommand.call(engine, scope, option66, buffer, 20, session);
            buffer.write('\n\n    <div class="g_price ', 0);
            var option77 = {
                escape: 1
            };
            ...
            buffer = ifCommand.call(engine, scope, option77, buffer, 33, session);
            buffer.write('">\n        ', 0);
            var option80 = {
                escape: 1
            };
            ...
            buffer = ifCommand.call(engine, scope, option80, buffer, 34, session);
            buffer.write('\n    </div>\n\n    ', 0);
            var option85 = {
                escape: 1
            };
            ...
            buffer = ifCommand.call(engine, scope, option85, buffer, 42, session);
            buffer.write('\n\n</div>\n', 0);
            return buffer;
        };
