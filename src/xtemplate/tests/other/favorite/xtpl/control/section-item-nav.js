...
var sectionItemNavXtpl = function (scope, buffer, undefined) {
...
sectionItemNavXtpl.TPL_NAME = module.name;
sectionItemNavXtpl.version = '5.0.0';
module.exports = sectionItemNavXtpl;