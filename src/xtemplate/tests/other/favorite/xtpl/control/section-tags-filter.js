...
KISSY.add(function (S, require, exports, module) {
        ...
        var sectionTagsFilter = function (scope, buffer, session, undefined) {
            var engine = this,
            ...
            option0.hash = hash1;
            var callRet2
            callRet2 = setCommand.call(engine, scope, option0, buffer, 1, session);
            ...
            option3.hash = hash4;
            var callRet5
            callRet5 = setCommand.call(engine, scope, option3, buffer, 2, session);
            ...
            var exp10 = id8;
            if ((id8)) {
                var id9 = scope.resolve(["frontCategoryList", "length"], 0);
                exp10 = id9;
            }
            params7.push(exp10);
            ...
            option6.fn = function (scope, buffer) {
                ...
                var callRet16
                callRet16 = callFnUtil(engine, scope, option13, buffer, ["count"], 0, 5);
                ...
                var callRet17
                callRet17 = setCommand.call(engine, scope, option11, buffer, 5, session);
            ...
            buffer = ifCommand.call(engine, scope, option6, buffer, 4, session);
            buffer.write('\n\n', 0);
            var option18 = {
                escape: 1
            };
            ...
            var exp22 = id20;
            if ((id20)) {
                var id21 = scope.resolve(["tagList", "length"], 0);
                exp22 = id21;
            }
            params19.push(exp22);
            ...
            option18.fn = function (scope, buffer) {
                ...
                var callRet28
                callRet28 = callFnUtil(engine, scope, option25, buffer, ["count"], 0, 9);
                ...
                var callRet29
                callRet29 = setCommand.call(engine, scope, option23, buffer, 9, session);
            ...
            buffer = ifCommand.call(engine, scope, option18, buffer, 8, session);
            buffer.write('\n\n', 0);
            var option30 = {
                escape: 1
            };
            ...
            var callRet32
            callRet32 = setCommand.call(engine, scope, option30, buffer, 12, session);
            ...
            var params34 = [];
            var id35 = scope.resolve(["info", "pageType"], 0);
            var exp36 = id35;
            exp36 = (id35) === ('shop');
            params34.push(exp36);
            ...
            option33.fn = function (scope, buffer) {
                ...
                var callRet39
                callRet39 = setCommand.call(engine, scope, option37, buffer, 14, session);
            ...
            buffer = ifCommand.call(engine, scope, option33, buffer, 13, session);
            buffer.write('\n\n<div id="fav-class">\n    <div class="mercury-map clearfix" data-spm="', 0);
            var id40 = scope.resolve(["spm", "tag"], 0);
            buffer.write(id40, true);
            buffer.write('">\n        <div class="mercury-map-wrap">\n            <div class="mod mod-a" style="height: 24px">\n                <div class="mod-wrap">\n                    <a data-spm="', 0);
            var id41 = scope.resolve(["spm", "tagAll"], 0);
            ...
            var params43 = [];
            var id44 = scope.resolve(["queryData", "tagname"], 0);
            var exp47 = !(id44);
            if ((!(id44))) {
                var id45 = scope.resolve(["queryData", "frontCategory"], 0);
                var exp46 = id45;
                exp46 = (id45) < (1);
                exp47 = exp46;
            }
            ...
            buffer = ifCommand.call(engine, scope, option42, buffer, 23, session);
            buffer.write('"\n                        href="', 0);
            var option48 = {};
            var params49 = [];
            ...
            var callRet51
            callRet51 = callFnUtil(engine, scope, option48, buffer, ["resetUrl"], 0, 24);
            ...
            buffer = ifCommand.call(engine, scope, option52, buffer, 27, session);
            buffer.write('\n\n                    </a>\n                </div>\n            </div>\n\n            ', 0);
            var option57 = {
                escape: 1
            };
            ...
            buffer = ifCommand.call(engine, scope, option57, buffer, 37, session);
            buffer.write('\n\n                <div class="mod-wrap">\n                    <ul>\n                        ', 0);
            var option60 = {
                escape: 1
            };
            ...
            option60.fn = function (scope, buffer) {
                ...
                var callRet67
                callRet67 = setCommand.call(engine, scope, option63, buffer, 47, session);
                ...
                buffer.write('\n                                <a data-spm="', 0);
                var id68 = scope.resolve(["spm", "tagCategory"], 0);
                ...
                var params70 = [];
                var id71 = scope.resolve(["queryData", "frontCategory"], 0);
                var exp73 = id71;
                ...
                buffer = ifCommand.call(engine, scope, option69, buffer, 49, session);
                buffer.write('"\n                                    href="', 0);
                var option74 = {};
                var params75 = [];
                var id76 = scope.resolve(["root", "pageLink"], 0);
                params75.push(id76);
                var id77 = scope.resolve(["query"], 0);
                params75.push(id77);
                option74.params = params75;
                var callRet78
                callRet78 = callFnUtil(engine, scope, option74, buffer, ["resetUrl"], 0, 50);
            ...
            buffer = eachCommand.call(engine, scope, option60, buffer, 45, session);
            buffer.write('\n                    </ul>\n                </div>\n            </div>\n\n            ', 0);
            var option82 = {
                escape: 1
            };
            ...
            option82.fn = function (scope, buffer) {
                ...
                buffer = ifCommand.call(engine, scope, option85, buffer, 62, session);
                buffer.write('"\n                    style="height:24px">\n                    <div class="mod-wrap">\n                        <ul>\n                            ', 0);
                var option88 = {
                    escape: 1
                };
                ...
                option88.fn = function (scope, buffer) {
                    ...
                    option91.fn = function (scope, buffer) {
                        ...
                        var callRet97
                        callRet97 = setCommand.call(engine, scope, option95, buffer, 69, session);
                    ...
                    option91.inverse = function (scope, buffer) {
                        ...
                        var callRet100
                        callRet100 = setCommand.call(engine, scope, option98, buffer, 71, session);
                    ...
                    buffer = ifCommand.call(engine, scope, option91, buffer, 68, session);
                    buffer.write('\n\n                                    ', 0);
                    var option101 = {
                        escape: 1
                    };
                    ...
                    option101.fn = function (scope, buffer) {
                        ...
                        var params105 = [];
                        var id106 = scope.resolve(["root", "queryData", "tagname"], 0);
                        var exp108 = id106;
                        ...
                        option104.fn = function (scope, buffer) {
                            ...
                            buffer.write('"\n                                                data-type="', 0);
                            var id110 = scope.resolve(["root", "pageTypeFlag"], 0);
                        ...
                        option104.inverse = function (scope, buffer) {
                            ...
                            var callRet117
                            callRet117 = setCommand.call(engine, scope, option113, buffer, 85, session);
                            ...
                            buffer.write('\n                                            <a  data-spm="', 0);
                            var id118 = scope.resolve(["spm", "tagTag"], 0);
                            ...
                            var params120 = [];
                            var id121 = scope.resolve(["root", "pageLink"], 0);
                            params120.push(id121);
                            var id122 = scope.resolve(["query"], 0);
                            params120.push(id122);
                            option119.params = params120;
                            var callRet123
                            callRet123 = callFnUtil(engine, scope, option119, buffer, ["resetUrl"], 0, 88);
                            ...
                            buffer.write('"\n                                                data-type="', 0);
                            var id126 = scope.resolve(["root", "pageTypeFlag"], 0);
                        ...
                        buffer = ifCommand.call(engine, scope, option104, buffer, 75, session);
                        buffer.write('\n                                    ', 0);
                        return buffer;
                    };
                    option101.inverse = function (scope, buffer) {
                        buffer.write('\n                                     <a  data-spm="', 0);
                        var id130 = scope.resolve(["spm", "tagTag"], 0);
                        ...
                        var params132 = [];
                        var id133 = scope.resolve(["queryData", "tagname"], 0);
                        ...
                        buffer = ifCommand.call(engine, scope, option131, buffer, 99, session);
                        buffer.write('"\n                                         href="', 0);
                        var option134 = {};
                        var params135 = [];
                        var id136 = scope.resolve(["root", "pageLink"], 0);
                        params135.push(id136);
                        option134.params = params135;
                        var callRet137
                        callRet137 = callFnUtil(engine, scope, option134, buffer, ["resetUrl"], 0, 100);
                    ...
                    buffer = ifCommand.call(engine, scope, option101, buffer, 74, session);
                    buffer.write('\n                                </li>\n                            ', 0);
                    return buffer;
                };
                buffer = eachCommand.call(engine, scope, option88, buffer, 66, session);
                buffer.write('\n\n\n                        </ul>\n                    </div>\n                </div>\n            ', 0);
                return buffer;
            };
            buffer = ifCommand.call(engine, scope, option82, buffer, 61, session);
            ...
            option140.fn = function (scope, buffer) {
                ...
                var callRet149
                callRet149 = setCommand.call(engine, scope, option147, buffer, 117, session);
            ...
            option140.inverse = function (scope, buffer) {
                ...
                var callRet152
                callRet152 = setCommand.call(engine, scope, option150, buffer, 119, session);
            ...
            buffer = ifCommand.call(engine, scope, option140, buffer, 116, session);
            buffer.write('\n\n                    <a pointname="', 0);
            var id153 = scope.resolve(["spm", "mmstattagmore"], 0);
...
sectionTagsFilter.TPL_NAME = module.name;
return sectionTagsFilter
});