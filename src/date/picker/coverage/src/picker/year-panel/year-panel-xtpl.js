...
if (! _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['108'] = [];
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['108'][1] = new BranchData();
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'] = [];
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][1] = new BranchData();
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][2] = new BranchData();
}
_$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][2].init(5444, 10, 'id31 === 0');
function visit72_113_2(result) {
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][2].ranCondition(result);
  return result;
}_$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][1].init(5436, 18, 'id31 || id31 === 0');
function visit71_113_1(result) {
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['113'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['108'][1].init(5169, 10, 'moduleWrap');
function visit70_108_1(result) {
  _$jscoverage['/picker/year-panel/year-panel-xtpl.js'].branchData['108'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit71_113_1(id31 || visit72_113_2(id31 === 0))) {
