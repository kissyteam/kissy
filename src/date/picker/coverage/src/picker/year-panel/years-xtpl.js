...
if (! _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['56'] = [];
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['56'][1] = new BranchData();
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['76'] = [];
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['76'][1] = new BranchData();
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['96'] = [];
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['96'][1] = new BranchData();
}
_$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['96'][1].init(2889, 11, 'id27 > id28');
function visit77_96_1(result) {
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['96'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['76'][1].init(1869, 11, 'id20 < id21');
function visit76_76_1(result) {
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['76'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['56'][1].init(849, 13, 'id13 === id14');
function visit75_56_1(result) {
  _$jscoverage['/picker/year-panel/years-xtpl.js'].branchData['56'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, require, exports, module) {
  ...
  params12.push(visit75_56_1(id13 === id14));
  ...
  params19.push(visit76_76_1(id20 < id21));
  ...
  params26.push(visit77_96_1(id27 > id28));
