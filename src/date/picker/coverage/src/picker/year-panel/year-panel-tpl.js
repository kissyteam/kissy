...
if (! _$jscoverage['/picker/year-panel/year-panel-tpl.js']) {
  _$jscoverage['/picker/year-panel/year-panel-tpl.js'] = {};
  _$jscoverage['/picker/year-panel/year-panel-tpl.js'].lineData = [];
  _$jscoverage['/picker/year-panel/year-panel-tpl.js'].lineData[4] = 0;
}
if (! _$jscoverage['/picker/year-panel/year-panel-tpl.js'].functionData) {
  _$jscoverage['/picker/year-panel/year-panel-tpl.js'].functionData = [];
}
if (! _$jscoverage['/picker/year-panel/year-panel-tpl.js'].branchData) {
  _$jscoverage['/picker/year-panel/year-panel-tpl.js'].branchData = {};
}
_$jscoverage['/picker/year-panel/year-panel-tpl.js'].lineData[4]++;
