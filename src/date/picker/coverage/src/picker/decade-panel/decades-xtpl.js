...
if (! _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][2] = new BranchData();
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][3] = new BranchData();
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['74'] = [];
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['74'][1] = new BranchData();
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['94'] = [];
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['94'][1] = new BranchData();
}
_$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['94'][1].init(2878, 11, 'id28 > id29');
function visit19_94_1(result) {
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['94'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['74'][1].init(1855, 11, 'id21 < id22');
function visit18_74_1(result) {
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['74'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][3].init(33, 12, 'id14 <= id15');
function visit17_54_3(result) {
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][3].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][2].init(15, 12, 'id12 <= id13');
function visit16_54_2(result) {
  _$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][2].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decades-xtpl.js'].branchData['54'][1].init(813, 31, '(id12 <= id13) && (id14 <= id15)');
...
KISSY.add(function(S, require, exports, module) {
  ...
  params11.push(visit15_54_1((visit16_54_2(id12 <= id13)) && (visit17_54_3(id14 <= id15))));
  ...
  params20.push(visit18_74_1(id21 < id22));
  ...
  params27.push(visit19_94_1(id28 > id29));
