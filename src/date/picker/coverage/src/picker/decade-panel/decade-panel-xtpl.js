...
if (! _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'] = [];
  _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][1] = new BranchData();
  _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][2] = new BranchData();
}
_$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][2].init(4639, 10, 'id26 === 0');
function visit12_99_2(result) {
  _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][2].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][1].init(4631, 18, 'id26 || id26 === 0');
function visit11_99_1(result) {
  _$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['99'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/decade-panel/decade-panel-xtpl.js'].branchData['94'][1].init(4360, 10, 'moduleWrap');
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit11_99_1(id26 || visit12_99_2(id26 === 0))) {
