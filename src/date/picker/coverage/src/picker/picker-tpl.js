...
if (! _$jscoverage['/picker/picker-tpl.js']) {
  _$jscoverage['/picker/picker-tpl.js'] = {};
  _$jscoverage['/picker/picker-tpl.js'].lineData = [];
  _$jscoverage['/picker/picker-tpl.js'].lineData[4] = 0;
}
if (! _$jscoverage['/picker/picker-tpl.js'].functionData) {
  _$jscoverage['/picker/picker-tpl.js'].functionData = [];
}
if (! _$jscoverage['/picker/picker-tpl.js'].branchData) {
  _$jscoverage['/picker/picker-tpl.js'].branchData = {};
}
_$jscoverage['/picker/picker-tpl.js'].lineData[4]++;
