...
if (! _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['98'] = [];
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['98'][1] = new BranchData();
}
_$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['98'][1].init(5258, 10, 'moduleWrap');
function visit22_98_1(result) {
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['98'][1].ranCondition(result);
  return result;
