...
if (! _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['8'][2] = new BranchData();
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['95'] = [];
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['95'][1] = new BranchData();
}
_$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['95'][1].init(5360, 10, 'moduleWrap');
function visit22_95_1(result) {
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['95'][1].ranCondition(result);
  return result;
}_$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['8'][2].init(165, 28, 'typeof module != "undefined"');
function visit21_8_2(result) {
  _$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['8'][2].ranCondition(result);
  return result;
}_$jscoverage['/picker/month-panel/month-panel-xtpl.js'].branchData['8'][1].init(165, 44, 'typeof module != "undefined" && module.kissy');
function visit20_8_1(result) {
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit20_8_1(visit21_8_2(typeof module != "undefined") && module.kissy)) {
