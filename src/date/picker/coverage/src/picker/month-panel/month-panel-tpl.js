...
if (! _$jscoverage['/picker/month-panel/month-panel-tpl.js']) {
  _$jscoverage['/picker/month-panel/month-panel-tpl.js'] = {};
  _$jscoverage['/picker/month-panel/month-panel-tpl.js'].lineData = [];
  _$jscoverage['/picker/month-panel/month-panel-tpl.js'].lineData[4] = 0;
}
if (! _$jscoverage['/picker/month-panel/month-panel-tpl.js'].functionData) {
  _$jscoverage['/picker/month-panel/month-panel-tpl.js'].functionData = [];
}
if (! _$jscoverage['/picker/month-panel/month-panel-tpl.js'].branchData) {
  _$jscoverage['/picker/month-panel/month-panel-tpl.js'].branchData = {};
}
_$jscoverage['/picker/month-panel/month-panel-tpl.js'].lineData[4]++;
