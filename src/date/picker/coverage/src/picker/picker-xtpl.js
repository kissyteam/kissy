...
if (! _$jscoverage['/picker/picker-xtpl.js']) {
  ...
  _$jscoverage['/picker/picker-xtpl.js'].lineData[236] = 0;
  _$jscoverage['/picker/picker-xtpl.js'].lineData[237] = 0;
}
...
if (! _$jscoverage['/picker/picker-xtpl.js'].branchData) {
  ...
  _$jscoverage['/picker/picker-xtpl.js'].branchData['193'] = [];
  _$jscoverage['/picker/picker-xtpl.js'].branchData['193'][1] = new BranchData();
}
_$jscoverage['/picker/picker-xtpl.js'].branchData['193'][1].init(10711, 12, 'id67 || id68');
function visit30_193_1(result) {
  _$jscoverage['/picker/picker-xtpl.js'].branchData['193'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, require, exports, module) {
  ...
  params66.push(visit30_193_1(id67 || id68));
  ...
  _$jscoverage['/picker/picker-xtpl.js'].lineData[236]++;
  buffer += runBlockCommandUtil(engine, scope, config65, "if", 68);
  _$jscoverage['/picker/picker-xtpl.js'].lineData[237]++;
  return buffer;
};
});
