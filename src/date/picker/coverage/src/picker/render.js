...
KISSY.add(function(S, require) {
  ...
  function isSameDay(one, two) {
    ...
    return visit32_33_1(visit33_33_2(one.getYear() === two.getYear()) && visit34_34_1(visit35_34_2(one.getMonth() === two.getMonth()) && visit36_35_1(one.getDayOfMonth() === two.getDayOfMonth())));
  }
  ...
  function isSameMonth(one, two) {
    ...
    return visit37_39_1(visit38_39_2(one.getYear() === two.getYear()) && visit39_40_1(one.getMonth() === two.getMonth()));
  }
  ...
  function beforeCurrentMonthYear(current, today) {
    ...
    if (visit40_44_1(current.getYear() < today.getYear())) {
      _$jscoverage['/picker/render.js'].lineData[45]++;
      return 1;
    }
    _$jscoverage['/picker/render.js'].lineData[47]++;
    return visit41_47_1(visit42_47_2(current.getYear() === today.getYear()) && visit43_48_1(current.getMonth() < today.getMonth()));
  }
  ...
  function afterCurrentMonthYear(current, today) {
    ...
    if (visit44_52_1(current.getYear() > today.getYear())) {
      _$jscoverage['/picker/render.js'].lineData[53]++;
      return 1;
    }
    _$jscoverage['/picker/render.js'].lineData[55]++;
    return visit45_55_1(visit46_55_2(current.getYear() === today.getYear()) && visit47_56_1(current.getMonth() > today.getMonth()));
  }
  ...
  for (var i = 0; visit48_104_1(i < DATE_COL_COUNT); i++) {
  ...
  content: dateTable[passed].getWeekOfYear()});
    ...
    for (j = 0; visit54_179_1(j < DATE_COL_COUNT); j++) {
      ...
      if (visit55_185_1(isSameDay(current, today))) {
        _$jscoverage['/picker/render.js'].lineData[186]++;
        cls += ' ' + todayClass;
      }
      _$jscoverage['/picker/render.js'].lineData[188]++;
      if (visit56_188_1(!isClear && isSameDay(current, value))) {
      ...
      if (visit60_204_1(!(visit61_204_2(dateRender && (dateHtml = dateRender(current, value)))))) {
  ...
  if (visit63_252_1(isSameMonth(preValue, value))) {
    ...
    if (visit64_258_1(!(visit65_258_2(disabledDate && disabledDate(value, value))))) {
