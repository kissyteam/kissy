...
if (! _$jscoverage['/swf/ua.js']) {
  ...
  _$jscoverage['/swf/ua.js'].lineData[10] = 0;
...
KISSY.add(function(S, require) {
  ...
  _$jscoverage['/swf/ua.js'].lineData[10]++;
  ...
  function getNumberVersion(ver) {
    ...
    if (visit5_62_1(util.isArray(arr))) {
