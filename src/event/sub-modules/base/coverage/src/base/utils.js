...
if (! _$jscoverage['/base/utils.js'].branchData) {
  ...
  _$jscoverage['/base/utils.js'].branchData['12'] = [];
  _$jscoverage['/base/utils.js'].branchData['12'][1] = new BranchData();
  _$jscoverage['/base/utils.js'].branchData['19'] = [];
  _$jscoverage['/base/utils.js'].branchData['19'][1] = new BranchData();
...
KISSY.add(function(S, require) {
  ...
  function getTypedGroups(type) {
    ...
    if (visit13_12_1(type.indexOf('.') < 0)) {
