...
if (! _$jscoverage['/util/single-touch.js']) {
  _$jscoverage['/util/single-touch.js'] = {};
...
if (! _$jscoverage['/util/single-touch.js'].functionData) {
  ...
  _$jscoverage['/util/single-touch.js'].functionData[0] = 0;
  _$jscoverage['/util/single-touch.js'].functionData[1] = 0;
  _$jscoverage['/util/single-touch.js'].functionData[2] = 0;
}
if (! _$jscoverage['/util/single-touch.js'].branchData) {
  _$jscoverage['/util/single-touch.js'].branchData = {};
}
_$jscoverage['/util/single-touch.js'].lineData[6]++;
