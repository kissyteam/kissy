...
if (! _$jscoverage['/base/observable.js']) {
  ...
  _$jscoverage['/base/observable.js'].lineData[449] = 0;
}
...
if (! _$jscoverage['/base/observable.js'].branchData) {
  ...
  _$jscoverage['/base/observable.js'].branchData['443'] = [];
  _$jscoverage['/base/observable.js'].branchData['443'][1] = new BranchData();
}
_$jscoverage['/base/observable.js'].branchData['443'][1].init(75, 30, '!domEventObservables && create');
function visit185_443_1(result) {
  _$jscoverage['/base/observable.js'].branchData['443'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['434'][1].init(244, 19, 'domEventObservables');
function visit184_434_1(result) {
  _$jscoverage['/base/observable.js'].branchData['434'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['431'][1].init(117, 25, 'domEventObservablesHolder');
function visit183_431_1(result) {
  _$jscoverage['/base/observable.js'].branchData['431'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['411'][1].init(723, 39, 'util.isEmptyObject(domEventObservables)');
function visit182_411_1(result) {
  _$jscoverage['/base/observable.js'].branchData['411'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['403'][2].init(212, 46, 's.tearDown.call(currentTarget, type) === false');
function visit181_403_2(result) {
  _$jscoverage['/base/observable.js'].branchData['403'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['403'][1].init(197, 61, '!s.tearDown || s.tearDown.call(currentTarget, type) === false');
function visit180_403_1(result) {
  _$jscoverage['/base/observable.js'].branchData['403'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['399'][1].init(84, 19, '!self.hasObserver()');
function visit179_399_1(result) {
  _$jscoverage['/base/observable.js'].branchData['399'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['397'][1].init(305, 9, 'eventDesc');
function visit178_397_1(result) {
  _$jscoverage['/base/observable.js'].branchData['397'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['394'][1].init(135, 19, 'Special[type] || {}');
function visit177_394_1(result) {
  _$jscoverage['/base/observable.js'].branchData['394'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['374'][1].init(316, 8, 's.remove');
function visit176_374_1(result) {
  _$jscoverage['/base/observable.js'].branchData['374'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['371'][1].init(178, 31, 'observer.last && self.lastCount');
function visit175_371_1(result) {
  _$jscoverage['/base/observable.js'].branchData['371'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['368'][1].init(30, 37, 'observer.filter && self.delegateCount');
function visit174_368_1(result) {
  _$jscoverage['/base/observable.js'].branchData['368'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['364'][1].init(391, 44, 'groupsRe && !observer.groups.match(groupsRe)');
function visit173_364_1(result) {
  _$jscoverage['/base/observable.js'].branchData['364'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['359'][1].init(86, 27, '!filter && !observer.filter');
function visit172_359_1(result) {
  _$jscoverage['/base/observable.js'].branchData['359'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['358'][3].init(104, 26, 'filter !== observer.filter');
function visit171_358_3(result) {
  _$jscoverage['/base/observable.js'].branchData['358'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['358'][2].init(94, 36, 'filter && filter !== observer.filter');
function visit170_358_2(result) {
  _$jscoverage['/base/observable.js'].branchData['358'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['358'][1].init(-1, 115, '(filter && filter !== observer.filter) || (!filter && !observer.filter)');
function visit169_358_1(result) {
  _$jscoverage['/base/observable.js'].branchData['358'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['356'][1].init(-1, 252, 'hasFilter && ((filter && filter !== observer.filter) || (!filter && !observer.filter))');
function visit168_356_1(result) {
  _$jscoverage['/base/observable.js'].branchData['356'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['355'][1].init(919, 437, '(hasFilter && ((filter && filter !== observer.filter) || (!filter && !observer.filter))) || (groupsRe && !observer.groups.match(groupsRe))');
function visit167_355_1(result) {
  _$jscoverage['/base/observable.js'].branchData['355'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['340'][3].init(290, 18, 'fn !== observer.fn');
function visit166_340_3(result) {
  _$jscoverage['/base/observable.js'].branchData['340'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['340'][2].init(284, 24, 'fn && fn !== observer.fn');
function visit165_340_2(result) {
  _$jscoverage['/base/observable.js'].branchData['340'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['340'][1].init(108, 1357, '(fn && fn !== observer.fn) || (hasFilter && ((filter && filter !== observer.filter) || (!filter && !observer.filter))) || (groupsRe && !observer.groups.match(groupsRe))');
function visit164_340_1(result) {
  _$jscoverage['/base/observable.js'].branchData['340'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['338'][2].init(174, 27, 'context !== observerContext');
function visit163_338_2(result) {
  _$jscoverage['/base/observable.js'].branchData['338'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['338'][1].init(30, 1466, '(context !== observerContext) || (fn && fn !== observer.fn) || (hasFilter && ((filter && filter !== observer.filter) || (!filter && !observer.filter))) || (groupsRe && !observer.groups.match(groupsRe))');
function visit162_338_1(result) {
  _$jscoverage['/base/observable.js'].branchData['338'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['336'][1].init(86, 33, 'observer.context || currentTarget');
function visit161_336_1(result) {
  _$jscoverage['/base/observable.js'].branchData['336'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['334'][1].init(100, 7, 'i < len');
function visit160_334_1(result) {
  _$jscoverage['/base/observable.js'].branchData['334'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['332'][1].init(28, 24, 'context || currentTarget');
function visit159_332_1(result) {
  _$jscoverage['/base/observable.js'].branchData['332'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['331'][2].init(704, 21, 'hasFilter || groupsRe');
function visit158_331_2(result) {
  _$jscoverage['/base/observable.js'].branchData['331'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['331'][1].init(698, 27, 'fn || hasFilter || groupsRe');
function visit157_331_1(result) {
  _$jscoverage['/base/observable.js'].branchData['331'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['324'][1].init(494, 6, 'groups');
function visit156_324_1(result) {
  _$jscoverage['/base/observable.js'].branchData['324'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['320'][1].init(414, 17, '!observers.length');
function visit155_320_1(result) {
  _$jscoverage['/base/observable.js'].branchData['320'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['311'][1].init(64, 24, 'Special[self.type] || {}');
function visit154_311_1(result) {
  _$jscoverage['/base/observable.js'].branchData['311'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['298'][1].init(536, 5, 's.add');
function visit153_298_1(result) {
  _$jscoverage['/base/observable.js'].branchData['298'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['290'][1].init(26, 13, 'observer.last');
function visit152_290_1(result) {
  _$jscoverage['/base/observable.js'].branchData['290'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['286'][1].init(54, 15, 'observer.filter');
function visit151_286_1(result) {
  _$jscoverage['/base/observable.js'].branchData['286'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['283'][1].init(442, 96, 'self.findObserver(observer) === -1');
function visit150_283_1(result) {
  _$jscoverage['/base/observable.js'].branchData['283'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['278'][1].init(22, 12, '!observer.fn');
function visit149_278_1(result) {
  _$jscoverage['/base/observable.js'].branchData['278'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['277'][1].init(265, 14, 'S.Config.debug');
function visit148_277_1(result) {
  _$jscoverage['/base/observable.js'].branchData['277'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['273'][1].init(82, 24, 'Special[self.type] || {}');
function visit147_273_1(result) {
  _$jscoverage['/base/observable.js'].branchData['273'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['248'][1].init(124, 59, 'currentTarget[eventType] && !util.isWindow(currentTarget)');
function visit146_248_1(result) {
  _$jscoverage['/base/observable.js'].branchData['248'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['242'][1].init(2872, 44, '!onlyHandlers && !event.isDefaultPrevented()');
function visit145_242_1(result) {
  _$jscoverage['/base/observable.js'].branchData['242'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['240'][2].init(2815, 36, 'cur && !event.isPropagationStopped()');
function visit144_240_2(result) {
  _$jscoverage['/base/observable.js'].branchData['240'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['240'][1].init(704, 53, '!onlyHandlers && cur && !event.isPropagationStopped()');
function visit143_240_1(result) {
  _$jscoverage['/base/observable.js'].branchData['240'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['236'][2].init(526, 33, 'cur[ontype].call(cur) === false');
function visit142_236_2(result) {
  _$jscoverage['/base/observable.js'].branchData['236'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['236'][1].init(509, 50, 'cur[ontype] && cur[ontype].call(cur) === false');
function visit141_236_1(result) {
  _$jscoverage['/base/observable.js'].branchData['236'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['231'][3].init(108, 14, 'gret !== false');
function visit140_231_3(result) {
  _$jscoverage['/base/observable.js'].branchData['231'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['231'][2].init(87, 17, 'ret !== undefined');
function visit139_231_2(result) {
  _$jscoverage['/base/observable.js'].branchData['231'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['231'][1].init(87, 35, 'ret !== undefined && gret !== false');
function visit138_231_1(result) {
  _$jscoverage['/base/observable.js'].branchData['231'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['229'][1].init(211, 18, 'domEventObservable');
function visit137_229_1(result) {
  _$jscoverage['/base/observable.js'].branchData['229'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['220'][2].init(1978, 14, 'cur && bubbles');
function visit136_220_2(result) {
  _$jscoverage['/base/observable.js'].branchData['220'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['220'][1].init(214, 31, '!onlyHandlers && cur && bubbles');
function visit135_220_1(result) {
  _$jscoverage['/base/observable.js'].branchData['220'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['219'][4].init(160, 19, 'cur === curDocument');
function visit134_219_4(result) {
  _$jscoverage['/base/observable.js'].branchData['219'][4].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['219'][3].init(160, 27, '(cur === curDocument) && win');
function visit133_219_3(result) {
  _$jscoverage['/base/observable.js'].branchData['219'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['219'][2].init(138, 49, 'cur.ownerDocument || (cur === curDocument) && win');
function visit132_219_2(result) {
  _$jscoverage['/base/observable.js'].branchData['219'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['219'][1].init(120, 67, 'cur.parentNode || cur.ownerDocument || (cur === curDocument) && win');
function visit131_219_1(result) {
  _$jscoverage['/base/observable.js'].branchData['219'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['197'][2].init(940, 71, 'specialEvent.preFire.call(currentTarget, event, onlyHandlers) === false');
function visit130_197_2(result) {
  _$jscoverage['/base/observable.js'].branchData['197'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['197'][1].init(916, 95, 'specialEvent.preFire && specialEvent.preFire.call(currentTarget, event, onlyHandlers) === false');
function visit129_197_1(result) {
  _$jscoverage['/base/observable.js'].branchData['197'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['187'][1].init(564, 34, '!(event instanceof DomEventObject)');
function visit128_187_1(result) {
  _$jscoverage['/base/observable.js'].branchData['187'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['183'][2].init(440, 61, 'specialEvent.fire.call(currentTarget, onlyHandlers) === false');
function visit127_183_2(result) {
  _$jscoverage['/base/observable.js'].branchData['183'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['183'][1].init(419, 82, 'specialEvent.fire && specialEvent.fire.call(currentTarget, onlyHandlers) === false');
function visit126_183_1(result) {
  _$jscoverage['/base/observable.js'].branchData['183'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['179'][1].init(214, 30, 'specialEvent.bubbles !== false');
function visit125_179_1(result) {
  _$jscoverage['/base/observable.js'].branchData['179'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['178'][1].init(161, 24, 'Special[eventType] || {}');
function visit124_178_1(result) {
  _$jscoverage['/base/observable.js'].branchData['178'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['172'][1].init(22, 11, 'event || {}');
function visit123_172_1(result) {
  _$jscoverage['/base/observable.js'].branchData['172'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['155'][3].init(315, 17, 'ret !== undefined');
function visit122_155_3(result) {
  _$jscoverage['/base/observable.js'].branchData['155'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['155'][2].init(297, 14, 'gRet !== false');
function visit121_155_2(result) {
  _$jscoverage['/base/observable.js'].branchData['155'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['155'][1].init(297, 35, 'gRet !== false && ret !== undefined');
function visit120_155_1(result) {
  _$jscoverage['/base/observable.js'].branchData['155'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['146'][2].init(371, 33, 'j < currentTargetObservers.length');
function visit119_146_2(result) {
  _$jscoverage['/base/observable.js'].branchData['146'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['146'][1].init(329, 75, '!event.isImmediatePropagationStopped() && j < currentTargetObservers.length');
function visit118_146_1(result) {
  _$jscoverage['/base/observable.js'].branchData['146'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['138'][2].init(3196, 7, 'i < len');
function visit117_138_2(result) {
  _$jscoverage['/base/observable.js'].branchData['138'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['138'][1].init(3163, 40, '!event.isPropagationStopped() && i < len');
function visit116_138_1(result) {
  _$jscoverage['/base/observable.js'].branchData['138'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['127'][1].init(2595, 32, 'delegateCount < observers.length');
function visit115_127_1(result) {
  _$jscoverage['/base/observable.js'].branchData['127'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['121'][1].init(1219, 34, 'target.parentNode || currentTarget');
function visit114_121_1(result) {
  _$jscoverage['/base/observable.js'].branchData['121'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['114'][1].init(810, 29, 'currentTargetObservers.length');
function visit113_114_1(result) {
  _$jscoverage['/base/observable.js'].branchData['114'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['110'][1].init(425, 7, 'matched');
function visit112_110_1(result) {
  _$jscoverage['/base/observable.js'].branchData['110'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['107'][1].init(248, 21, 'matched === undefined');
function visit111_107_1(result) {
  _$jscoverage['/base/observable.js'].branchData['107'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['102'][1].init(190, 17, 'i < delegateCount');
function visit110_102_1(result) {
  _$jscoverage['/base/observable.js'].branchData['102'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['98'][3].init(54, 21, 'eventType !== \'click\'');
function visit109_98_3(result) {
  _$jscoverage['/base/observable.js'].branchData['98'][3].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['98'][2].init(26, 24, 'target.disabled !== true');
function visit108_98_2(result) {
  _$jscoverage['/base/observable.js'].branchData['98'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['98'][1].init(26, 49, 'target.disabled !== true || eventType !== \'click\'');
function visit107_98_1(result) {
  _$jscoverage['/base/observable.js'].branchData['98'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['97'][1].init(25, 24, 'target !== currentTarget');
function visit106_97_1(result) {
  _$jscoverage['/base/observable.js'].branchData['97'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['96'][1].init(1043, 32, 'delegateCount && target.nodeType');
function visit105_96_1(result) {
  _$jscoverage['/base/observable.js'].branchData['96'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['89'][1].init(412, 23, 'self.delegateCount || 0');
function visit104_89_1(result) {
  _$jscoverage['/base/observable.js'].branchData['89'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['47'][2].init(342, 43, 's.setup.call(currentTarget, type) === false');
function visit103_47_2(result) {
  _$jscoverage['/base/observable.js'].branchData['47'][2].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['47'][1].init(330, 55, '!s.setup || s.setup.call(currentTarget, type) === false');
function visit102_47_1(result) {
  _$jscoverage['/base/observable.js'].branchData['47'][1].ranCondition(result);
  return result;
}_$jscoverage['/base/observable.js'].branchData['42'][1].init(72, 19, 'Special[type] || {}');
...
KISSY.add(function(S, require) {
  ...
  var self = this, type = self.type, s = visit101_42_1(Special[type] || {}), currentTarget = self.currentTarget, eventDesc = DomEventUtils.data(currentTarget), handle = eventDesc.handle;
  _$jscoverage['/base/observable.js'].lineData[47]++;
  if (visit102_47_1(!s.setup || visit103_47_2(s.setup.call(currentTarget, type) === false))) {
  ...
  var target = event.target, eventType = event.type, self = this, currentTarget = self.currentTarget, observers = self.observers, currentTarget0, allObservers = [], ret, gRet, observerObj, i, j, delegateCount = visit104_89_1(self.delegateCount || 0), len, currentTargetObservers, currentTargetObserver, observer;
  _$jscoverage['/base/observable.js'].lineData[96]++;
  if (visit105_96_1(delegateCount && target.nodeType)) {
    _$jscoverage['/base/observable.js'].lineData[97]++;
    while (visit106_97_1(target !== currentTarget)) {
      _$jscoverage['/base/observable.js'].lineData[98]++;
      if (visit107_98_1(visit108_98_2(target.disabled !== true) || visit109_98_3(eventType !== 'click'))) {
        ...
        for (i = 0; visit110_102_1(i < delegateCount); i++) {
          ...
          if (visit111_107_1(matched === undefined)) {
        ...
        if (visit113_114_1(currentTargetObservers.length)) {
  ...
  currentTargetObservers: currentTargetObservers});
      ...
      target = visit114_121_1(target.parentNode || currentTarget);
    }
  }
  _$jscoverage['/base/observable.js'].lineData[127]++;
  if (visit115_127_1(delegateCount < observers.length)) {
  ...
  for (i = 0 , len = allObservers.length; visit116_138_1(!event.isPropagationStopped() && visit117_138_2(i < len)); ++i) {
    ...
    for (j = 0; visit118_146_1(!event.isImmediatePropagationStopped() && visit119_146_2(j < currentTargetObservers.length)); j++) {
      ...
      if (visit120_155_1(visit121_155_2(gRet !== false) && visit122_155_3(ret !== undefined))) {
  ...
  event = visit123_172_1(event || {});
  _$jscoverage['/base/observable.js'].lineData[174]++;
  var self = this, eventType = String(self.type), domEventObservable, eventData, specialEvent = visit124_178_1(Special[eventType] || {}), bubbles = visit125_179_1(specialEvent.bubbles !== false), currentTarget = self.currentTarget;
  _$jscoverage['/base/observable.js'].lineData[183]++;
  if (visit126_183_1(specialEvent.fire && visit127_183_2(specialEvent.fire.call(currentTarget, onlyHandlers) === false))) {
    _$jscoverage['/base/observable.js'].lineData[184]++;
    return;
  }
  _$jscoverage['/base/observable.js'].lineData[187]++;
  if (visit128_187_1(!(event instanceof DomEventObject))) {
  ...
  if (visit129_197_1(specialEvent.preFire && visit130_197_2(specialEvent.preFire.call(currentTarget, event, onlyHandlers) === false))) {
  ...
  do {
    ...
    cur = visit131_219_1(cur.parentNode || visit132_219_2(cur.ownerDocument || visit133_219_3((visit134_219_4(cur === curDocument)) && win)));
  } while (visit135_220_1(!onlyHandlers && visit136_220_2(cur && bubbles)));
  ...
  do {
    ...
    if (visit137_229_1(domEventObservable)) {
      ...
      if (visit138_231_1(visit139_231_2(ret !== undefined) && visit140_231_3(gret !== false))) {
        _$jscoverage['/base/observable.js'].lineData[232]++;
        gret = ret;
      }
    }
    _$jscoverage['/base/observable.js'].lineData[236]++;
    if (visit141_236_1(cur[ontype] && visit142_236_2(cur[ontype].call(cur) === false))) {
      _$jscoverage['/base/observable.js'].lineData[237]++;
      event.preventDefault();
    }
    _$jscoverage['/base/observable.js'].lineData[239]++;
    cur = eventPath[++eventPathIndex];
  } while (visit143_240_1(!onlyHandlers && visit144_240_2(cur && !event.isPropagationStopped())));
  _$jscoverage['/base/observable.js'].lineData[242]++;
  if (visit145_242_1(!onlyHandlers && !event.isDefaultPrevented())) {
    _$jscoverage['/base/observable.js'].lineData[245]++;
    try {
      _$jscoverage['/base/observable.js'].lineData[248]++;
      if (visit146_248_1(currentTarget[eventType] && !util.isWindow(currentTarget))) {
  ...
  var self = this, observers = self.observers, s = visit147_273_1(Special[self.type] || {}), observer = cfg instanceof DomEventObserver ? cfg : new DomEventObserver(cfg);
  _$jscoverage['/base/observable.js'].lineData[277]++;
  if (visit148_277_1(S.Config.debug)) {
    _$jscoverage['/base/observable.js'].lineData[278]++;
    if (visit149_278_1(!observer.fn)) {
  ...
  if (visit150_283_1(self.findObserver(observer) === -1)) {
    _$jscoverage['/base/observable.js'].lineData[286]++;
    if (visit151_286_1(observer.filter)) {
      ...
      if (visit152_290_1(observer.last)) {
  ...
  var groupsRe, self = this, s = visit154_311_1(Special[self.type] || {}), hasFilter = 'filter' in cfg, filter = cfg.filter, context = cfg.context, fn = cfg.fn, currentTarget = self.currentTarget, observers = self.observers, groups = cfg.groups;
  _$jscoverage['/base/observable.js'].lineData[320]++;
  if (visit155_320_1(!observers.length)) {
    _$jscoverage['/base/observable.js'].lineData[321]++;
    return;
  }
  _$jscoverage['/base/observable.js'].lineData[324]++;
  if (visit156_324_1(groups)) {
  ...
  if (visit157_331_1(fn || visit158_331_2(hasFilter || groupsRe))) {
    _$jscoverage['/base/observable.js'].lineData[332]++;
    context = visit159_332_1(context || currentTarget);
    _$jscoverage['/base/observable.js'].lineData[334]++;
    for (i = 0 , j = 0 , t = []; visit160_334_1(i < len); ++i) {
      _$jscoverage['/base/observable.js'].lineData[335]++;
      observer = observers[i];
      _$jscoverage['/base/observable.js'].lineData[336]++;
      observerContext = visit161_336_1(observer.context || currentTarget);
      _$jscoverage['/base/observable.js'].lineData[337]++;
      if (visit162_338_1((visit163_338_2(context !== observerContext)) || visit164_340_1((visit165_340_2(fn && visit166_340_3(fn !== observer.fn))) || visit167_355_1((visit168_356_1(hasFilter && (visit169_358_1((visit170_358_2(filter && visit171_358_3(filter !== observer.filter))) || (visit172_359_1(!filter && !observer.filter)))))) || (visit173_364_1(groupsRe && !observer.groups.match(groupsRe))))))) {
        _$jscoverage['/base/observable.js'].lineData[366]++;
        t[j++] = observer;
      } else {
        _$jscoverage['/base/observable.js'].lineData[368]++;
        if (visit174_368_1(observer.filter && self.delegateCount)) {
          _$jscoverage['/base/observable.js'].lineData[369]++;
          self.delegateCount--;
        }
        _$jscoverage['/base/observable.js'].lineData[371]++;
        if (visit175_371_1(observer.last && self.lastCount)) {
          _$jscoverage['/base/observable.js'].lineData[372]++;
          self.lastCount--;
        }
        _$jscoverage['/base/observable.js'].lineData[374]++;
        if (visit176_374_1(s.remove)) {
  ...
  var self = this, type = self.type, domEventObservables, handle, s = visit177_394_1(Special[type] || {}), currentTarget = self.currentTarget, eventDesc = DomEventUtils.data(currentTarget);
  _$jscoverage['/base/observable.js'].lineData[397]++;
  if (visit178_397_1(eventDesc)) {
    ...
    if (visit179_399_1(!self.hasObserver())) {
      _$jscoverage['/base/observable.js'].lineData[400]++;
      handle = eventDesc.handle;
      _$jscoverage['/base/observable.js'].lineData[403]++;
      if ((visit180_403_1(!s.tearDown || visit181_403_2(s.tearDown.call(currentTarget, type) === false)))) {
    ...
    if (visit182_411_1(util.isEmptyObject(domEventObservables))) {
  ...
  if (visit183_431_1(domEventObservablesHolder)) {
  ...
  if (visit184_434_1(domEventObservables)) {
  ...
  if (visit185_443_1(!domEventObservables && create)) {
  ...
  _$jscoverage['/base/observable.js'].lineData[449]++;
