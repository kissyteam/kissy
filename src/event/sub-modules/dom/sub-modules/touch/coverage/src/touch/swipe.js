...
function visit101_160_1(result) {
...
function visit100_151_2(result) {
...
KISSY.add(function(S, require) {
  ...
  function fire(self, e, ing) {
    ...
    if (visit82_29_1(ing)) {
      ...
      if (visit83_30_1(self.isVertical && self.isHorizontal)) {
        _$jscoverage['/touch/swipe.js'].lineData[32]++;
        if (visit84_32_1(Math.max(absDeltaX, absDeltaY) < 5)) {
          _$jscoverage['/touch/swipe.js'].lineData[33]++;
          return undefined;
        }
        _$jscoverage['/touch/swipe.js'].lineData[36]++;
        if (visit85_36_1(absDeltaY > absDeltaX)) {
  ...
  if (visit94_114_1(Swipe.superclass.onTouchStart.apply(self, arguments) === false)) {
  ...
  if (visit95_126_1(e.type.indexOf('mouse') !== -1)) {
  ...
  if (visit96_143_1(time - self.startTime > MAX_DURATION)) {
    _$jscoverage['/touch/swipe.js'].lineData[144]++;
    return false;
  }
  _$jscoverage['/touch/swipe.js'].lineData[147]++;
  if (visit97_147_1(self.isVertical && visit98_147_2(absDeltaX > MAX_OFFSET))) {
    _$jscoverage['/touch/swipe.js'].lineData[148]++;
    self.isVertical = 0;
  }
  _$jscoverage['/touch/swipe.js'].lineData[151]++;
  if (visit99_151_1(self.isHorizontal && visit100_151_2(absDeltaY > MAX_OFFSET))) {
  ...
  if (visit101_160_1(self.onTouchMove(e) === false)) {
