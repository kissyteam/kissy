...
KISSY.add('event/dom/touch/pinch', function(S, eventHandleMap, DomEvent, MultiTouch) {
  ...
  if (visit53_26_1(!self.isTracking)) {
  ...
  if (visit54_35_1(!self.isStarted)) {
  ...
  function prevent(e) {
    ...
    if (visit55_70_1(e.touches.length == 2)) {
