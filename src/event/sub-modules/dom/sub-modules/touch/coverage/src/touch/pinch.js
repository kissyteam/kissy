...
KISSY.add('event/dom/touch/pinch', function(S, eventHandleMap, DomEvent, MultiTouch) {
  ...
  if (visit61_26_1(!self.isTracking)) {
  ...
  if (visit62_35_1(!self.isStarted)) {
  ...
  function prevent(e) {
    ...
    if (visit63_70_1(e.touches.length == 2)) {
