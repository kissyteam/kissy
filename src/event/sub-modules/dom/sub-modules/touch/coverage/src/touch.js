...
KISSY.add('event/dom/touch', function(S, DomEvent, eventHandleMap, eventHandle) {
  ...
  var doc = visit97_26_1(this.ownerDocument || this);
  _$jscoverage['/touch.js'].lineData[27]++;
  doc.__ks__pointer_events_count = visit98_27_1(doc.__ks__pointer_events_count || 0);
  ...
  var doc = visit99_31_1(this.ownerDocument || this);
  _$jscoverage['/touch.js'].lineData[32]++;
  if (visit100_32_1(doc.__ks__pointer_events_count)) {
  ...
  var t = e.target, doc = visit101_42_1(t.ownerDocument || t);
  _$jscoverage['/touch.js'].lineData[43]++;
  if (visit102_43_1(doc.__ks__pointer_events_count)) {
  ...
  for (e in eventHandleMap) {
    ...
    if (visit103_84_1(eventHandleValue.setup)) {
    ...
    if (visit104_89_1(eventHandleValue.tearDown)) {
