...
KISSY.add(function(S, require) {
  ...
  for (e in eventHandleMap) {
    ...
    if (visit118_74_1(eventHandleValue.setup)) {
    ...
    if (visit119_79_1(eventHandleValue.tearDown)) {
