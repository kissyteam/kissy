...
KISSY.add(function(S, require) {
  ...
  for (e in eventHandleMap) {
    ...
    if (visit118_73_1(eventHandleValue.setup)) {
    ...
    if (visit119_78_1(eventHandleValue.tearDown)) {
