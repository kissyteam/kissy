...
KISSY.add(function(S, require) {
  ...
  for (e in eventHandleMap) {
    ...
    if (visit113_73_1(eventHandleValue.setup)) {
    ...
    if (visit114_78_1(eventHandleValue.tearDown)) {
