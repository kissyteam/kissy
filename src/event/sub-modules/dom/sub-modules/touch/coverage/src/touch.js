...
KISSY.add(function(S, require) {
  ...
  for (e in eventHandleMap) {
    ...
    if (visit110_73_1(eventHandleValue.setup)) {
    ...
    if (visit111_78_1(eventHandleValue.tearDown)) {
