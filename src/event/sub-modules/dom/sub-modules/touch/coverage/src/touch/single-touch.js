...
if (! _$jscoverage['/touch/single-touch.js']) {
  ...
  _$jscoverage['/touch/single-touch.js'].lineData[21] = 0;
  _$jscoverage['/touch/single-touch.js'].lineData[25] = 0;
  _$jscoverage['/touch/single-touch.js'].lineData[31] = 0;
}
...
_$jscoverage['/touch/single-touch.js'].branchData['16'][1].init(71, 44, 'e.touches.length !== self.requiredTouchCount');
function visit84_16_1(result) {
...
KISSY.add(function(S) {
  ...
  if (visit84_16_1(e.touches.length !== self.requiredTouchCount)) {
  ...
  _$jscoverage['/touch/single-touch.js'].lineData[21]++;
  self.lastXY = {
  ...
  onTouchMove: S.noop, 
  onTouchEnd: S.noop};
  _$jscoverage['/touch/single-touch.js'].lineData[31]++;
  return SingleTouch;
});
