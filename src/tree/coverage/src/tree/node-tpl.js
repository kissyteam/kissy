...
if (! _$jscoverage['/tree/node-tpl.js']) {
  _$jscoverage['/tree/node-tpl.js'] = {};
  _$jscoverage['/tree/node-tpl.js'].lineData = [];
  _$jscoverage['/tree/node-tpl.js'].lineData[4] = 0;
}
if (! _$jscoverage['/tree/node-tpl.js'].functionData) {
  _$jscoverage['/tree/node-tpl.js'].functionData = [];
}
if (! _$jscoverage['/tree/node-tpl.js'].branchData) {
  _$jscoverage['/tree/node-tpl.js'].branchData = {};
}
_$jscoverage['/tree/node-tpl.js'].lineData[4]++;
