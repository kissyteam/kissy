...
KISSY.add(function(S, require) {
  ...
  if (visit5_33_1(v && visit6_33_2(ev && (highlightedItem = ev.prevVal)))) {
  ...
  if (visit7_46_1(!v && (highlightedItem = this.get('highlightedItem')))) {
  ...
  if (visit8_64_1(rootMenu && rootMenu._popupAutoHideTimer)) {
