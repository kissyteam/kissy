...
if (! _$jscoverage['/menu/menu-render.js']) {
  ...
  _$jscoverage['/menu/menu-render.js'].lineData[16] = 0;
}
if (! _$jscoverage['/menu/menu-render.js'].functionData) {
  _$jscoverage['/menu/menu-render.js'].functionData = [];
  _$jscoverage['/menu/menu-render.js'].functionData[0] = 0;
  _$jscoverage['/menu/menu-render.js'].functionData[1] = 0;
  _$jscoverage['/menu/menu-render.js'].functionData[2] = 0;
}
if (! _$jscoverage['/menu/menu-render.js'].branchData) {
  _$jscoverage['/menu/menu-render.js'].branchData = {};
  _$jscoverage['/menu/menu-render.js'].branchData['16'] = [];
  _$jscoverage['/menu/menu-render.js'].branchData['16'][1] = new BranchData();
...
KISSY.add(function(S, require) {
  ...
  _$jscoverage['/menu/menu-render.js'].functionData[1]++;
  _$jscoverage['/menu/menu-render.js'].lineData[11]++;
  renderData.elAttrs.role = 'menu';
}, 
  containsElement: function(element) {
  _$jscoverage['/menu/menu-render.js'].functionData[2]++;
  _$jscoverage['/menu/menu-render.js'].lineData[15]++;
  var $el = this.$el;
  _$jscoverage['/menu/menu-render.js'].lineData[16]++;
  return visit27_16_1($el && (visit28_16_2(visit29_16_3($el[0] === element) || $el.contains(element))));
}});
});
