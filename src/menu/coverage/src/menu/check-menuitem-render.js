...
if (! _$jscoverage['/menu/check-menuitem-render.js'].functionData) {
  ...
  _$jscoverage['/menu/check-menuitem-render.js'].functionData[0] = 0;
  _$jscoverage['/menu/check-menuitem-render.js'].functionData[1] = 0;
  _$jscoverage['/menu/check-menuitem-render.js'].functionData[2] = 0;
}
