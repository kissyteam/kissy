...
_$jscoverage['/menu/popupmenu.js'].branchData['47'][1].init(74, 17, 'rootMenu !== this');
...
KISSY.add(function(S, require) {
  ...
  do {
    ...
    cur = cur.get('parent');
  } while (visit36_33_1(cur && (visit37_33_2(cur.isMenuItem || cur.isMenu))));
