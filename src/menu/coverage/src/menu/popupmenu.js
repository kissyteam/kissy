...
KISSY.add(function(S, require) {
  ...
  do {
    ...
    cur = cur.get('parent');
  } while (visit42_31_1(cur && (visit43_31_2(cur.isMenuItem || cur.isMenu))));
  _$jscoverage['/menu/popupmenu.js'].lineData[32]++;
  return visit44_32_1(last === this) ? null : last;
}, 
