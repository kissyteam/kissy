...
if (! _$jscoverage['/menu/submenu-render.js']) {
...
if (! _$jscoverage['/menu/submenu-render.js'].functionData) {
  ...
  _$jscoverage['/menu/submenu-render.js'].functionData[0] = 0;
  _$jscoverage['/menu/submenu-render.js'].functionData[1] = 0;
}
if (! _$jscoverage['/menu/submenu-render.js'].branchData) {
