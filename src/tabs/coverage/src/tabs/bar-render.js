...
if (! _$jscoverage['/tabs/bar-render.js']) {
  _$jscoverage['/tabs/bar-render.js'] = {};
  _$jscoverage['/tabs/bar-render.js'].lineData = [];
...
if (! _$jscoverage['/tabs/bar-render.js'].functionData) {
  ...
  _$jscoverage['/tabs/bar-render.js'].functionData[0] = 0;
  _$jscoverage['/tabs/bar-render.js'].functionData[1] = 0;
}
if (! _$jscoverage['/tabs/bar-render.js'].branchData) {
