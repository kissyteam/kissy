...
if (! _$jscoverage['/overlay/dialog-xtpl.js'].branchData) {
  ...
  _$jscoverage['/overlay/dialog-xtpl.js'].branchData['8'][2] = new BranchData();
  _$jscoverage['/overlay/dialog-xtpl.js'].branchData['19'] = [];
  _$jscoverage['/overlay/dialog-xtpl.js'].branchData['19'][1] = new BranchData();
}
_$jscoverage['/overlay/dialog-xtpl.js'].branchData['19'][1].init(656, 10, 'moduleWrap');
function visit8_19_1(result) {
  _$jscoverage['/overlay/dialog-xtpl.js'].branchData['19'][1].ranCondition(result);
  return result;
}_$jscoverage['/overlay/dialog-xtpl.js'].branchData['8'][2].init(165, 28, 'typeof module != "undefined"');
function visit7_8_2(result) {
  _$jscoverage['/overlay/dialog-xtpl.js'].branchData['8'][2].ranCondition(result);
  return result;
}_$jscoverage['/overlay/dialog-xtpl.js'].branchData['8'][1].init(165, 44, 'typeof module != "undefined" && module.kissy');
function visit6_8_1(result) {
...
KISSY.add(function(S, require, exports, module) {
  ...
  if (visit6_8_1(visit7_8_2(typeof module != "undefined") && module.kissy)) {
