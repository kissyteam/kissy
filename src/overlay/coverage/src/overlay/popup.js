...
KISSY.add(function(S, require) {
  ...
  if (visit53_20_1(trigger)) {
    _$jscoverage['/overlay/popup.js'].lineData[21]++;
    if (visit54_21_1(self.get('triggerType') === 'mouse')) {
  ...
  if (visit56_74_1(self._hiddenTimer)) {
  ...
  if (visit57_84_1(self.get('toggle'))) {
  ...
  if (visit58_110_1(t)) {
    ...
    if (visit61_117_1(self._mouseLeavePopup)) {
