...
KISSY.add(function(S, require) {
  ...
  if (visit47_20_1(trigger)) {
    _$jscoverage['/overlay/popup.js'].lineData[21]++;
    if (visit48_21_1(self.get('triggerType') === 'mouse')) {
  ...
  if (visit50_74_1(self._hiddenTimer)) {
  ...
  if (visit51_84_1(self.get('toggle'))) {
  ...
  if (visit52_110_1(t)) {
    ...
    if (visit55_117_1(self._mouseLeavePopup)) {
