...
KISSY.add(function(S, require) {
  ...
  var UA = S.UA, Node = require('node'), ie6 = (visit28_9_1(UA.ie === 6)), $ = Node.all;
  ...
  function processMask(mask, el, show, self) {
    ...
    var effect = visit30_109_1(mask.effect || NONE);
  ...
  function afterVisibleChange(e) {
    ...
    if ((v = e.newVal)) {
      ...
      if (visit32_140_1(!isNaN(elZIndex))) {
  ...
  if (visit33_150_1(self.get('mask'))) {
  ...
  if ((mask = self.get('mask'))) {
    ...
    if (visit34_161_1(mask.closeOnClick)) {
