...
KISSY.add(function(S, require) {
  ...
  function afterVisibleChange(e) {
    ...
    if ((v = e.newVal)) {
      ...
      if (visit25_140_1(!isNaN(elZIndex))) {
  ...
  if (visit26_150_1(self.get('mask'))) {
  ...
  if ((mask = self.get('mask'))) {
    ...
    if (visit27_161_1(mask.closeOnClick)) {
