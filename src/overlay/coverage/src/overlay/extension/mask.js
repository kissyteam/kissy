...
KISSY.add(function(S, require) {
  ...
  function processMask(mask, el, show, self) {
    ...
    var effect = visit27_109_1(mask.effect || NONE);
  ...
  function afterVisibleChange(e) {
    ...
    if ((v = e.newVal)) {
      ...
      if (visit29_140_1(!isNaN(elZIndex))) {
  ...
  if (visit30_150_1(self.get('mask'))) {
  ...
  if ((mask = self.get('mask'))) {
    ...
    if (visit31_161_1(mask.closeOnClick)) {
