...
KISSY.add(function(S) {
  ...
  function processTarget(self, show) {
    ...
    if (visit27_22_1(self.__effectGhost)) {
  ...
  if (visit33_164_1(visit34_164_2(typeof effect === 'string') && !effects[effect])) {
