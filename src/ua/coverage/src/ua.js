...
if (! _$jscoverage['/ua.js'].branchData) {
  ...
  _$jscoverage['/ua.js'].branchData['52'] = [];
  _$jscoverage['/ua.js'].branchData['52'][1] = new BranchData();
  _$jscoverage['/ua.js'].branchData['194'] = [];
  _$jscoverage['/ua.js'].branchData['194'][1] = new BranchData();
  _$jscoverage['/ua.js'].branchData['201'] = [];
  _$jscoverage['/ua.js'].branchData['201'][1] = new BranchData();
  _$jscoverage['/ua.js'].branchData['211'] = [];
  _$jscoverage['/ua.js'].branchData['211'][1] = new BranchData();
  _$jscoverage['/ua.js'].branchData['213'] = [];
  _$jscoverage['/ua.js'].branchData['213'][1] = new BranchData();
  _$jscoverage['/ua.js'].branchData['221'] = [];
  _$jscoverage['/ua.js'].branchData['221'][1] = new BranchData();
...
function visit45_376_1(result) {
  _$jscoverage['/ua.js'].branchData['376'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['373'][1].init(12101, 15, 'documentElement');
...
function visit42_349_1(result) {
  ...
  return result;
}_$jscoverage['/ua.js'].branchData['346'][1].init(11377, 27, 'typeof process === \'object\'');
function visit41_346_1(result) {
  _$jscoverage['/ua.js'].branchData['346'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['338'][2].init(10265, 25, 'UA.ie && doc.documentMode');
function visit40_338_2(result) {
  _$jscoverage['/ua.js'].branchData['338'][2].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['338'][1].init(10265, 34, 'UA.ie && doc.documentMode || UA.ie');
function visit39_338_1(result) {
  _$jscoverage['/ua.js'].branchData['338'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['336'][1].init(10202, 15, 'UA.core || core');
...
function visit34_324_1(result) {
  ...
  return result;
}_$jscoverage['/ua.js'].branchData['323'][1].init(9805, 3, '!os');
...
function visit13_228_1(result) {
  ...
  return result;
}_$jscoverage['/ua.js'].branchData['221'][1].init(745, 40, '!UA.ie && (ieVersion = getIEVersion(ua))');
function visit12_221_1(result) {
  _$jscoverage['/ua.js'].branchData['221'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['213'][1].init(100, 12, 's.length > 0');
function visit11_213_1(result) {
  _$jscoverage['/ua.js'].branchData['213'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['211'][1].init(404, 8, 'v <= end');
function visit10_211_1(result) {
  _$jscoverage['/ua.js'].branchData['211'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['201'][1].init(4366, 12, 's.length > 0');
function visit9_201_1(result) {
  _$jscoverage['/ua.js'].branchData['201'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['194'][1].init(3982, 31, 'div && div.getElementsByTagName');
function visit8_194_1(result) {
  _$jscoverage['/ua.js'].branchData['194'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['52'][1].init(343, 31, 'doc && doc.createElement(\'div\')');
function visit7_52_1(result) {
  _$jscoverage['/ua.js'].branchData['52'][1].ranCondition(result);
  return result;
...
KISSY.add(function(S, undefined) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit7_52_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit8_194_1(div && div.getElementsByTagName)) {
    ...
    if (visit9_201_1(s.length > 0)) {
      ...
      if (visit12_221_1(!UA.ie && (ieVersion = getIEVersion(ua)))) {
  ...
  if (visit45_376_1(v)) {
    ...
    if (visit46_381_1(S.trim(className))) {
