...
_$jscoverage['/ua.js'].branchData['378'][1].init(238, 17, 'S.trim(className)');
function visit590_378_1(result) {
  _$jscoverage['/ua.js'].branchData['378'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['373'][1].init(46, 1, 'v');
function visit589_373_1(result) {
  _$jscoverage['/ua.js'].branchData['373'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['370'][1].init(11840, 15, 'documentElement');
function visit588_370_1(result) {
...
function visit587_368_1(result) {
...
function visit581_325_1(result) {
...
function visit580_323_1(result) {
  _$jscoverage['/ua.js'].branchData['323'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['322'][1].init(9620, 3, '!os');
function visit579_322_1(result) {
  _$jscoverage['/ua.js'].branchData['322'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['313'][1].init(484, 42, '(m = ua.match(/Firefox\\/([\\d.]*)/)) && m[1]');
function visit578_313_1(result) {
...
function visit577_308_1(result) {
...
function visit576_306_1(result) {
...
function visit575_298_1(result) {
...
function visit574_288_1(result) {
...
function visit573_282_1(result) {
...
function visit572_277_1(result) {
...
function visit571_274_1(result) {
...
function visit570_270_1(result) {
...
function visit563_236_1(result) {
...
function visit562_231_1(result) {
...
function visit561_227_1(result) {
...
function visit560_223_1(result) {
...
function visit559_220_1(result) {
...
function visit554_187_1(result) {
...
(function(S, undefined) {
  ...
  nodejs: undefined};
    ...
    if (visit554_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit555_194_1(s.length > 0)) {
      ...
      if (visit559_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit570_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit575_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit584_335_1(UA.core || core);
  ...
  if (visit585_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit586_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit587_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit588_370_1(documentElement)) {
  ...
  if (visit589_373_1(v)) {
    ...
    if (visit590_378_1(S.trim(className))) {
