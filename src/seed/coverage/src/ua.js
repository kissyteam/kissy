...
if (! _$jscoverage['/ua.js']) {
  ...
  _$jscoverage['/ua.js'].lineData[360] = 0;
  _$jscoverage['/ua.js'].lineData[362] = 0;
...
if (! _$jscoverage['/ua.js'].branchData) {
  ...
  _$jscoverage['/ua.js'].branchData['375'] = [];
  _$jscoverage['/ua.js'].branchData['375'][1] = new BranchData();
  ...
  _$jscoverage['/ua.js'].branchData['385'] = [];
  _$jscoverage['/ua.js'].branchData['385'][1] = new BranchData();
}
_$jscoverage['/ua.js'].branchData['385'][1].init(238, 17, 'S.trim(className)');
function visit592_385_1(result) {
  _$jscoverage['/ua.js'].branchData['385'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['380'][1].init(46, 1, 'v');
function visit591_380_1(result) {
  _$jscoverage['/ua.js'].branchData['380'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['377'][1].init(12061, 15, 'documentElement');
function visit590_377_1(result) {
  _$jscoverage['/ua.js'].branchData['377'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['375'][1].init(307, 26, 'doc && doc.documentElement');
function visit589_375_1(result) {
  _$jscoverage['/ua.js'].branchData['375'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['353'][1].init(49, 61, '(versions = process.versions) && (nodeVersion = versions.node)');
function visit588_353_1(result) {
  _$jscoverage['/ua.js'].branchData['353'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['351'][1].init(11338, 27, 'typeof process === \'object\'');
function visit587_351_1(result) {
  _$jscoverage['/ua.js'].branchData['351'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['343'][2].init(10245, 25, 'UA.ie && doc.documentMode');
function visit586_343_2(result) {
  _$jscoverage['/ua.js'].branchData['343'][2].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['343'][1].init(10245, 34, 'UA.ie && doc.documentMode || UA.ie');
function visit585_343_1(result) {
  _$jscoverage['/ua.js'].branchData['343'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['341'][1].init(10182, 15, 'UA.core || core');
function visit584_341_1(result) {
  _$jscoverage['/ua.js'].branchData['341'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['335'][1].init(279, 18, '(/rhino/i).test(ua)');
function visit583_335_1(result) {
  _$jscoverage['/ua.js'].branchData['335'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['333'][1].init(202, 18, '(/linux/i).test(ua)');
function visit582_333_1(result) {
...
function visit581_331_1(result) {
...
function visit580_329_1(result) {
  ...
  return result;
}_$jscoverage['/ua.js'].branchData['328'][1].init(9785, 3, '!os');
function visit579_328_1(result) {
...
function visit578_319_1(result) {
...
function visit577_314_1(result) {
...
function visit576_312_1(result) {
  _$jscoverage['/ua.js'].branchData['312'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['304'][1].init(170, 28, 'ieVersion = getIEVersion(ua)');
function visit575_304_1(result) {
...
function visit574_294_1(result) {
...
function visit573_288_1(result) {
...
function visit572_283_1(result) {
...
function visit571_280_1(result) {
...
function visit570_276_1(result) {
...
function visit563_242_1(result) {
...
function visit562_237_1(result) {
...
function visit561_233_1(result) {
...
function visit560_229_1(result) {
...
function visit559_226_1(result) {
...
function visit554_193_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit547_9_1(visit548_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit550_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit551_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit552_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit553_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit554_193_1(div && div.getElementsByTagName)) {
    ...
    if (visit555_200_1(s.length > 0)) {
      ...
      if (visit559_226_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit570_276_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit575_304_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit584_341_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[342]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[343]++;
    UA.ieMode = visit585_343_1(visit586_343_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit587_351_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[352]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[353]++;
    if (visit588_353_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  _$jscoverage['/ua.js'].lineData[360]++;
  UA.getDescriptorFromUserAgent = getDescriptorFromUserAgent;
  _$jscoverage['/ua.js'].lineData[362]++;
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit589_375_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[377]++;
  if (visit590_377_1(documentElement)) {
  ...
  if (visit591_380_1(v)) {
    ...
    if (visit592_385_1(S.trim(className))) {
