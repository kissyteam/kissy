...
function visit601_367_1(result) {
...
function visit595_324_1(result) {
...
function visit594_322_1(result) {
...
function visit592_312_1(result) {
...
function visit591_307_1(result) {
...
function visit590_305_1(result) {
...
function visit589_297_1(result) {
...
function visit588_287_1(result) {
...
function visit587_281_1(result) {
...
function visit586_276_1(result) {
...
function visit585_273_1(result) {
...
function visit584_269_1(result) {
...
function visit580_247_1(result) {
...
function visit576_230_1(result) {
...
function visit575_226_1(result) {
...
function visit573_219_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit561_9_1(visit562_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit564_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit565_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit566_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit567_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit569_193_1(s.length > 0)) {
      ...
      if (visit573_219_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit584_269_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit589_297_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit598_334_1(UA.core || core);
  ...
  if (visit599_343_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[344]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[345]++;
    if (visit600_345_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit601_367_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[369]++;
  if (visit602_369_1(documentElement)) {
  ...
  if (visit603_372_1(v)) {
    ...
    if (visit604_377_1(S.trim(className))) {
