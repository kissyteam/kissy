...
function visit581_368_1(result) {
...
function visit580_346_1(result) {
...
function visit579_344_1(result) {
...
function visit575_325_1(result) {
...
function visit572_313_1(result) {
...
function visit571_308_1(result) {
...
function visit570_306_1(result) {
...
function visit569_298_1(result) {
...
function visit568_288_1(result) {
...
function visit566_277_1(result) {
...
function visit565_274_1(result) {
...
function visit564_270_1(result) {
...
function visit557_236_1(result) {
...
function visit555_227_1(result) {
...
function visit554_223_1(result) {
...
function visit553_220_1(result) {
...
function visit548_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit541_9_1(visit542_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit544_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit545_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit546_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit547_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit548_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit549_194_1(s.length > 0)) {
      ...
      if (visit553_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit564_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit569_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit578_335_1(UA.core || core);
  ...
  if (visit579_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit580_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit581_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit582_370_1(documentElement)) {
  ...
  if (visit583_373_1(v)) {
    ...
    if (visit584_378_1(S.trim(className))) {
