...
function visit593_368_1(result) {
...
function visit592_346_1(result) {
...
function visit591_344_1(result) {
...
function visit587_325_1(result) {
...
function visit585_322_1(result) {
...
function visit584_313_1(result) {
...
function visit583_308_1(result) {
...
function visit582_306_1(result) {
...
function visit581_298_1(result) {
...
function visit580_288_1(result) {
...
function visit579_282_1(result) {
...
function visit578_277_1(result) {
...
function visit577_274_1(result) {
...
function visit576_270_1(result) {
...
function visit575_262_1(result) {
...
function visit573_249_1(result) {
...
function visit569_236_1(result) {
...
function visit567_227_1(result) {
...
function visit566_223_1(result) {
...
function visit565_220_1(result) {
...
function visit560_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit553_9_1(visit554_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit556_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit557_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit558_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit559_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit560_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit561_194_1(s.length > 0)) {
      ...
      if (visit565_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit576_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit581_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit590_335_1(UA.core || core);
  ...
  if (visit591_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit592_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit593_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit594_370_1(documentElement)) {
  ...
  if (visit595_373_1(v)) {
    ...
    if (visit596_378_1(S.trim(className))) {
