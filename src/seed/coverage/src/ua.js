...
if (! _$jscoverage['/ua.js']) {
  ...
  _$jscoverage['/ua.js'].lineData[59] = 0;
...
function visit586_367_1(result) {
...
function visit585_345_1(result) {
...
function visit584_343_1(result) {
...
function visit580_325_1(result) {
...
function visit577_313_1(result) {
...
function visit576_308_1(result) {
...
function visit575_306_1(result) {
...
function visit574_298_1(result) {
...
function visit572_282_1(result) {
...
function visit571_277_1(result) {
...
function visit570_274_1(result) {
...
function visit569_270_1(result) {
...
function visit568_262_1(result) {
...
function visit566_249_1(result) {
...
function visit562_236_1(result) {
...
function visit561_231_1(result) {
...
function visit560_227_1(result) {
...
function visit559_223_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit546_9_1(visit547_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit549_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit550_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit551_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit552_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit554_194_1(s.length > 0)) {
      ...
      if (visit558_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit569_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit574_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit583_335_1(UA.core || core);
  ...
  if (visit584_343_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[344]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[345]++;
    if (visit585_345_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit586_367_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[369]++;
  if (visit587_369_1(documentElement)) {
  ...
  if (visit588_372_1(v)) {
    ...
    if (visit589_377_1(S.trim(className))) {
