...
function visit613_368_1(result) {
...
function visit612_346_1(result) {
...
function visit604_313_1(result) {
...
function visit602_306_1(result) {
...
function visit601_298_1(result) {
...
function visit599_282_1(result) {
...
function visit598_277_1(result) {
...
function visit597_274_1(result) {
...
function visit596_270_1(result) {
...
function visit589_236_1(result) {
...
function visit588_231_1(result) {
...
function visit587_227_1(result) {
...
function visit586_223_1(result) {
...
function visit585_220_1(result) {
...
function visit580_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit573_9_1(visit574_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit576_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit577_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit578_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit579_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit580_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit581_194_1(s.length > 0)) {
      ...
      if (visit585_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit596_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit601_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit610_335_1(UA.core || core);
  ...
  if (visit611_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit612_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit613_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit614_370_1(documentElement)) {
  ...
  if (visit615_373_1(v)) {
    ...
    if (visit616_378_1(S.trim(className))) {
