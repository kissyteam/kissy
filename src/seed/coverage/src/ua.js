...
function visit590_368_1(result) {
...
function visit589_346_1(result) {
...
function visit584_325_1(result) {
...
function visit581_313_1(result) {
...
function visit580_308_1(result) {
...
function visit579_306_1(result) {
...
function visit578_298_1(result) {
...
function visit577_288_1(result) {
...
function visit576_282_1(result) {
...
function visit575_277_1(result) {
...
function visit574_274_1(result) {
...
function visit573_270_1(result) {
...
function visit566_236_1(result) {
...
function visit565_231_1(result) {
...
function visit564_227_1(result) {
...
function visit563_223_1(result) {
...
function visit562_220_1(result) {
...
function visit557_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit550_9_1(visit551_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit553_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit554_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit555_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit556_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit557_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit558_194_1(s.length > 0)) {
      ...
      if (visit562_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit573_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit578_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit587_335_1(UA.core || core);
  ...
  if (visit588_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit589_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit590_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit591_370_1(documentElement)) {
  ...
  if (visit592_373_1(v)) {
    ...
    if (visit593_378_1(S.trim(className))) {
