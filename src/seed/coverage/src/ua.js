...
function visit615_368_1(result) {
...
function visit614_346_1(result) {
...
function visit606_313_1(result) {
...
function visit604_306_1(result) {
...
function visit603_298_1(result) {
...
function visit601_282_1(result) {
...
function visit600_277_1(result) {
...
function visit599_274_1(result) {
...
function visit598_270_1(result) {
...
function visit591_236_1(result) {
...
function visit590_231_1(result) {
...
function visit589_227_1(result) {
...
function visit588_223_1(result) {
...
function visit587_220_1(result) {
...
function visit582_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit575_9_1(visit576_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit578_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit579_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit580_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit581_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit582_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit583_194_1(s.length > 0)) {
      ...
      if (visit587_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit598_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit603_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit612_335_1(UA.core || core);
  ...
  if (visit613_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit614_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit615_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit616_370_1(documentElement)) {
  ...
  if (visit617_373_1(v)) {
    ...
    if (visit618_378_1(S.trim(className))) {
