...
function visit616_372_1(result) {
...
function visit615_350_1(result) {
...
function visit614_347_1(result) {
...
function visit613_339_2(result) {
...
function visit608_327_1(result) {
...
function visit605_315_1(result) {
...
function visit604_310_1(result) {
...
function visit603_308_1(result) {
...
function visit602_288_1(result) {
...
function visit601_286_1(result) {
...
function visit600_281_1(result) {
...
function visit599_278_1(result) {
...
function visit591_244_1(result) {
...
function visit589_234_1(result) {
...
function visit588_232_1(result) {
...
function visit587_229_2(result) {
...
function visit586_229_1(result) {
...
function visit581_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit574_11_1(visit575_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit577_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit578_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit579_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit580_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit581_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit611_337_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[338]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[339]++;
    UA.ieMode = visit612_339_1(visit613_339_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit614_347_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[348]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[350]++;
    if (visit615_350_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit616_372_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[374]++;
  if (visit617_374_1(documentElement)) {
  ...
  if (visit618_377_1(v)) {
    ...
    if (visit619_382_1(S.trim(className))) {
