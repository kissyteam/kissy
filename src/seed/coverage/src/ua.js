...
function visit591_378_1(result) {
...
function visit590_356_1(result) {
...
function visit589_353_1(result) {
...
function visit588_345_2(result) {
...
function visit583_333_1(result) {
...
function visit580_321_1(result) {
...
function visit579_316_1(result) {
...
function visit578_314_1(result) {
...
function visit577_296_1(result) {
...
function visit576_290_1(result) {
...
function visit575_285_1(result) {
...
function visit574_282_1(result) {
...
function visit573_278_1(result) {
...
function visit569_256_1(result) {
...
function visit567_248_1(result) {
...
function visit566_244_1(result) {
...
function visit565_239_1(result) {
...
function visit564_235_1(result) {
...
function visit563_231_1(result) {
...
function visit562_228_1(result) {
...
function visit557_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit550_11_1(visit551_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit553_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit554_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit555_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit556_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit557_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit586_343_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[344]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[345]++;
    UA.ieMode = visit587_345_1(visit588_345_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit589_353_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[354]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[356]++;
    if (visit590_356_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit591_378_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[380]++;
  if (visit592_380_1(documentElement)) {
  ...
  if (visit593_383_1(v)) {
    ...
    if (visit594_388_1(S.trim(className))) {
