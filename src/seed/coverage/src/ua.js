...
function visit589_356_1(result) {
...
function visit587_345_2(result) {
...
function visit586_345_1(result) {
...
function visit584_337_1(result) {
...
function visit580_330_1(result) {
...
function visit579_321_1(result) {
...
function visit578_316_1(result) {
...
function visit576_296_1(result) {
...
function visit575_290_1(result) {
...
function visit574_285_1(result) {
...
function visit572_278_1(result) {
...
function visit565_244_1(result) {
...
function visit564_239_1(result) {
...
function visit563_235_1(result) {
...
function visit561_228_1(result) {
...
function visit556_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit549_11_1(visit550_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit552_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit553_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit554_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit555_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit556_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit585_343_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[344]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[345]++;
    UA.ieMode = visit586_345_1(visit587_345_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit588_353_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[354]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[356]++;
    if (visit589_356_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit590_378_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[380]++;
  if (visit591_380_1(documentElement)) {
  ...
  if (visit592_383_1(v)) {
    ...
    if (visit593_388_1(S.trim(className))) {
