...
function visit588_377_1(result) {
...
function visit585_367_1(result) {
...
function visit579_325_1(result) {
...
function visit576_313_1(result) {
...
function visit575_308_1(result) {
...
function visit574_306_1(result) {
...
function visit573_298_1(result) {
...
function visit572_288_1(result) {
...
function visit571_282_1(result) {
...
function visit570_277_1(result) {
...
function visit569_274_1(result) {
...
function visit566_253_1(result) {
...
function visit561_236_1(result) {
...
function visit560_231_1(result) {
...
function visit559_227_1(result) {
...
function visit558_223_1(result) {
...
function visit557_220_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit545_9_1(visit546_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit548_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit549_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit550_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit551_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit553_194_1(s.length > 0)) {
      ...
      if (visit557_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit568_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit573_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit582_335_1(UA.core || core);
  ...
  if (visit583_343_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[344]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[345]++;
    if (visit584_345_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit585_367_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[369]++;
  if (visit586_369_1(documentElement)) {
  ...
  if (visit587_372_1(v)) {
    ...
    if (visit588_377_1(S.trim(className))) {
