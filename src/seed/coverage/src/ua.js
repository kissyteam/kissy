...
_$jscoverage['/ua.js'].branchData['381'][1].init(242, 17, 'S.trim(className)');
function visit609_381_1(result) {
  _$jscoverage['/ua.js'].branchData['381'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['376'][1].init(46, 1, 'v');
function visit608_376_1(result) {
  _$jscoverage['/ua.js'].branchData['376'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['373'][1].init(12005, 15, 'documentElement');
function visit607_373_1(result) {
...
function visit606_371_1(result) {
...
function visit598_326_1(result) {
...
function visit597_324_1(result) {
  _$jscoverage['/ua.js'].branchData['324'][1].ranCondition(result);
  return result;
}_$jscoverage['/ua.js'].branchData['323'][1].init(9704, 3, '!os');
function visit596_323_1(result) {
...
function visit595_314_1(result) {
...
function visit594_309_1(result) {
...
function visit593_307_1(result) {
...
function visit592_287_1(result) {
...
function visit591_285_1(result) {
...
function visit590_280_1(result) {
...
function visit589_277_1(result) {
...
function visit588_273_1(result) {
...
function visit581_243_1(result) {
...
function visit580_235_1(result) {
...
function visit579_233_1(result) {
...
function visit578_231_1(result) {
...
function visit577_228_1(result) {
...
function visit572_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit565_11_1(visit566_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit568_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit569_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit570_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit571_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit572_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit601_336_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[337]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[338]++;
    UA.ieMode = visit602_338_1(visit603_338_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit604_346_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[347]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[349]++;
    if (visit605_349_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit606_371_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[373]++;
  if (visit607_373_1(documentElement)) {
  ...
  if (visit608_376_1(v)) {
    ...
    if (visit609_381_1(S.trim(className))) {
