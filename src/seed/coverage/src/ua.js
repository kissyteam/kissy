...
function visit602_378_1(result) {
...
function visit601_356_1(result) {
...
function visit600_353_1(result) {
...
function visit599_345_2(result) {
...
function visit594_333_1(result) {
...
function visit591_321_1(result) {
...
function visit590_316_1(result) {
...
function visit588_296_1(result) {
...
function visit587_290_1(result) {
...
function visit586_285_1(result) {
...
function visit585_282_1(result) {
...
function visit584_278_1(result) {
...
function visit577_244_1(result) {
...
function visit576_239_1(result) {
...
function visit575_235_1(result) {
...
function visit574_231_1(result) {
...
function visit573_228_1(result) {
...
function visit568_195_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit561_11_1(visit562_11_2(navigator && navigator.userAgent) || '');
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit564_26_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit565_35_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit566_36_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit567_53_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit568_195_1(div && div.getElementsByTagName)) {
    ...
    UA.core = visit597_343_1(UA.core || core);
    _$jscoverage['/ua.js'].lineData[344]++;
    UA.shell = shell;
    _$jscoverage['/ua.js'].lineData[345]++;
    UA.ieMode = visit598_345_1(visit599_345_2(UA.ie && doc.documentMode) || UA.ie);
  ...
  if (visit600_353_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[354]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[356]++;
    if (visit601_356_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var browsers = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit602_378_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[380]++;
  if (visit603_380_1(documentElement)) {
  ...
  if (visit604_383_1(v)) {
    ...
    if (visit605_388_1(S.trim(className))) {
