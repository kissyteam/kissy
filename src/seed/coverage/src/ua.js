...
function visit591_368_1(result) {
...
function visit590_346_1(result) {
...
function visit585_325_1(result) {
...
function visit582_313_1(result) {
...
function visit581_308_1(result) {
...
function visit580_306_1(result) {
...
function visit579_298_1(result) {
...
function visit578_288_1(result) {
...
function visit577_282_1(result) {
...
function visit576_277_1(result) {
...
function visit575_274_1(result) {
...
function visit567_236_1(result) {
...
function visit566_231_1(result) {
...
function visit565_227_1(result) {
...
function visit564_223_1(result) {
...
function visit563_220_1(result) {
...
function visit558_187_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, doc = win.document, navigator = win.navigator, ua = visit551_9_1(visit552_9_2(navigator && navigator.userAgent) || "");
  ...
  function setTridentVersion(ua, UA) {
    ...
    if (visit554_24_1((m = ua.match(/Trident\/([\d.]*)/)) && m[1])) {
  ...
  function getIEVersion(ua) {
    ...
    if (visit555_33_1((m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = (visit556_34_1(m[1] || m[2]))))) {
  ...
  function getDescriptorFromUserAgent(ua) {
    ...
    var EMPTY = '', os, core = EMPTY, shell = EMPTY, m, IE_DETECT_RANGE = [6, 9], ieVersion, v, end, VERSION_PLACEHOLDER = '{{version}}', IE_DETECT_TPL = '<!--[if IE ' + VERSION_PLACEHOLDER + ']><' + 's></s><![endif]-->', div = visit557_51_1(doc && doc.createElement('div')), s = [];
  ...
  nodejs: undefined};
    ...
    if (visit558_187_1(div && div.getElementsByTagName)) {
    ...
    if (visit559_194_1(s.length > 0)) {
      ...
      if (visit563_220_1((m = ua.match(/AppleWebKit\/([\d.]*)/)) && m[1])) {
        ...
        if (visit574_270_1((m = ua.match(/Presto\/([\d.]*)/)) && m[1])) {
          ...
          if (visit579_298_1(ieVersion = getIEVersion(ua))) {
    ...
    UA.core = visit588_335_1(UA.core || core);
  ...
  if (visit589_344_1(typeof process === 'object')) {
    _$jscoverage['/ua.js'].lineData[345]++;
    var versions, nodeVersion;
    _$jscoverage['/ua.js'].lineData[346]++;
    if (visit590_346_1((versions = process.versions) && (nodeVersion = versions.node))) {
  ...
  var o = ['webkit', 'trident', 'gecko', 'presto', 'chrome', 'safari', 'firefox', 'ie', 'opera'], documentElement = visit591_368_1(doc && doc.documentElement), className = '';
  _$jscoverage['/ua.js'].lineData[370]++;
  if (visit592_370_1(documentElement)) {
  ...
  if (visit593_373_1(v)) {
    ...
    if (visit594_378_1(S.trim(className))) {
