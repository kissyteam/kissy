...
function visit636_658_1(result) {
...
function visit634_645_1(result) {
...
function visit633_640_1(result) {
...
function visit629_619_1(result) {
...
function visit628_617_1(result) {
...
function visit627_612_1(result) {
...
function visit626_588_1(result) {
...
function visit625_587_1(result) {
...
function visit624_572_1(result) {
...
function visit623_540_1(result) {
...
function visit622_539_1(result) {
...
function visit621_434_1(result) {
...
function visit616_414_1(result) {
...
function visit608_291_1(result) {
...
function visit605_240_1(result) {
...
function visit604_233_1(result) {
...
function visit601_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit594_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit595_89_1(query || '');
  }
  ...
  self._query = visit596_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit597_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit600_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit601_192_1(key instanceof Query)) {
  ...
  if (visit603_229_1(typeof key == 'string')) {
    ...
    if (visit604_233_1(currentValue === undefined)) {
    ...
    if (visit605_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit608_291_1(uriStr instanceof Uri)) {
  ...
  if (visit611_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit612_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit613_406_1(override)) {
    ...
    if (visit619_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit620_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit621_434_1(override || relativeUri[o])) {
  ...
  if (visit622_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit623_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit624_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit625_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit626_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit627_612_1(scheme = self.scheme)) {
  ...
  if (visit628_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit629_619_1(userInfo = self.userInfo)) {
    ...
    if (visit630_626_1(port = self.port)) {
  ...
  if (visit631_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit632_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit633_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit634_645_1(fragment = self.fragment)) {
  ...
  url = visit635_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit636_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
