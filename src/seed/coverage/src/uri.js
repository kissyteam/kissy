...
function visit628_645_1(result) {
...
function visit627_640_1(result) {
...
function visit623_619_1(result) {
...
function visit622_617_1(result) {
...
function visit621_612_1(result) {
...
function visit620_588_1(result) {
...
function visit619_587_1(result) {
...
function visit618_572_1(result) {
...
function visit617_540_1(result) {
...
function visit616_539_1(result) {
...
function visit615_434_1(result) {
...
function visit610_414_1(result) {
...
function visit602_291_1(result) {
...
function visit599_240_1(result) {
...
function visit598_233_1(result) {
...
function visit595_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit588_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit589_89_1(query || '');
  }
  ...
  self._query = visit590_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit591_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit594_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit595_192_1(key instanceof Query)) {
  ...
  if (visit597_229_1(typeof key == 'string')) {
    ...
    if (visit598_233_1(currentValue === undefined)) {
    ...
    if (visit599_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit602_291_1(uriStr instanceof Uri)) {
  ...
  if (visit605_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit606_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit607_406_1(override)) {
    ...
    if (visit613_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit614_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit615_434_1(override || relativeUri[o])) {
  ...
  if (visit616_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit617_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit618_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit619_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit620_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit621_612_1(scheme = self.scheme)) {
  ...
  if (visit622_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit623_619_1(userInfo = self.userInfo)) {
    ...
    if (visit624_626_1(port = self.port)) {
  ...
  if (visit625_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit626_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit627_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit628_645_1(fragment = self.fragment)) {
  ...
  url = visit629_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit630_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
