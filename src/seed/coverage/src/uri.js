...
function visit639_658_1(result) {
...
function visit637_645_1(result) {
...
function visit636_640_1(result) {
...
function visit632_619_1(result) {
...
function visit631_617_1(result) {
...
function visit630_612_1(result) {
...
function visit629_588_1(result) {
...
function visit628_587_1(result) {
...
function visit627_572_1(result) {
...
function visit626_540_1(result) {
...
function visit625_539_1(result) {
...
function visit624_434_1(result) {
...
function visit619_414_1(result) {
...
function visit611_291_1(result) {
...
function visit608_240_1(result) {
...
function visit607_233_1(result) {
...
function visit604_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit597_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit598_89_1(query || '');
  }
  ...
  self._query = visit599_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit600_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit603_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit604_192_1(key instanceof Query)) {
  ...
  if (visit606_229_1(typeof key == 'string')) {
    ...
    if (visit607_233_1(currentValue === undefined)) {
    ...
    if (visit608_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit611_291_1(uriStr instanceof Uri)) {
  ...
  if (visit614_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit615_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit616_406_1(override)) {
    ...
    if (visit622_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit623_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit624_434_1(override || relativeUri[o])) {
  ...
  if (visit625_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit626_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit627_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit628_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit629_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit630_612_1(scheme = self.scheme)) {
  ...
  if (visit631_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit632_619_1(userInfo = self.userInfo)) {
    ...
    if (visit633_626_1(port = self.port)) {
  ...
  if (visit634_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit635_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit636_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit637_645_1(fragment = self.fragment)) {
  ...
  url = visit638_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit639_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
