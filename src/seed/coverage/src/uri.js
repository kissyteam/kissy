...
function visit647_632_1(result) {
...
function visit646_587_1(result) {
...
function visit645_586_1(result) {
...
function visit644_571_1(result) {
...
function visit643_539_1(result) {
...
function visit642_538_1(result) {
...
function visit641_433_1(result) {
...
function visit636_413_1(result) {
...
function visit628_291_1(result) {
...
function visit625_240_1(result) {
...
function visit624_233_1(result) {
...
function visit621_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit614_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit615_90_1(query || '');
  }
  ...
  self._query = visit616_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit617_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit620_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit621_192_1(key instanceof Query)) {
  ...
  if (visit623_229_1(typeof key === 'string')) {
    ...
    if (visit624_233_1(currentValue === undefined)) {
    ...
    if (visit625_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit628_291_1(uriStr instanceof Uri)) {
  ...
  if (visit631_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit632_403_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[405]++;
    if (visit633_405_1(override)) {
    ...
    if (visit639_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit640_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit641_433_1(override || relativeUri[o])) {
  ...
  if (visit642_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit643_539_1(S.startsWith(query, '?'))) {
  ...
  if (visit644_571_1(S.startsWith(fragment, '#'))) {
  ...
  return visit645_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit646_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit647_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit648_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit649_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
