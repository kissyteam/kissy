...
function visit653_632_1(result) {
...
function visit652_587_1(result) {
...
function visit651_586_1(result) {
...
function visit650_571_1(result) {
...
function visit649_539_1(result) {
...
function visit648_538_1(result) {
...
function visit647_433_1(result) {
...
function visit642_413_1(result) {
...
function visit634_291_1(result) {
...
function visit631_240_1(result) {
...
function visit630_233_1(result) {
...
function visit627_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit620_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit621_90_1(query || '');
  }
  ...
  self._query = visit622_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit623_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit626_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit627_192_1(key instanceof Query)) {
  ...
  if (visit629_229_1(typeof key === 'string')) {
    ...
    if (visit630_233_1(currentValue === undefined)) {
    ...
    if (visit631_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit634_291_1(uriStr instanceof Uri)) {
  ...
  if (visit637_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit638_403_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[405]++;
    if (visit639_405_1(override)) {
    ...
    if (visit645_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit646_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit647_433_1(override || relativeUri[o])) {
  ...
  if (visit648_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit649_539_1(S.startsWith(query, '?'))) {
  ...
  if (visit650_571_1(S.startsWith(fragment, '#'))) {
  ...
  return visit651_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit652_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit653_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit654_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit655_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
