...
function visit641_657_1(result) {
...
function visit640_645_1(result) {
...
function visit639_640_1(result) {
...
function visit638_633_1(result) {
...
function visit636_626_1(result) {
...
function visit635_619_1(result) {
...
function visit634_617_1(result) {
...
function visit633_612_1(result) {
...
function visit630_572_1(result) {
...
function visit617_393_1(result) {
...
(function(S, undefined) {
  ...
  if (visit617_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit618_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit619_406_1(override)) {
    ...
    if (visit625_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit626_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit627_434_1(override || relativeUri[o])) {
  ...
  if (visit628_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit629_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit630_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit631_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit632_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit633_612_1(scheme = self.scheme)) {
  ...
  if (visit634_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit635_619_1(userInfo = self.userInfo)) {
    ...
    if (visit636_626_1(port = self.port)) {
  ...
  if (visit637_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit638_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit639_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit640_645_1(fragment = self.fragment)) {
  ...
  url = visit641_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit642_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
