...
function visit635_645_1(result) {
...
function visit634_640_1(result) {
...
function visit633_633_1(result) {
...
function visit631_626_1(result) {
...
function visit630_619_1(result) {
...
function visit629_617_1(result) {
...
function visit628_612_1(result) {
...
function visit627_588_1(result) {
...
function visit626_587_1(result) {
...
function visit625_572_1(result) {
...
function visit624_540_1(result) {
...
function visit623_539_1(result) {
...
function visit622_434_1(result) {
...
function visit617_414_1(result) {
...
function visit609_291_1(result) {
...
function visit606_240_1(result) {
...
function visit605_233_1(result) {
...
function visit602_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit595_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit596_89_1(query || '');
  }
  ...
  self._query = visit597_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit598_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit601_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit602_192_1(key instanceof Query)) {
  ...
  if (visit604_229_1(typeof key == 'string')) {
    ...
    if (visit605_233_1(currentValue === undefined)) {
    ...
    if (visit606_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit609_291_1(uriStr instanceof Uri)) {
  ...
  if (visit612_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit613_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit614_406_1(override)) {
    ...
    if (visit620_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit621_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit622_434_1(override || relativeUri[o])) {
  ...
  if (visit623_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit624_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit625_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit626_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit627_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit628_612_1(scheme = self.scheme)) {
  ...
  if (visit629_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit630_619_1(userInfo = self.userInfo)) {
    ...
    if (visit631_626_1(port = self.port)) {
  ...
  if (visit632_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit633_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit634_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit635_645_1(fragment = self.fragment)) {
  ...
  url = visit636_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit637_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
