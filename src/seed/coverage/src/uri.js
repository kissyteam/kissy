...
function visit627_645_1(result) {
...
function visit626_640_1(result) {
...
function visit622_619_1(result) {
...
function visit621_617_1(result) {
...
function visit620_612_1(result) {
...
function visit619_588_1(result) {
...
function visit618_587_1(result) {
...
function visit617_572_1(result) {
...
function visit616_540_1(result) {
...
function visit615_539_1(result) {
...
function visit614_434_1(result) {
...
function visit609_414_1(result) {
...
function visit601_291_1(result) {
...
function visit598_240_1(result) {
...
function visit597_233_1(result) {
...
function visit594_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit587_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit588_89_1(query || '');
  }
  ...
  self._query = visit589_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit590_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit593_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit594_192_1(key instanceof Query)) {
  ...
  if (visit596_229_1(typeof key == 'string')) {
    ...
    if (visit597_233_1(currentValue === undefined)) {
    ...
    if (visit598_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit601_291_1(uriStr instanceof Uri)) {
  ...
  if (visit604_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit605_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit606_406_1(override)) {
    ...
    if (visit612_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit613_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit614_434_1(override || relativeUri[o])) {
  ...
  if (visit615_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit616_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit617_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit618_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit619_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit620_612_1(scheme = self.scheme)) {
  ...
  if (visit621_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit622_619_1(userInfo = self.userInfo)) {
    ...
    if (visit623_626_1(port = self.port)) {
  ...
  if (visit624_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit625_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit626_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit627_645_1(fragment = self.fragment)) {
  ...
  url = visit628_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit629_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
