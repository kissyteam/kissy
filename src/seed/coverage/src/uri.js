...
function visit632_632_1(result) {
...
function visit631_587_1(result) {
...
function visit630_586_1(result) {
...
function visit629_571_1(result) {
...
function visit628_539_1(result) {
...
function visit627_538_1(result) {
...
function visit621_413_1(result) {
...
function visit620_412_1(result) {
...
function visit613_291_1(result) {
...
function visit610_240_1(result) {
...
function visit609_233_1(result) {
...
function visit606_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit599_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit600_90_1(query || '');
  }
  ...
  self._query = visit601_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit602_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit605_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit606_192_1(key instanceof Query)) {
  ...
  if (visit608_229_1(typeof key === 'string')) {
    ...
    if (visit609_233_1(currentValue === undefined)) {
    ...
    if (visit610_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit613_291_1(uriStr instanceof Uri)) {
  ...
  if (visit616_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit617_403_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[405]++;
    if (visit618_405_1(override)) {
    ...
    if (visit624_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit625_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit626_433_1(override || relativeUri[o])) {
  ...
  if (visit627_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit628_539_1(S.startsWith(query, '?'))) {
  ...
  if (visit629_571_1(S.startsWith(fragment, '#'))) {
  ...
  return visit630_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit631_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit632_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit633_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit634_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
