...
function visit640_658_1(result) {
...
function visit638_645_1(result) {
...
function visit637_640_1(result) {
...
function visit633_619_1(result) {
...
function visit632_617_1(result) {
...
function visit631_612_1(result) {
...
function visit630_588_1(result) {
...
function visit629_587_1(result) {
...
function visit628_572_1(result) {
...
function visit627_540_1(result) {
...
function visit626_539_1(result) {
...
function visit625_434_1(result) {
...
function visit620_414_1(result) {
...
function visit612_291_1(result) {
...
function visit609_240_1(result) {
...
function visit608_233_1(result) {
...
function visit605_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit598_78_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit599_89_1(query || '');
  }
  ...
  self._query = visit600_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit601_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit604_189_1(typeof key == 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit605_192_1(key instanceof Query)) {
  ...
  if (visit607_229_1(typeof key == 'string')) {
    ...
    if (visit608_233_1(currentValue === undefined)) {
    ...
    if (visit609_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit612_291_1(uriStr instanceof Uri)) {
  ...
  if (visit615_393_1(typeof relativeUri == 'string')) {
  ...
  if (visit616_404_1(o == 'path')) {
    _$jscoverage['/uri.js'].lineData[406]++;
    if (visit617_406_1(override)) {
    ...
    if (visit623_429_1(o == 'query')) {
      _$jscoverage['/uri.js'].lineData[430]++;
      if (visit624_430_1(override || relativeUri['query'].toString())) {
      ...
      if (visit625_434_1(override || relativeUri[o])) {
  ...
  if (visit626_539_1(typeof query == 'string')) {
    _$jscoverage['/uri.js'].lineData[540]++;
    if (visit627_540_1(S.startsWith(query, '?'))) {
  ...
  if (visit628_572_1(S.startsWith(fragment, '#'))) {
  ...
  return visit629_587_1(equalsIgnoreCase(self.hostname, other['hostname']) && visit630_588_1(equalsIgnoreCase(self.scheme, other['scheme']) && equalsIgnoreCase(self.port, other['port'])));
}, 
  toString: function(serializeArray) {
  ...
  if (visit631_612_1(scheme = self.scheme)) {
  ...
  if (visit632_617_1(hostname = self.hostname)) {
    _$jscoverage['/uri.js'].lineData[618]++;
    out.push('//');
    _$jscoverage['/uri.js'].lineData[619]++;
    if (visit633_619_1(userInfo = self.userInfo)) {
    ...
    if (visit634_626_1(port = self.port)) {
  ...
  if (visit635_632_1(path = self.path)) {
    _$jscoverage['/uri.js'].lineData[633]++;
    if (visit636_633_1(hostname && !S.startsWith(path, '/'))) {
  ...
  if (visit637_640_1(query = (self.query.toString.call(self.query, serializeArray)))) {
  ...
  if (visit638_645_1(fragment = self.fragment)) {
  ...
  url = visit639_657_1(url || "");
  _$jscoverage['/uri.js'].lineData[658]++;
  var m = visit640_658_1(url.match(URI_SPLIT_REG) || []), ret = {};
