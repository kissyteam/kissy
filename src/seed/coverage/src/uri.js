...
function visit630_659_1(result) {
...
function visit628_634_1(result) {
...
function visit627_589_1(result) {
...
function visit625_573_1(result) {
...
function visit624_541_1(result) {
...
function visit622_435_1(result) {
...
function visit621_431_1(result) {
...
function visit617_415_1(result) {
...
function visit609_292_1(result) {
...
function visit606_241_1(result) {
...
function visit605_234_1(result) {
...
function visit602_193_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit595_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit596_90_1(query || '');
  }
  ...
  self._query = visit597_112_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit598_130_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit601_190_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[191]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[193]++;
    if (visit602_193_1(key instanceof Query)) {
  ...
  if (visit604_230_1(typeof key === 'string')) {
    ...
    if (visit605_234_1(currentValue === undefined)) {
    ...
    if (visit606_241_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit609_292_1(uriStr instanceof Uri)) {
  ...
  if (visit612_394_1(typeof relativeUri === 'string')) {
  ...
  if (visit613_405_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[407]++;
    if (visit614_407_1(override)) {
    ...
    if (visit620_430_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[431]++;
      if (visit621_431_1(override || relativeUri.query.toString())) {
      ...
      if (visit622_435_1(override || relativeUri[o])) {
  ...
  if (visit623_540_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[541]++;
    if (visit624_541_1(S.startsWith(query, '?'))) {
  ...
  if (visit625_573_1(S.startsWith(fragment, '#'))) {
  ...
  return visit626_588_1(equalsIgnoreCase(self.hostname, other.hostname) && visit627_589_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit628_634_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit629_658_1(url || '');
  _$jscoverage['/uri.js'].lineData[659]++;
  var m = visit630_659_1(url.match(URI_SPLIT_REG) || []), ret = {};
