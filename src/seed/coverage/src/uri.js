...
function visit644_632_1(result) {
...
function visit643_587_1(result) {
...
function visit642_586_1(result) {
...
function visit641_571_1(result) {
...
function visit640_539_1(result) {
...
function visit639_538_1(result) {
...
function visit638_433_1(result) {
...
function visit633_413_1(result) {
...
function visit625_291_1(result) {
...
function visit622_240_1(result) {
...
function visit621_233_1(result) {
...
function visit618_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit611_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit612_90_1(query || '');
  }
  ...
  self._query = visit613_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit614_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit617_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit618_192_1(key instanceof Query)) {
  ...
  if (visit620_229_1(typeof key === 'string')) {
    ...
    if (visit621_233_1(currentValue === undefined)) {
    ...
    if (visit622_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit625_291_1(uriStr instanceof Uri)) {
  ...
  if (visit628_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit629_403_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[405]++;
    if (visit630_405_1(override)) {
    ...
    if (visit636_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit637_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit638_433_1(override || relativeUri[o])) {
  ...
  if (visit639_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit640_539_1(S.startsWith(query, '?'))) {
  ...
  if (visit641_571_1(S.startsWith(fragment, '#'))) {
  ...
  return visit642_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit643_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit644_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit645_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit646_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
