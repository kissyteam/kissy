...
function visit621_634_1(result) {
...
function visit620_589_1(result) {
...
function visit618_573_1(result) {
...
function visit617_541_1(result) {
...
function visit615_435_1(result) {
...
function visit614_431_1(result) {
...
function visit610_415_1(result) {
...
function visit608_411_1(result) {
...
function visit606_405_1(result) {
...
function visit605_394_1(result) {
...
function visit602_292_1(result) {
...
function visit599_241_1(result) {
...
function visit598_234_1(result) {
...
function visit595_193_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit588_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit589_90_1(query || '');
  }
  ...
  self._query = visit590_112_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit591_130_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit594_190_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[191]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[193]++;
    if (visit595_193_1(key instanceof Query)) {
  ...
  if (visit597_230_1(typeof key === 'string')) {
    ...
    if (visit598_234_1(currentValue === undefined)) {
    ...
    if (visit599_241_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit602_292_1(uriStr instanceof Uri)) {
  ...
  if (visit605_394_1(typeof relativeUri === 'string')) {
  ...
  if (visit606_405_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[407]++;
    if (visit607_407_1(override)) {
    ...
    if (visit613_430_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[431]++;
      if (visit614_431_1(override || relativeUri.query.toString())) {
      ...
      if (visit615_435_1(override || relativeUri[o])) {
  ...
  if (visit616_540_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[541]++;
    if (visit617_541_1(S.startsWith(query, '?'))) {
  ...
  if (visit618_573_1(S.startsWith(fragment, '#'))) {
  ...
  return visit619_588_1(equalsIgnoreCase(self.hostname, other.hostname) && visit620_589_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit621_634_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit622_658_1(url || '');
  _$jscoverage['/uri.js'].lineData[659]++;
  var m = visit623_659_1(url.match(URI_SPLIT_REG) || []), ret = {};
