...
if (! _$jscoverage['/uri.js']) {
  ...
  _$jscoverage['/uri.js'].lineData[392] = 0;
  _$jscoverage['/uri.js'].lineData[393] = 0;
  _$jscoverage['/uri.js'].lineData[396] = 0;
  _$jscoverage['/uri.js'].lineData[402] = 0;
  ...
  _$jscoverage['/uri.js'].lineData[447] = 0;
  _$jscoverage['/uri.js'].lineData[456] = 0;
  _$jscoverage['/uri.js'].lineData[457] = 0;
  _$jscoverage['/uri.js'].lineData[465] = 0;
  _$jscoverage['/uri.js'].lineData[474] = 0;
  _$jscoverage['/uri.js'].lineData[475] = 0;
  _$jscoverage['/uri.js'].lineData[484] = 0;
  _$jscoverage['/uri.js'].lineData[485] = 0;
  _$jscoverage['/uri.js'].lineData[493] = 0;
  _$jscoverage['/uri.js'].lineData[502] = 0;
  _$jscoverage['/uri.js'].lineData[503] = 0;
  _$jscoverage['/uri.js'].lineData[511] = 0;
  _$jscoverage['/uri.js'].lineData[520] = 0;
  _$jscoverage['/uri.js'].lineData[521] = 0;
  _$jscoverage['/uri.js'].lineData[529] = 0;
  _$jscoverage['/uri.js'].lineData[538] = 0;
  ...
  _$jscoverage['/uri.js'].lineData[553] = 0;
  _$jscoverage['/uri.js'].lineData[561] = 0;
  _$jscoverage['/uri.js'].lineData[570] = 0;
  ...
  _$jscoverage['/uri.js'].lineData[584] = 0;
  _$jscoverage['/uri.js'].lineData[586] = 0;
  _$jscoverage['/uri.js'].lineData[601] = 0;
  _$jscoverage['/uri.js'].lineData[611] = 0;
...
if (! _$jscoverage['/uri.js'].branchData) {
  ...
  _$jscoverage['/uri.js'].branchData['392'] = [];
  _$jscoverage['/uri.js'].branchData['392'][1] = new BranchData();
  _$jscoverage['/uri.js'].branchData['403'] = [];
  _$jscoverage['/uri.js'].branchData['403'][1] = new BranchData();
  ...
  _$jscoverage['/uri.js'].branchData['428'] = [];
  _$jscoverage['/uri.js'].branchData['428'][1] = new BranchData();
  ...
  _$jscoverage['/uri.js'].branchData['538'] = [];
  _$jscoverage['/uri.js'].branchData['538'][1] = new BranchData();
  _$jscoverage['/uri.js'].branchData['539'] = [];
  _$jscoverage['/uri.js'].branchData['539'][1] = new BranchData();
  _$jscoverage['/uri.js'].branchData['571'] = [];
  _$jscoverage['/uri.js'].branchData['571'][1] = new BranchData();
  _$jscoverage['/uri.js'].branchData['586'] = [];
  _$jscoverage['/uri.js'].branchData['586'][1] = new BranchData();
  ...
  _$jscoverage['/uri.js'].branchData['656'] = [];
  _$jscoverage['/uri.js'].branchData['656'][1] = new BranchData();
  _$jscoverage['/uri.js'].branchData['657'] = [];
  _$jscoverage['/uri.js'].branchData['657'][1] = new BranchData();
}
_$jscoverage['/uri.js'].branchData['657'][1].init(42, 30, 'url.match(URI_SPLIT_REG) || []');
function visit645_657_1(result) {
  _$jscoverage['/uri.js'].branchData['657'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['656'][1].init(15, 9, 'url || \'\'');
function visit644_656_1(result) {
  _$jscoverage['/uri.js'].branchData['656'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['632'][1].init(21, 36, 'hostname && !S.startsWith(path, \'/\')');
function visit643_632_1(result) {
  _$jscoverage['/uri.js'].branchData['632'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['587'][1].init(66, 102, 'equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)');
function visit642_587_1(result) {
  _$jscoverage['/uri.js'].branchData['587'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['586'][1].init(97, 169, 'equalsIgnoreCase(self.hostname, other.hostname) && equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)');
function visit641_586_1(result) {
  _$jscoverage['/uri.js'].branchData['586'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['571'][1].init(46, 27, 'S.startsWith(fragment, \'#\')');
function visit640_571_1(result) {
  _$jscoverage['/uri.js'].branchData['571'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['539'][1].init(21, 24, 'S.startsWith(query, \'?\')');
function visit639_539_1(result) {
  _$jscoverage['/uri.js'].branchData['539'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['538'][1].init(17, 25, 'typeof query === \'string\'');
function visit638_538_1(result) {
  _$jscoverage['/uri.js'].branchData['538'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['433'][1].init(1637, 26, 'override || relativeUri[o]');
function visit637_433_1(result) {
  _$jscoverage['/uri.js'].branchData['433'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['429'][1].init(25, 40, 'override || relativeUri.query.toString()');
function visit636_429_1(result) {
  _$jscoverage['/uri.js'].branchData['429'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['428'][1].init(1398, 13, 'o === \'query\'');
function visit635_428_1(result) {
  _$jscoverage['/uri.js'].branchData['428'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['419'][1].init(195, 21, 'lastSlashIndex !== -1');
function visit634_419_1(result) {
  _$jscoverage['/uri.js'].branchData['419'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['416'][1].init(242, 11, 'target.path');
function visit633_416_1(result) {
  _$jscoverage['/uri.js'].branchData['416'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['413'][1].init(37, 31, 'target.hostname && !target.path');
function visit632_413_1(result) {
  _$jscoverage['/uri.js'].branchData['413'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['412'][1].init(154, 24, '!S.startsWith(path, \'/\')');
function visit631_412_1(result) {
  _$jscoverage['/uri.js'].branchData['412'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['409'][1].init(82, 4, 'path');
function visit630_409_1(result) {
  _$jscoverage['/uri.js'].branchData['409'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['405'][1].init(107, 8, 'override');
function visit629_405_1(result) {
  _$jscoverage['/uri.js'].branchData['405'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['403'][1].init(21, 12, 'o === \'path\'');
function visit628_403_1(result) {
  _$jscoverage['/uri.js'].branchData['403'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['392'][1].init(18, 31, 'typeof relativeUri === \'string\'');
function visit627_392_1(result) {
  _$jscoverage['/uri.js'].branchData['392'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['339'][1].init(42, 15, 'key === \'query\'');
function visit626_339_1(result) {
  _$jscoverage['/uri.js'].branchData['339'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['338'][1].init(17, 7, 'v || \'\'');
function visit625_338_1(result) {
...
function visit624_291_1(result) {
  _$jscoverage['/uri.js'].branchData['291'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['267'][1].init(16, 41, 'str1.toLowerCase() === str2.toLowerCase()');
function visit623_267_1(result) {
  _$jscoverage['/uri.js'].branchData['267'][1].ranCondition(result);
  return result;
}_$jscoverage['/uri.js'].branchData['263'][1].init(16, 16, 'str.length === 1');
function visit622_263_1(result) {
...
function visit621_240_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit610_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit611_90_1(query || '');
  }
  ...
  self._query = visit612_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit613_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit616_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit617_192_1(key instanceof Query)) {
  ...
  if (visit619_229_1(typeof key === 'string')) {
    ...
    if (visit620_233_1(currentValue === undefined)) {
    ...
    if (visit621_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit624_291_1(uriStr instanceof Uri)) {
  ...
  _$jscoverage['/uri.js'].lineData[392]++;
  if (visit627_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit628_403_1(o === 'path')) {
    ...
    if (visit635_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit636_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit637_433_1(override || relativeUri[o])) {
  ...
  _$jscoverage['/uri.js'].lineData[447]++;
  return this.scheme;
}, 
  setScheme: function(scheme) {
  _$jscoverage['/uri.js'].functionData[25]++;
  _$jscoverage['/uri.js'].lineData[456]++;
  this.scheme = scheme;
  ...
  _$jscoverage['/uri.js'].lineData[465]++;
  return this.hostname;
}, 
  setHostname: function(hostname) {
  _$jscoverage['/uri.js'].functionData[27]++;
  _$jscoverage['/uri.js'].lineData[474]++;
  ...
  _$jscoverage['/uri.js'].lineData[484]++;
  ...
  _$jscoverage['/uri.js'].lineData[493]++;
  return this.userInfo;
}, 
  setPort: function(port) {
  _$jscoverage['/uri.js'].functionData[30]++;
  _$jscoverage['/uri.js'].lineData[502]++;
  this.port = port;
  ...
  _$jscoverage['/uri.js'].lineData[511]++;
  return this.port;
}, 
  setPath: function(path) {
  _$jscoverage['/uri.js'].functionData[32]++;
  _$jscoverage['/uri.js'].lineData[520]++;
  this.path = path;
  ...
  _$jscoverage['/uri.js'].lineData[529]++;
  return this.path;
}, 
  setQuery: function(query) {
  _$jscoverage['/uri.js'].functionData[34]++;
  _$jscoverage['/uri.js'].lineData[538]++;
  if (visit638_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit639_539_1(S.startsWith(query, '?'))) {
  ...
  _$jscoverage['/uri.js'].lineData[553]++;
  return this.query;
}, 
  getFragment: function() {
  _$jscoverage['/uri.js'].functionData[36]++;
  _$jscoverage['/uri.js'].lineData[561]++;
  return this.fragment;
}, 
  setFragment: function(fragment) {
  _$jscoverage['/uri.js'].functionData[37]++;
  _$jscoverage['/uri.js'].lineData[570]++;
  var self = this;
  _$jscoverage['/uri.js'].lineData[571]++;
  if (visit640_571_1(S.startsWith(fragment, '#'))) {
  ...
  _$jscoverage['/uri.js'].lineData[584]++;
  var self = this;
  _$jscoverage['/uri.js'].lineData[586]++;
  return visit641_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit642_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  _$jscoverage['/uri.js'].functionData[39]++;
  _$jscoverage['/uri.js'].lineData[601]++;
  var out = [], self = this, scheme, hostname, path, port, fragment, query, userInfo;
  _$jscoverage['/uri.js'].lineData[611]++;
  ...
  if ((path = self.path)) {
    ...
    if (visit643_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit644_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit645_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
