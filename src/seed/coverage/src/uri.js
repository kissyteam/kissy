...
function visit627_634_1(result) {
...
function visit626_589_1(result) {
...
function visit624_573_1(result) {
...
function visit623_541_1(result) {
...
function visit621_435_1(result) {
...
function visit620_431_1(result) {
...
function visit616_415_1(result) {
...
function visit608_292_1(result) {
...
function visit605_241_1(result) {
...
function visit604_234_1(result) {
...
function visit601_193_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit594_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit595_90_1(query || '');
  }
  ...
  self._query = visit596_112_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit597_130_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit600_190_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[191]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[193]++;
    if (visit601_193_1(key instanceof Query)) {
  ...
  if (visit603_230_1(typeof key === 'string')) {
    ...
    if (visit604_234_1(currentValue === undefined)) {
    ...
    if (visit605_241_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit608_292_1(uriStr instanceof Uri)) {
  ...
  if (visit611_394_1(typeof relativeUri === 'string')) {
  ...
  if (visit612_405_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[407]++;
    if (visit613_407_1(override)) {
    ...
    if (visit619_430_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[431]++;
      if (visit620_431_1(override || relativeUri.query.toString())) {
      ...
      if (visit621_435_1(override || relativeUri[o])) {
  ...
  if (visit622_540_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[541]++;
    if (visit623_541_1(S.startsWith(query, '?'))) {
  ...
  if (visit624_573_1(S.startsWith(fragment, '#'))) {
  ...
  return visit625_588_1(equalsIgnoreCase(self.hostname, other.hostname) && visit626_589_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit627_634_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit628_658_1(url || '');
  _$jscoverage['/uri.js'].lineData[659]++;
  var m = visit629_659_1(url.match(URI_SPLIT_REG) || []), ret = {};
