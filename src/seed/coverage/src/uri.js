...
function visit655_632_1(result) {
...
function visit654_587_1(result) {
...
function visit653_586_1(result) {
...
function visit652_571_1(result) {
...
function visit651_539_1(result) {
...
function visit650_538_1(result) {
...
function visit649_433_1(result) {
...
function visit644_413_1(result) {
...
function visit636_291_1(result) {
...
function visit633_240_1(result) {
...
function visit632_233_1(result) {
...
function visit629_192_1(result) {
...
(function(S, undefined) {
  ...
  function parseQuery(self) {
    ...
    if (visit622_79_1(!self._queryMap)) {
  ...
  function Query(query) {
    ...
    this._query = visit623_90_1(query || '');
  }
  ...
  self._query = visit624_111_1(query || '');
  ...
  for (k in _queryMap) {
    ...
    if (visit625_129_1(S.isArray(_queryMap[k]))) {
  ...
  if (visit628_189_1(typeof key === 'string')) {
    _$jscoverage['/uri.js'].lineData[190]++;
    self._queryMap[key] = value;
  } else {
    _$jscoverage['/uri.js'].lineData[192]++;
    if (visit629_192_1(key instanceof Query)) {
  ...
  if (visit631_229_1(typeof key === 'string')) {
    ...
    if (visit632_233_1(currentValue === undefined)) {
    ...
    if (visit633_240_1(key instanceof Query)) {
  ...
  function Uri(uriStr) {
    ...
    if (visit636_291_1(uriStr instanceof Uri)) {
  ...
  if (visit639_392_1(typeof relativeUri === 'string')) {
  ...
  if (visit640_403_1(o === 'path')) {
    _$jscoverage['/uri.js'].lineData[405]++;
    if (visit641_405_1(override)) {
    ...
    if (visit647_428_1(o === 'query')) {
      _$jscoverage['/uri.js'].lineData[429]++;
      if (visit648_429_1(override || relativeUri.query.toString())) {
      ...
      if (visit649_433_1(override || relativeUri[o])) {
  ...
  if (visit650_538_1(typeof query === 'string')) {
    _$jscoverage['/uri.js'].lineData[539]++;
    if (visit651_539_1(S.startsWith(query, '?'))) {
  ...
  if (visit652_571_1(S.startsWith(fragment, '#'))) {
  ...
  return visit653_586_1(equalsIgnoreCase(self.hostname, other.hostname) && visit654_587_1(equalsIgnoreCase(self.scheme, other.scheme) && equalsIgnoreCase(self.port, other.port)));
}, 
  toString: function(serializeArray) {
  ...
  if ((path = self.path)) {
    ...
    if (visit655_632_1(hostname && !S.startsWith(path, '/'))) {
  ...
  url = visit656_656_1(url || '');
  _$jscoverage['/uri.js'].lineData[657]++;
  var m = visit657_657_1(url.match(URI_SPLIT_REG) || []), ret = {};
