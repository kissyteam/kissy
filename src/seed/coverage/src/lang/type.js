...
function visit308_177_1(result) {
...
function visit307_174_1(result) {
...
(function(S, undefined) {
  ...
  if (visit297_70_1(!obj || visit298_70_2(visit299_70_3(S.type(obj) !== 'object') || visit300_70_4(obj.nodeType || visit301_73_1(obj.window == obj))))) {
  ...
  try {
    ...
    if (visit302_81_1((objConstructor = obj.constructor) && visit303_81_2(!hasOwnProperty(obj, 'constructor') && !hasOwnProperty(objConstructor.prototype, 'isPrototypeOf')))) {
  ...
  return (visit304_95_1((visit305_95_2(key === undefined)) || hasOwnProperty(obj, key)));
}});
  _$jscoverage['/lang/type.js'].lineData[99]++;
  if (visit306_99_1('@DEBUG@')) {
  ...
  return visit307_174_1(S.type(o) === lc);
};
});
  _$jscoverage['/lang/type.js'].lineData[177]++;
  S.isArray = visit308_177_1(Array.isArray || S.isArray);
})(KISSY);
