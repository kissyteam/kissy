...
function visit120_332_1(result) {
...
function visit119_328_4(result) {
...
function visit118_328_3(result) {
...
function visit117_328_2(result) {
...
function visit116_328_1(result) {
...
function visit115_326_2(result) {
...
function visit114_326_1(result) {
...
function visit112_320_2(result) {
...
function visit111_320_1(result) {
...
function visit110_314_1(result) {
...
function visit108_298_1(result) {
...
function visit107_297_1(result) {
...
function visit106_296_2(result) {
...
function visit105_296_1(result) {
...
function visit104_293_1(result) {
...
function visit103_275_1(result) {
...
function visit102_274_1(result) {
...
function visit101_273_2(result) {
...
function visit100_273_1(result) {
...
(function(S, undefined) {
  ...
  if (visit62_29_1(object)) {
    _$jscoverage['/lang/array.js'].lineData[30]++;
    var key, val, keys, i = 0, length = visit63_34_1(object && object.length), isObj = visit64_36_1(visit65_36_2(length === undefined) || visit66_36_3(S.type(object) === 'function'));
    _$jscoverage['/lang/array.js'].lineData[38]++;
    context = visit67_38_1(context || null);
    _$jscoverage['/lang/array.js'].lineData[40]++;
    if (visit68_40_1(isObj)) {
      _$jscoverage['/lang/array.js'].lineData[41]++;
      keys = S.keys(object);
      _$jscoverage['/lang/array.js'].lineData[42]++;
      for (; visit69_42_1(i < keys.length); i++) {
        _$jscoverage['/lang/array.js'].lineData[43]++;
        key = keys[i];
        _$jscoverage['/lang/array.js'].lineData[45]++;
        if (visit70_45_1(fn.call(context, object[key], key, object) === FALSE)) {
      ...
      for (val = object[0]; visit71_51_1(i < length); val = object[++i]) {
        _$jscoverage['/lang/array.js'].lineData[52]++;
        if (visit72_52_1(fn.call(context, val, i, object) === FALSE)) {
  ...
  for (var i = 0, len = arr.length; visit73_74_1(i < len); ++i) {
    _$jscoverage['/lang/array.js'].lineData[75]++;
    if (visit74_75_1(arr[i] === item)) {
  ...
  for (var i = arr.length - 1; visit75_97_1(i >= 0); i--) {
    _$jscoverage['/lang/array.js'].lineData[98]++;
    if (visit76_98_1(arr[i] === item)) {
  ...
  if (visit83_166_1(fn.call(visit84_166_2(context || this), item, i, arr))) {
  ...
  return map.call(arr, fn, visit85_188_1(context || this));
} : function(arr, fn, context) {
  ...
  for (var i = 0; visit86_193_1(i < len); i++) {
    _$jscoverage['/lang/array.js'].lineData[194]++;
    var el = visit87_194_1(typeof arr === 'string') ? arr.charAt(i) : arr[i];
    _$jscoverage['/lang/array.js'].lineData[195]++;
    if (visit88_195_1(el || i in arr)) {
      _$jscoverage['/lang/array.js'].lineData[198]++;
      res[i] = fn.call(visit89_198_1(context || this), el, i, arr);
    }
  }
  ...
  if (visit90_219_1(typeof callback !== 'function')) {
    _$jscoverage['/lang/array.js'].lineData[220]++;
    throw new TypeError('callback is not function!');
  }
  _$jscoverage['/lang/array.js'].lineData[224]++;
  if (visit91_224_1(visit92_224_2(len === 0) && visit93_224_3(arguments.length === 2))) {
  ...
  if (visit94_230_1(arguments.length >= 3)) {
  ...
  while (visit97_249_1(k < len)) {
    _$jscoverage['/lang/array.js'].lineData[250]++;
    if (visit98_250_1(k in arr)) {
  ...
  return every.call(arr, fn, visit99_270_1(context || this));
} : function(arr, fn, context) {
  _$jscoverage['/lang/array.js'].functionData[15]++;
  _$jscoverage['/lang/array.js'].lineData[273]++;
  var len = visit100_273_1(visit101_273_2(arr && arr.length) || 0);
  _$jscoverage['/lang/array.js'].lineData[274]++;
  for (var i = 0; visit102_274_1(i < len); i++) {
    _$jscoverage['/lang/array.js'].lineData[275]++;
    if (visit103_275_1(i in arr && !fn.call(context, arr[i], i, arr))) {
  ...
  return some.call(arr, fn, visit104_293_1(context || this));
} : function(arr, fn, context) {
  _$jscoverage['/lang/array.js'].functionData[17]++;
  _$jscoverage['/lang/array.js'].lineData[296]++;
  var len = visit105_296_1(visit106_296_2(arr && arr.length) || 0);
  _$jscoverage['/lang/array.js'].lineData[297]++;
  for (var i = 0; visit107_297_1(i < len); i++) {
    _$jscoverage['/lang/array.js'].lineData[298]++;
    if (visit108_298_1(i in arr && fn.call(context, arr[i], i, arr))) {
  ...
  if (visit111_320_1(visit112_320_2(lengthType !== 'number') || visit113_325_1(o.alert || visit114_326_1(visit115_326_2(oType === 'string') || (visit116_328_1(visit117_328_2(oType === 'function') && !(visit118_328_3('item' in o && visit119_328_4(lengthType === 'number'))))))))) {
  ...
  for (var i = 0, l = o.length; visit120_332_1(i < l); i++) {
