...
function visit171_172_1(result) {
...
function visit170_168_1(result) {
...
function visit169_161_1(result) {
...
function visit168_159_1(result) {
...
function visit165_141_1(result) {
...
function visit164_133_1(result) {
...
function visit163_131_1(result) {
...
(function(S, undefined) {
  ...
  return fn.apply(this instanceof FNOP ? this : visit157_20_1(obj || this), (r ? inArgs.concat(args) : args.concat(inArgs)));
};
  ...
  if (visit161_110_1(this.interval)) {
  ...
  ms = visit162_129_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[131]++;
  if (visit163_131_1(ms === -1)) {
  ...
  fn.apply(visit164_133_1(context || this), arguments);
};
  }
  ...
  ms = visit167_157_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[159]++;
  if (visit168_159_1(ms === -1)) {
  ...
  fn.apply(visit169_161_1(context || this), arguments);
};
  }
  ...
  function f() {
    ...
    bufferTimer = S.later(fn, ms, 0, visit170_168_1(context || this), arguments);
  }
