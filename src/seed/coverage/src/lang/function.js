...
function visit168_173_1(result) {
...
function visit167_169_1(result) {
...
function visit166_162_1(result) {
...
function visit164_158_1(result) {
...
function visit163_144_1(result) {
...
function visit162_142_1(result) {
...
function visit161_134_1(result) {
...
function visit160_132_1(result) {
...
function visit159_130_1(result) {
...
function visit158_110_1(result) {
...
(function(S, undefined) {
  ...
  return fn.apply(this instanceof FNOP ? this : visit154_20_1(obj || this), (r ? inArgs.concat(args) : args.concat(inArgs)));
};
  ...
  if (visit158_110_1(this.interval)) {
  ...
  ms = visit159_130_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[132]++;
  if (visit160_132_1(ms === -1)) {
  ...
  fn.apply(visit161_134_1(context || this), arguments);
};
  }
  ...
  ms = visit164_158_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[160]++;
  if (visit165_160_1(ms === -1)) {
  ...
  fn.apply(visit166_162_1(context || this), arguments);
};
  }
  ...
  function f() {
    ...
    bufferTimer = S.later(fn, ms, 0, visit167_169_1(context || this), arguments);
  }
