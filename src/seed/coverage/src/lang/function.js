...
function visit120_172_1(result) {
...
function visit119_168_1(result) {
...
function visit118_161_1(result) {
...
function visit117_159_1(result) {
...
function visit116_157_1(result) {
...
function visit115_143_1(result) {
...
function visit114_141_1(result) {
...
function visit113_133_1(result) {
...
function visit111_129_1(result) {
...
(function(S, undefined) {
  ...
  return fn.apply(this instanceof FNOP ? this : visit106_20_1(obj || this), (r ? inArgs.concat(args) : args.concat(inArgs)));
};
  ...
  if (visit110_110_1(this.interval)) {
  ...
  ms = visit111_129_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[131]++;
  if (visit112_131_1(ms === -1)) {
  ...
  fn.apply(visit113_133_1(context || this), arguments);
};
  }
  ...
  ms = visit116_157_1(ms || 150);
  _$jscoverage['/lang/function.js'].lineData[159]++;
  if (visit117_159_1(ms === -1)) {
  ...
  fn.apply(visit118_161_1(context || this), arguments);
};
  }
  ...
  function f() {
    ...
    bufferTimer = S.later(fn, ms, 0, visit119_168_1(context || this), arguments);
  }
