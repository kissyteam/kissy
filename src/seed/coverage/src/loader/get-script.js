...
function visit443_161_1(result) {
...
function visit442_158_1(result) {
...
function visit441_153_1(result) {
...
function visit440_145_1(result) {
...
function visit439_137_1(result) {
...
function visit438_130_1(result) {
...
function visit437_129_2(result) {
...
function visit436_129_1(result) {
...
function visit435_128_1(result) {
...
function visit434_122_2(result) {
...
function visit433_122_1(result) {
...
function visit432_120_3(result) {
...
function visit431_120_2(result) {
...
function visit429_107_1(result) {
...
(function(S) {
  ...
  if (visit421_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit422_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit423_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit424_70_1(callbacks.length > 1)) {
  ...
  if (visit429_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit430_120_1(S.Config['forceCssPoll'] || (visit431_120_2(UA.webkit && visit432_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit433_122_1(css && visit434_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit435_128_1(!readyState || visit436_129_1(visit437_129_2(readyState == "loaded") || visit438_130_1(readyState == "complete")))) {
