...
if (! _$jscoverage['/loader/get-script.js'].branchData) {
  ...
  _$jscoverage['/loader/get-script.js'].branchData['143'] = [];
  _$jscoverage['/loader/get-script.js'].branchData['143'][1] = new BranchData();
...
_$jscoverage['/loader/get-script.js'].branchData['160'][1].init(3301, 3, 'css');
function visit446_160_1(result) {
  _$jscoverage['/loader/get-script.js'].branchData['160'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/get-script.js'].branchData['157'][1].init(3226, 9, '!headNode');
function visit445_157_1(result) {
  _$jscoverage['/loader/get-script.js'].branchData['157'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/get-script.js'].branchData['152'][1].init(3077, 7, 'timeout');
function visit444_152_1(result) {
  _$jscoverage['/loader/get-script.js'].branchData['152'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/get-script.js'].branchData['143'][1].init(2857, 3, 'css');
function visit443_143_1(result) {
  _$jscoverage['/loader/get-script.js'].branchData['143'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/get-script.js'].branchData['137'][1].init(2673, 9, 'useNative');
function visit442_137_1(result) {
...
function visit441_130_1(result) {
...
function visit440_129_2(result) {
...
function visit439_129_1(result) {
...
function visit438_128_1(result) {
...
function visit437_122_2(result) {
...
function visit436_122_1(result) {
...
function visit435_120_3(result) {
...
function visit434_120_2(result) {
...
function visit433_120_1(result) {
...
(function(S) {
  ...
  if (visit425_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit426_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit427_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit428_70_1(callbacks.length > 1)) {
  ...
  var forceCssPoll = visit433_120_1(S.Config.forceCssPoll || (visit434_120_2(UA.webkit && visit435_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit436_122_1(css && visit437_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit438_128_1(!readyState || visit439_129_1(visit440_129_2(readyState === 'loaded') || visit441_130_1(readyState === 'complete')))) {
