...
function visit436_161_1(result) {
...
function visit434_153_1(result) {
...
function visit433_145_1(result) {
...
function visit432_137_1(result) {
...
function visit431_130_1(result) {
...
function visit430_129_2(result) {
...
function visit429_129_1(result) {
...
function visit428_128_1(result) {
...
function visit427_122_2(result) {
...
function visit426_122_1(result) {
...
function visit425_120_3(result) {
...
function visit424_120_2(result) {
...
function visit423_120_1(result) {
...
function visit422_107_1(result) {
...
(function(S) {
  ...
  if (visit414_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit415_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit416_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit417_70_1(callbacks.length > 1)) {
  ...
  if (visit422_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit423_120_1(S.Config['forceCssPoll'] || (visit424_120_2(UA.webkit && visit425_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit426_122_1(css && visit427_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit428_128_1(!readyState || visit429_129_1(visit430_129_2(readyState == "loaded") || visit431_130_1(readyState == "complete")))) {
