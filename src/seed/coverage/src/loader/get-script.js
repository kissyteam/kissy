...
function visit438_161_1(result) {
...
function visit437_158_1(result) {
...
function visit436_153_1(result) {
...
function visit435_145_1(result) {
...
function visit434_137_1(result) {
...
function visit433_130_1(result) {
...
function visit432_129_2(result) {
...
function visit431_129_1(result) {
...
function visit430_128_1(result) {
...
function visit429_122_2(result) {
...
function visit428_122_1(result) {
...
function visit427_120_3(result) {
...
function visit426_120_2(result) {
...
function visit425_120_1(result) {
...
function visit424_107_1(result) {
...
(function(S) {
  ...
  if (visit416_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit417_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit418_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit419_70_1(callbacks.length > 1)) {
  ...
  if (visit424_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit425_120_1(S.Config['forceCssPoll'] || (visit426_120_2(UA.webkit && visit427_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit428_122_1(css && visit429_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit430_128_1(!readyState || visit431_129_1(visit432_129_2(readyState == "loaded") || visit433_130_1(readyState == "complete")))) {
