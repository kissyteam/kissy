...
function visit435_161_1(result) {
...
function visit434_158_1(result) {
...
function visit433_153_1(result) {
...
function visit431_137_1(result) {
...
function visit430_130_1(result) {
...
function visit429_129_2(result) {
...
function visit428_129_1(result) {
...
function visit427_128_1(result) {
...
function visit426_122_2(result) {
...
function visit425_122_1(result) {
...
function visit424_120_3(result) {
...
function visit423_120_2(result) {
...
function visit422_120_1(result) {
...
function visit421_107_1(result) {
...
(function(S) {
  ...
  if (visit413_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit414_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit415_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit416_70_1(callbacks.length > 1)) {
  ...
  if (visit421_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit422_120_1(S.Config['forceCssPoll'] || (visit423_120_2(UA.webkit && visit424_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit425_122_1(css && visit426_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit427_128_1(!readyState || visit428_129_1(visit429_129_2(readyState == "loaded") || visit430_130_1(readyState == "complete")))) {
