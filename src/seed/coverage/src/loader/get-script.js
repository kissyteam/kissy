...
function visit441_161_1(result) {
...
function visit440_158_1(result) {
...
function visit439_153_1(result) {
...
function visit438_145_1(result) {
...
function visit437_137_1(result) {
...
function visit436_130_1(result) {
...
function visit435_129_2(result) {
...
function visit434_129_1(result) {
...
function visit433_128_1(result) {
...
function visit432_122_2(result) {
...
function visit431_122_1(result) {
...
function visit430_120_3(result) {
...
function visit429_120_2(result) {
...
function visit428_120_1(result) {
...
function visit427_107_1(result) {
...
(function(S) {
  ...
  if (visit419_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit420_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit421_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit422_70_1(callbacks.length > 1)) {
  ...
  if (visit427_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit428_120_1(S.Config['forceCssPoll'] || (visit429_120_2(UA.webkit && visit430_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit431_122_1(css && visit432_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit433_128_1(!readyState || visit434_129_1(visit435_129_2(readyState == "loaded") || visit436_130_1(readyState == "complete")))) {
