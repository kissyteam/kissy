...
function visit440_161_1(result) {
...
function visit439_158_1(result) {
...
function visit438_153_1(result) {
...
function visit437_145_1(result) {
...
function visit436_137_1(result) {
...
function visit435_130_1(result) {
...
function visit434_129_2(result) {
...
function visit433_129_1(result) {
...
function visit432_128_1(result) {
...
function visit431_122_2(result) {
...
function visit430_122_1(result) {
...
function visit429_120_3(result) {
...
function visit428_120_2(result) {
...
function visit427_120_1(result) {
...
function visit426_107_1(result) {
...
(function(S) {
  ...
  if (visit418_54_1(S.startsWith(Path.extname(url).toLowerCase(), '.css'))) {
    _$jscoverage['/loader/get-script.js'].lineData[55]++;
    css = 1;
  }
  _$jscoverage['/loader/get-script.js'].lineData[58]++;
  if (visit419_58_1(S.isPlainObject(config))) {
  ...
  callbacks = jsCssCallbacks[url] = visit420_66_1(jsCssCallbacks[url] || []);
  _$jscoverage['/loader/get-script.js'].lineData[68]++;
  callbacks.push([success, error]);
  _$jscoverage['/loader/get-script.js'].lineData[70]++;
  if (visit421_70_1(callbacks.length > 1)) {
  ...
  if (visit426_107_1(fn = callback[index])) {
  ...
  var forceCssPoll = visit427_120_1(S.Config['forceCssPoll'] || (visit428_120_2(UA.webkit && visit429_120_3(UA.webkit < 536))));
  _$jscoverage['/loader/get-script.js'].lineData[122]++;
  if (visit430_122_1(css && visit431_122_2(forceCssPoll && useNative))) {
  ...
  function onload() {
    ...
    if (visit432_128_1(!readyState || visit433_129_1(visit434_129_2(readyState == "loaded") || visit435_130_1(readyState == "complete")))) {
