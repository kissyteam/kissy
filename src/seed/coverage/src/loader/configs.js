...
function visit376_91_1(result) {
  _$jscoverage['/loader/configs.js'].branchData['91'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/configs.js'].branchData['86'][1].init(161, 17, 'simulatedLocation');
function visit375_86_1(result) {
  _$jscoverage['/loader/configs.js'].branchData['86'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/configs.js'].branchData['83'][1].init(75, 35, 'base.charAt(base.length - 1) != \'/\'');
function visit374_83_1(result) {
...
function visit373_71_1(result) {
  _$jscoverage['/loader/configs.js'].branchData['71'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/configs.js'].branchData['60'][1].init(137, 32, 'mod.status == Loader.Status.INIT');
function visit372_60_1(result) {
...
(function(S, undefined) {
  ...
  if (visit363_15_1(!S.UA.nodejs && visit364_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit365_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit366_27_1(config)) {
  ...
  name = visit367_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit368_32_1(cfg.base || cfg.path));
  ...
  if (visit372_60_1(mod.status == Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit375_86_1(simulatedLocation)) {
      ...
      if (visit376_91_1(!S.startsWith(base, 'file:'))) {
