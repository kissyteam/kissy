...
(function(S, undefined) {
  ...
  if (visit358_15_1(!S.UA.nodejs && visit359_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit360_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit361_27_1(config)) {
  ...
  name = visit362_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit363_32_1(cfg.base || cfg.path));
  ...
  if (visit367_60_1(mod.status === Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit370_86_1(simulatedLocation)) {
      ...
      if (visit371_91_1(!S.startsWith(base, 'file:'))) {
