...
(function(S, undefined) {
  ...
  if (visit361_15_1(!S.UA.nodejs && visit362_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit363_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit364_27_1(config)) {
  ...
  name = visit365_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit366_32_1(cfg.base || cfg.path));
  ...
  if (visit370_60_1(mod.status == Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit373_86_1(simulatedLocation)) {
      ...
      if (visit374_91_1(!S.startsWith(base, 'file:'))) {
