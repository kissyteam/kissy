...
(function(S, undefined) {
  ...
  if (visit366_15_1(!S.UA.nodejs && visit367_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit368_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit369_27_1(config)) {
  ...
  name = visit370_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit371_32_1(cfg.base || cfg.path));
  ...
  if (visit375_60_1(mod.status === Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit378_86_1(simulatedLocation)) {
      ...
      if (visit379_91_1(!S.startsWith(base, 'file:'))) {
