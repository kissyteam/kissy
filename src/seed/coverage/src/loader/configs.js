...
(function(S, undefined) {
  ...
  if (visit365_15_1(!S.UA.nodejs && visit366_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit367_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit368_27_1(config)) {
  ...
  name = visit369_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit370_32_1(cfg.base || cfg.path));
  ...
  if (visit374_60_1(mod.status == Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit377_86_1(simulatedLocation)) {
      ...
      if (visit378_91_1(!S.startsWith(base, 'file:'))) {
