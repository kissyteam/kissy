...
(function(S, undefined) {
  ...
  if (visit364_15_1(!S.UA.nodejs && visit365_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit366_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit367_27_1(config)) {
  ...
  name = visit368_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit369_32_1(cfg.base || cfg.path));
  ...
  if (visit373_60_1(mod.status === Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit376_86_1(simulatedLocation)) {
      ...
      if (visit377_91_1(!S.startsWith(base, 'file:'))) {
