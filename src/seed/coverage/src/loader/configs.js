...
(function(S, undefined) {
  ...
  if (visit367_15_1(!S.UA.nodejs && visit368_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit369_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit370_27_1(config)) {
  ...
  name = visit371_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit372_32_1(cfg.base || cfg.path));
  ...
  if (visit376_60_1(mod.status === Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit379_86_1(simulatedLocation)) {
      ...
      if (visit380_91_1(!S.startsWith(base, 'file:'))) {
