...
(function(S, undefined) {
  ...
  if (visit362_15_1(!S.UA.nodejs && visit363_15_2(location && (locationHref = location.href)))) {
  ...
  var name, Config = this.Config, ps = Config.packages = visit364_26_1(Config.packages || {});
  _$jscoverage['/loader/configs.js'].lineData[27]++;
  if (visit365_27_1(config)) {
  ...
  name = visit366_30_1(cfg.name || key);
  _$jscoverage['/loader/configs.js'].lineData[32]++;
  var baseUri = normalizeBase(visit367_32_1(cfg.base || cfg.path));
  ...
  if (visit371_60_1(mod.status == Loader.Status.INIT)) {
  ...
  function normalizeBase(base) {
    ...
    if (visit374_86_1(simulatedLocation)) {
      ...
      if (visit375_91_1(!S.startsWith(base, 'file:'))) {
