...
_$jscoverage['/loader/init.js'].branchData['122'][1].init(3506, 31, 'doc && doc.getElementsByTagName');
function visit457_122_1(result) {
  _$jscoverage['/loader/init.js'].branchData['122'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/init.js'].branchData['113'][1].init(3219, 11, 'S.UA.nodejs');
