...
_$jscoverage['/loader/init.js'].branchData['105'][1].init(2961, 24, 'doc.getElementsByTagName');
function visit446_105_1(result) {
  _$jscoverage['/loader/init.js'].branchData['105'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/init.js'].branchData['97'][1].init(2699, 11, 'S.UA.nodejs');
...
(function(S) {
  ...
  base: __dirname.replace(/\\/g, '/').replace(/\/$/, '') + '/'});
    ...
    if (visit446_105_1(doc.getElementsByTagName)) {
