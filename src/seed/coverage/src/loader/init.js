...
function visit455_123_1(result) {
...
(function(S) {
  ...
  function getBaseInfoFromOneScript(script) {
    ...
    var src = visit442_24_1(script.src || '');
    _$jscoverage['/loader/init.js'].lineData[25]++;
    if (visit443_25_1(!src.match(baseTestReg))) {
    ...
    var comboPrefix = visit445_37_1(baseInfo.comboPrefix || defaultComboPrefix);
    _$jscoverage['/loader/init.js'].lineData[38]++;
    var comboSep = visit446_38_1(baseInfo.comboSep || defaultComboSep);
    ...
    if (visit447_45_1(index === -1)) {
      ...
      if (visit448_51_1(base.charAt(base.length - 1) !== '/')) {
  ...
  if (visit449_56_1(part.match(baseTestReg))) {
  ...
  return undefined;
    ...
    baseInfo.base = visit452_73_1(baseInfo.base || base);
  ...
  function getBaseInfo() {
    ...
    for (i = scripts.length - 1; visit453_96_1(i >= 0); i--) {
  ...
  base: __dirname.replace(/\\/g, '/').replace(/\/$/, '') + '/'});
    ...
    if (visit455_123_1(doc && doc.getElementsByTagName)) {
