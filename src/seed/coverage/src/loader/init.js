...
function visit452_106_1(result) {
...
(function(S) {
  ...
  var doc = visit441_6_1(S.Env.host && S.Env.host.document);
  ...
  function getBaseInfoFromOneScript(script) {
    ...
    var src = visit442_23_1(script.src || '');
    _$jscoverage['/loader/init.js'].lineData[24]++;
    if (visit443_24_1(!src.match(baseTestReg))) {
    ...
    var comboPrefix = visit445_36_1(baseInfo.comboPrefix || defaultComboPrefix);
    _$jscoverage['/loader/init.js'].lineData[37]++;
    var comboSep = visit446_37_1(baseInfo.comboSep || defaultComboSep);
    ...
    if (visit447_44_1(index == -1)) {
      ...
      if (visit448_50_1(base.charAt(base.length - 1) != '/')) {
  ...
  if (visit449_55_1(part.match(baseTestReg))) {
  ...
  function getBaseInfo() {
    ...
    for (i = scripts.length - 1; visit450_88_1(i >= 0); i--) {
      _$jscoverage['/loader/init.js'].lineData[89]++;
      if (visit451_89_1(info = getBaseInfoFromOneScript(scripts[i]))) {
  ...
  base: __dirname.replace(/\\/g, '/').replace(/\/$/, '') + '/'});
    ...
    if (visit453_114_1(doc && doc.getElementsByTagName)) {
