...
function visit460_113_1(result) {
...
(function(S) {
  ...
  var doc = visit447_6_1(S.Env.host && S.Env.host.document);
  ...
  function getBaseInfoFromOneScript(script) {
    ...
    var src = visit448_24_1(script.src || '');
    _$jscoverage['/loader/init.js'].lineData[25]++;
    if (visit449_25_1(!src.match(baseTestReg))) {
    ...
    var comboPrefix = visit451_37_1(baseInfo.comboPrefix || defaultComboPrefix);
    _$jscoverage['/loader/init.js'].lineData[38]++;
    var comboSep = visit452_38_1(baseInfo.comboSep || defaultComboSep);
    ...
    if (visit453_45_1(index === -1)) {
      ...
      if (visit454_51_1(base.charAt(base.length - 1) !== '/')) {
  ...
  if (visit455_56_1(part.match(baseTestReg))) {
  ...
  return undefined;
    ...
    baseInfo.base = visit458_73_1(baseInfo.base || base);
  ...
  function getBaseInfo() {
    ...
    for (i = scripts.length - 1; visit459_96_1(i >= 0); i--) {
  ...
  base: __dirname.replace(/\\/g, '/').replace(/\/$/, '') + '/'});
    ...
    if (visit461_122_1(doc && doc.getElementsByTagName)) {
