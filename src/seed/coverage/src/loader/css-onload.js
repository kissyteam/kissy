...
(function(S) {
  ...
  function isCssLoaded(node, url) {
    ...
    if (visit382_26_1(UA.webkit)) {
      _$jscoverage['/loader/css-onload.js'].lineData[28]++;
      if (visit383_28_1(node['sheet'])) {
  ...
  if (visit386_45_1(exName == 'NS_ERROR_DOM_SECURITY_ERR')) {
  ...
  function cssPoll() {
    ...
    for (var url in monitors) {
      ...
      if (visit387_59_1(isCssLoaded(node, url))) {
        _$jscoverage['/loader/css-onload.js'].lineData[60]++;
        if (visit388_60_1(callbackObj.callback)) {
    ...
    if (visit389_67_1(S.isEmptyObject(monitors))) {
