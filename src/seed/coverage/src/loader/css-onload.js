...
(function(S) {
  ...
  function isCssLoaded(node, url) {
    ...
    if (visit394_26_1(UA.webkit)) {
      _$jscoverage['/loader/css-onload.js'].lineData[28]++;
      if (visit395_28_1(node.sheet)) {
  ...
  if (visit398_45_1(exName === 'NS_ERROR_DOM_SECURITY_ERR')) {
  ...
  function cssPoll() {
    ...
    for (var url in monitors) {
      ...
      if (visit399_59_1(isCssLoaded(node, url))) {
        _$jscoverage['/loader/css-onload.js'].lineData[60]++;
        if (visit400_60_1(callbackObj.callback)) {
    ...
    if (visit401_67_1(S.isEmptyObject(monitors))) {
