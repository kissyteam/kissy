...
(function(S) {
  ...
  function isCssLoaded(node, url) {
    ...
    if (visit373_26_1(UA.webkit)) {
      _$jscoverage['/loader/css-onload.js'].lineData[28]++;
      if (visit374_28_1(node['sheet'])) {
  ...
  if (visit377_45_1(exName == 'NS_ERROR_DOM_SECURITY_ERR')) {
  ...
  function cssPoll() {
    ...
    for (var url in monitors) {
      ...
      if (visit378_59_1(isCssLoaded(node, url))) {
        _$jscoverage['/loader/css-onload.js'].lineData[60]++;
        if (visit379_60_1(callbackObj.callback)) {
    ...
    if (visit380_67_1(S.isEmptyObject(monitors))) {
