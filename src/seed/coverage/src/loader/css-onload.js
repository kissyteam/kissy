...
(function(S) {
  ...
  function isCssLoaded(node, url) {
    ...
    if (visit385_26_1(UA.webkit)) {
      _$jscoverage['/loader/css-onload.js'].lineData[28]++;
      if (visit386_28_1(node.sheet)) {
  ...
  if (visit389_45_1(exName === 'NS_ERROR_DOM_SECURITY_ERR')) {
  ...
  function cssPoll() {
    ...
    for (var url in monitors) {
      ...
      if (visit390_59_1(isCssLoaded(node, url))) {
        _$jscoverage['/loader/css-onload.js'].lineData[60]++;
        if (visit391_60_1(callbackObj.callback)) {
    ...
    if (visit392_67_1(S.isEmptyObject(monitors))) {
