...
_$jscoverage['/loader/utils.js'].branchData['426'][2].init(62, 21, 'mod.status !== status');
function visit505_426_2(result) {
  _$jscoverage['/loader/utils.js'].branchData['426'][2].ranCondition(result);
  return result;
}_$jscoverage['/loader/utils.js'].branchData['426'][1].init(54, 29, '!mod || mod.status !== status');
function visit504_426_1(result) {
  _$jscoverage['/loader/utils.js'].branchData['426'][1].ranCondition(result);
  return result;
}_$jscoverage['/loader/utils.js'].branchData['424'][1].init(132, 19, 'i < modNames.length');
