...
function visit415_373_1(result) {
...
function visit414_369_2(result) {
...
function visit413_369_1(result) {
...
function visit412_351_1(result) {
...
function visit411_332_1(result) {
...
function visit410_330_1(result) {
...
function visit408_328_2(result) {
...
function visit407_328_1(result) {
...
function visit406_311_1(result) {
...
function visit404_309_2(result) {
...
function visit402_290_1(result) {
...
function visit401_281_1(result) {
...
function visit400_270_1(result) {
...
function visit399_244_1(result) {
...
function visit396_208_1(result) {
...
function visit395_201_1(result) {
...
function visit394_200_1(result) {
...
function visit393_178_1(result) {
...
function visit392_177_1(result) {
...
function visit391_149_1(result) {
...
(function(S) {
  ...
  return self.getBase() + (visit389_61_1(packageName && !self.isIgnorePackageNameInUri()) ? (packageName + '/') : '');
}, 
  ...
  if (visit390_72_1(self.packageUri)) {
  ...
  if (visit392_177_1(!v)) {
    ...
    if (visit393_178_1(Path.extname(self.name).toLowerCase() == '.css')) {
  ...
  if (visit394_200_1(!self.fullPathUri)) {
    _$jscoverage['/loader/data-structure.js'].lineData[201]++;
    if (visit395_201_1(self.fullpath)) {
      ...
      if (visit396_208_1(packageInfo.isIgnorePackageNameInUri() && (packageName = packageInfo.getName()))) {
      ...
      if (visit397_214_1(t = self.getTag())) {
  ...
  if (visit398_231_1(!self.fullpath)) {
  ...
  return visit399_244_1(self.path || (self.path = defaultComponentJsName(self)));
}, 
  getValue: function() {
  ...
  return visit400_270_1(self.packageInfo || (self.packageInfo = getPackage(self.runtime, self.name)));
}, 
  getTag: function() {
  ...
  return visit401_281_1(self.tag || self.getPackage().getTag());
}, 
  getCharset: function() {
  ...
  return visit402_290_1(self.charset || self.getPackage().getCharset());
}, 
  ...
  if (visit403_309_1(!requires || visit404_309_2(requires.length == 0))) {
    _$jscoverage['/loader/data-structure.js'].lineData[310]++;
    return visit405_310_1(requires || []);
  } else {
    _$jscoverage['/loader/data-structure.js'].lineData[311]++;
    if (visit406_311_1(!requiresWithAlias)) {
  ...
  if (visit407_328_1(!requires || visit408_328_2(requires.length == 0))) {
    _$jscoverage['/loader/data-structure.js'].lineData[329]++;
    return visit409_329_1(requires || []);
  } else {
    _$jscoverage['/loader/data-structure.js'].lineData[330]++;
    if (visit410_330_1((normalizedRequires = self.normalizedRequires) && (visit411_332_1(normalizedRequiresStatus == status)))) {
  ...
  function defaultComponentJsName(m) {
    ...
    if (visit412_351_1(m.getPackage().isDebug())) {
  ...
  function getPackage(self, modName) {
    ...
    for (p in packages) {
      ...
      if (visit413_369_1(S.startsWith(modNameSlash, p + '/') && visit414_369_2(p.length > pName.length))) {
        _$jscoverage['/loader/data-structure.js'].lineData[370]++;
        pName = p;
      }
    }
    _$jscoverage['/loader/data-structure.js'].lineData[373]++;
    return visit415_373_1(packages[pName] || systemPackage);
  }
})(KISSY);
