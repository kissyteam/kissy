...
function visit395_263_1(result) {
...
function visit394_256_1(result) {
...
function visit392_232_1(result) {
...
(function(S) {
  ...
  return self.getBase() + (visit387_63_1(packageName && !self.isIgnorePackageNameInUri()) ? (packageName + '/') : '');
}, 
  ...
  if (visit388_74_1(!self.packageUri)) {
  ...
  S.log(visit390_214_1(e.stack || e), 'error');
  ...
  if (visit391_231_1(!v)) {
    ...
    if (visit392_232_1(Path.extname(self.name).toLowerCase() === '.css')) {
  ...
  if (visit393_254_1(!self.fullPathUri)) {
    _$jscoverage['/loader/data-structure.js'].lineData[256]++;
    if (visit394_256_1(self.fullpath)) {
      ...
      if (visit395_263_1(packageInfo.isIgnorePackageNameInUri() && (packageName = packageInfo.name))) {
