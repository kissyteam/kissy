...
function visit407_369_2(result) {
...
function visit406_369_1(result) {
...
function visit405_351_1(result) {
...
function visit404_332_1(result) {
...
function visit403_330_1(result) {
...
function visit401_328_2(result) {
...
function visit400_328_1(result) {
...
function visit399_311_1(result) {
...
function visit398_310_1(result) {
...
function visit397_309_2(result) {
...
function visit396_309_1(result) {
...
function visit395_290_1(result) {
...
function visit394_281_1(result) {
...
function visit393_270_1(result) {
...
function visit392_244_1(result) {
...
function visit391_231_1(result) {
...
function visit390_214_1(result) {
...
function visit389_208_1(result) {
...
function visit388_201_1(result) {
...
function visit387_200_1(result) {
...
function visit386_178_1(result) {
...
function visit385_177_1(result) {
...
function visit384_149_1(result) {
...
(function(S) {
  ...
  return self.getBase() + (visit382_61_1(packageName && !self.isIgnorePackageNameInUri()) ? (packageName + '/') : '');
}, 
  ...
  if (visit383_72_1(self.packageUri)) {
  ...
  if (visit385_177_1(!v)) {
    ...
    if (visit386_178_1(Path.extname(self.name).toLowerCase() == '.css')) {
  ...
  if (visit387_200_1(!self.fullPathUri)) {
    _$jscoverage['/loader/data-structure.js'].lineData[201]++;
    if (visit388_201_1(self.fullpath)) {
      ...
      if (visit389_208_1(packageInfo.isIgnorePackageNameInUri() && (packageName = packageInfo.getName()))) {
      ...
      if (visit390_214_1(t = self.getTag())) {
  ...
  if (visit391_231_1(!self.fullpath)) {
  ...
  return visit392_244_1(self.path || (self.path = defaultComponentJsName(self)));
}, 
  getValue: function() {
  ...
  return visit393_270_1(self.packageInfo || (self.packageInfo = getPackage(self.runtime, self.name)));
}, 
  getTag: function() {
  ...
  return visit394_281_1(self.tag || self.getPackage().getTag());
}, 
  getCharset: function() {
  ...
  return visit395_290_1(self.charset || self.getPackage().getCharset());
}, 
  ...
  if (visit396_309_1(!requires || visit397_309_2(requires.length == 0))) {
    _$jscoverage['/loader/data-structure.js'].lineData[310]++;
    return visit398_310_1(requires || []);
  } else {
    _$jscoverage['/loader/data-structure.js'].lineData[311]++;
    if (visit399_311_1(!requiresWithAlias)) {
  ...
  if (visit400_328_1(!requires || visit401_328_2(requires.length == 0))) {
    _$jscoverage['/loader/data-structure.js'].lineData[329]++;
    return visit402_329_1(requires || []);
  } else {
    _$jscoverage['/loader/data-structure.js'].lineData[330]++;
    if (visit403_330_1((normalizedRequires = self.normalizedRequires) && (visit404_332_1(normalizedRequiresStatus == status)))) {
  ...
  function defaultComponentJsName(m) {
    ...
    if (visit405_351_1(m.getPackage().isDebug())) {
  ...
  function getPackage(self, modName) {
    ...
    for (p in packages) {
      ...
      if (visit406_369_1(S.startsWith(modNameSlash, p + '/') && visit407_369_2(p.length > pName.length))) {
        _$jscoverage['/loader/data-structure.js'].lineData[370]++;
        pName = p;
      }
    }
    _$jscoverage['/loader/data-structure.js'].lineData[373]++;
    return visit408_373_1(packages[pName] || systemPackage);
  }
})(KISSY);
