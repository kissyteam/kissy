...
function visit397_263_1(result) {
...
function visit395_254_1(result) {
...
function visit394_232_1(result) {
...
function visit393_231_1(result) {
...
function visit392_214_1(result) {
...
function visit391_209_1(result) {
...
(function(S) {
  ...
  return self.getBase() + (visit389_63_1(packageName && !self.isIgnorePackageNameInUri()) ? (packageName + '/') : '');
}, 
  ...
  if (visit390_74_1(!self.packageUri)) {
  ...
  S.log(visit392_214_1(e.stack || e), 'error');
  ...
  if (visit393_231_1(!v)) {
    ...
    if (visit394_232_1(Path.extname(self.name).toLowerCase() === '.css')) {
  ...
  if (visit395_254_1(!self.fullPathUri)) {
    _$jscoverage['/loader/data-structure.js'].lineData[256]++;
    if (visit396_256_1(self.fullpath)) {
      ...
      if (visit397_263_1(packageInfo.isIgnorePackageNameInUri() && (packageName = packageInfo.name))) {
