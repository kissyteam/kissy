...
function visit683_207_1(result) {
...
function visit682_197_3(result) {
...
function visit681_197_2(result) {
...
function visit680_197_1(result) {
...
function visit678_175_1(result) {
...
function visit675_148_1(result) {
...
function visit674_139_2(result) {
...
function visit670_114_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, logger = S.getLogger('s/web'), UA = S.UA, doc = win['document'], docElem = visit659_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', readyDefer = new S.Defer(), readyPromise = readyDefer.promise, POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit660_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit661_45_1(visit662_45_2(obj != null) && visit663_45_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[55]++;
  if (visit664_55_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit665_61_1(win['DOMParser'])) {
  ...
  if (visit666_73_1(!xml || visit667_73_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit668_84_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[87]++;
    (visit669_87_1(win.execScript || function(data) {
  ...
  if (visit670_114_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    if (visit672_129_1(doc && !UA.nodejs)) {
  ...
  function bindReady() {
    ...
    if (visit673_139_1(!doc || visit674_139_2(doc.readyState === COMPLETE))) {
    ...
    if (visit675_148_1(standardEventModel)) {
  ...
  if (visit676_159_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit677_172_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[174]++;
      try {
        _$jscoverage['/web.js'].lineData[175]++;
        notframe = (visit678_175_1(win['frameElement'] === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[177]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[181]++;
      if (visit679_181_1(doScroll && notframe)) {
  ...
  if (visit680_197_1(location && visit681_197_2((visit682_197_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
