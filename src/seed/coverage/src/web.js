...
function visit675_238_1(result) {
...
function visit674_228_3(result) {
...
function visit673_228_2(result) {
...
function visit672_228_1(result) {
...
function visit671_212_1(result) {
...
function visit670_206_1(result) {
...
function visit669_203_1(result) {
...
function visit668_190_1(result) {
...
function visit667_181_1(result) {
...
function visit666_172_2(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, UA = S.UA, doc = win.document, docElem = visit646_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', domReady = 0, callbacks = [], POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit647_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit648_47_1(visit649_47_2(obj != null) && visit650_47_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[57]++;
  if (visit651_57_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit652_63_1(win.DOMParser)) {
  ...
  if (visit653_76_1(!xml || visit654_76_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit655_87_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[91]++;
    if (visit656_91_1(win.execScript)) {
  ...
  S.log(visit658_112_1(e.stack || e), 'error');
  ...
  if (visit659_133_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    for (var i = 0; visit663_155_1(i < callbacks.length); i++) {
  ...
  S.log(visit664_159_1(e.stack || e), 'error');
  ...
  function bindReady() {
    ...
    if (visit665_172_1(!doc || visit666_172_2(doc.readyState === COMPLETE))) {
    ...
    if (visit667_181_1(standardEventModel)) {
  ...
  if (visit668_190_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit669_203_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[205]++;
      try {
        _$jscoverage['/web.js'].lineData[206]++;
        notframe = (visit670_206_1(win.frameElement === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[208]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[212]++;
      if (visit671_212_1(doScroll && notframe)) {
  ...
  if (visit672_228_1(location && visit673_228_2((visit674_228_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
