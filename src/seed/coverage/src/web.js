...
function visit681_207_1(result) {
...
function visit680_197_3(result) {
...
function visit679_197_2(result) {
...
function visit678_197_1(result) {
...
function visit676_175_1(result) {
...
function visit673_148_1(result) {
...
function visit672_139_2(result) {
...
function visit668_114_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, logger = S.getLogger('s/web'), UA = S.UA, doc = win['document'], docElem = visit657_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', readyDefer = new S.Defer(), readyPromise = readyDefer.promise, POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit658_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit659_45_1(visit660_45_2(obj != null) && visit661_45_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[55]++;
  if (visit662_55_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit663_61_1(win['DOMParser'])) {
  ...
  if (visit664_73_1(!xml || visit665_73_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit666_84_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[87]++;
    (visit667_87_1(win.execScript || function(data) {
  ...
  if (visit668_114_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    if (visit670_129_1(doc && !UA.nodejs)) {
  ...
  function bindReady() {
    ...
    if (visit671_139_1(!doc || visit672_139_2(doc.readyState === COMPLETE))) {
    ...
    if (visit673_148_1(standardEventModel)) {
  ...
  if (visit674_159_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit675_172_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[174]++;
      try {
        _$jscoverage['/web.js'].lineData[175]++;
        notframe = (visit676_175_1(win['frameElement'] === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[177]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[181]++;
      if (visit677_181_1(doScroll && notframe)) {
  ...
  if (visit678_197_1(location && visit679_197_2((visit680_197_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
