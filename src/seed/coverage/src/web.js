...
function visit670_207_1(result) {
...
function visit669_197_3(result) {
...
function visit668_197_2(result) {
...
function visit667_197_1(result) {
...
function visit666_181_1(result) {
...
function visit665_175_1(result) {
...
function visit663_159_1(result) {
...
function visit662_148_1(result) {
...
function visit661_139_2(result) {
...
function visit657_114_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, logger = S.getLogger('s/web'), UA = S.UA, doc = win['document'], docElem = visit646_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', readyDefer = new S.Defer(), readyPromise = readyDefer.promise, POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit647_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit648_45_1(visit649_45_2(obj != null) && visit650_45_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[55]++;
  if (visit651_55_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit652_61_1(win['DOMParser'])) {
  ...
  if (visit653_73_1(!xml || visit654_73_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit655_84_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[87]++;
    (visit656_87_1(win.execScript || function(data) {
  ...
  if (visit657_114_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    if (visit659_129_1(doc && !UA.nodejs)) {
  ...
  function bindReady() {
    ...
    if (visit660_139_1(!doc || visit661_139_2(doc.readyState === COMPLETE))) {
    ...
    if (visit662_148_1(standardEventModel)) {
  ...
  if (visit663_159_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit664_172_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[174]++;
      try {
        _$jscoverage['/web.js'].lineData[175]++;
        notframe = (visit665_175_1(win['frameElement'] === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[177]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[181]++;
      if (visit666_181_1(doScroll && notframe)) {
  ...
  if (visit667_197_1(location && visit668_197_2((visit669_197_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
