...
function visit668_207_1(result) {
...
function visit667_197_3(result) {
...
function visit666_197_2(result) {
...
function visit665_197_1(result) {
...
function visit664_181_1(result) {
...
function visit663_175_1(result) {
...
function visit661_159_1(result) {
...
function visit660_148_1(result) {
...
function visit659_139_2(result) {
...
function visit655_114_1(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, logger = S.getLogger('s/web'), UA = S.UA, doc = win['document'], docElem = visit644_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', readyDefer = new S.Defer(), readyPromise = readyDefer.promise, POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit645_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit646_45_1(visit647_45_2(obj != null) && visit648_45_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[55]++;
  if (visit649_55_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit650_61_1(win['DOMParser'])) {
  ...
  if (visit651_73_1(!xml || visit652_73_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit653_84_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[87]++;
    (visit654_87_1(win.execScript || function(data) {
  ...
  if (visit655_114_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    if (visit657_129_1(doc && !UA.nodejs)) {
  ...
  function bindReady() {
    ...
    if (visit658_139_1(!doc || visit659_139_2(doc.readyState === COMPLETE))) {
    ...
    if (visit660_148_1(standardEventModel)) {
  ...
  if (visit661_159_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit662_172_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[174]++;
      try {
        _$jscoverage['/web.js'].lineData[175]++;
        notframe = (visit663_175_1(win['frameElement'] === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[177]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[181]++;
      if (visit664_181_1(doScroll && notframe)) {
  ...
  if (visit665_197_1(location && visit666_197_2((visit667_197_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
