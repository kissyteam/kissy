...
function visit669_238_1(result) {
...
function visit668_228_3(result) {
...
function visit667_228_2(result) {
...
function visit666_228_1(result) {
...
function visit665_212_1(result) {
...
function visit664_206_1(result) {
...
function visit663_203_1(result) {
...
function visit662_190_1(result) {
...
function visit661_181_1(result) {
...
function visit660_172_2(result) {
...
(function(S, undefined) {
  ...
  return visit642_47_1(visit643_47_2(obj != null) && visit644_47_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[57]++;
  if (visit645_57_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit646_63_1(win.DOMParser)) {
  ...
  if (visit647_76_1(!xml || visit648_76_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit649_87_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[91]++;
    if (visit650_91_1(win.execScript)) {
  ...
  S.log(visit652_112_1(e.stack || e), 'error');
  ...
  if (visit653_133_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    for (var i = 0; visit657_155_1(i < callbacks.length); i++) {
  ...
  S.log(visit658_159_1(e.stack || e), 'error');
  ...
  function bindReady() {
    ...
    if (visit659_172_1(!doc || visit660_172_2(doc.readyState === COMPLETE))) {
    ...
    if (visit661_181_1(standardEventModel)) {
  ...
  if (visit662_190_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit663_203_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[205]++;
      try {
        _$jscoverage['/web.js'].lineData[206]++;
        notframe = (visit664_206_1(win.frameElement === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[208]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[212]++;
      if (visit665_212_1(doScroll && notframe)) {
  ...
  if (visit666_228_1(location && visit667_228_2((visit668_228_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
