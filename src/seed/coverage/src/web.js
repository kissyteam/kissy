...
function visit669_221_3(result) {
...
function visit668_221_2(result) {
...
function visit667_221_1(result) {
...
function visit666_205_1(result) {
...
function visit665_199_1(result) {
...
function visit664_196_1(result) {
...
function visit663_183_1(result) {
...
function visit662_172_1(result) {
...
function visit661_163_2(result) {
...
(function(S, undefined) {
  ...
  var win = S.Env.host, logger = S.getLogger('s/web'), UA = S.UA, doc = win['document'], docElem = visit641_11_1(doc && doc.documentElement), location = win.location, EMPTY = '', domReady = 0, callbacks = [], POLL_RETIRES = 500, POLL_INTERVAL = 40, RE_ID_STR = /^#?([\w-]+)$/, RE_NOT_WHITESPACE = /\S/, standardEventModel = !!(visit642_23_1(doc && doc.addEventListener)), DOM_READY_EVENT = 'DOMContentLoaded', READY_STATE_CHANGE_EVENT = 'readystatechange', LOAD_EVENT = 'load', COMPLETE = 'complete', addEventListener = standardEventModel ? function(el, type, fn) {
  ...
  return visit643_45_1(visit644_45_2(obj != null) && visit645_45_3(obj == obj.window));
}, 
  parseXML: function(data) {
  _$jscoverage['/web.js'].functionData[6]++;
  _$jscoverage['/web.js'].lineData[55]++;
  if (visit646_55_1(data.documentElement)) {
  ...
  try {
    ...
    if (visit647_61_1(win['DOMParser'])) {
  ...
  if (visit648_73_1(!xml || visit649_73_2(!xml.documentElement || xml.getElementsByTagName('parsererror').length))) {
  ...
  if (visit650_84_1(data && RE_NOT_WHITESPACE.test(data))) {
    _$jscoverage['/web.js'].lineData[87]++;
    (visit651_87_1(win.execScript || function(data) {
  ...
  S.log(visit653_104_1(e.stack || e), 'error');
  ...
  if (visit654_125_1(++retryCount > POLL_RETIRES)) {
  ...
  function fireReady() {
    ...
    for (var i = 0; visit658_147_1(i < callbacks.length); i++) {
  ...
  S.log(visit659_151_1(e.stack || e), 'error');
  ...
  function bindReady() {
    ...
    if (visit660_163_1(!doc || visit661_163_2(doc.readyState === COMPLETE))) {
    ...
    if (visit662_172_1(standardEventModel)) {
  ...
  if (visit663_183_1(doc.readyState === COMPLETE)) {
    ...
    fireReady();
      ...
      var notframe, doScroll = visit664_196_1(docElem && docElem.doScroll);
      _$jscoverage['/web.js'].lineData[198]++;
      try {
        _$jscoverage['/web.js'].lineData[199]++;
        notframe = (visit665_199_1(win['frameElement'] === null));
      }      catch (e) {
  _$jscoverage['/web.js'].lineData[201]++;
  notframe = false;
}
      _$jscoverage['/web.js'].lineData[205]++;
      if (visit666_205_1(doScroll && notframe)) {
  ...
  if (visit667_221_1(location && visit668_221_2((visit669_221_3(location.search || EMPTY)).indexOf('ks-debug') !== -1))) {
