...
var KISSY = (function(undefined) {
  ...
  if (visit37_172_1(S.isObject(configName))) {
  ...
  if (visit38_175_1(fn)) {
    ...
    if (visit39_183_1(configValue === undefined)) {
      _$jscoverage['/kissy.js'].lineData[184]++;
      if (visit40_184_1(cfg)) {
  ...
  if (visit42_208_1('@DEBUG@')) {
    _$jscoverage['/kissy.js'].lineData[209]++;
    var matched = 1;
    _$jscoverage['/kissy.js'].lineData[210]++;
    if (visit43_210_1(logger)) {
      _$jscoverage['/kissy.js'].lineData[211]++;
      var loggerCfg = visit44_211_1(S.Config.logger || {}), list, i, l, level, minLevel, maxLevel, reg;
      _$jscoverage['/kissy.js'].lineData[213]++;
      cat = visit45_213_1(cat || 'debug');
      _$jscoverage['/kissy.js'].lineData[214]++;
      level = visit46_214_1(loggerLevel[cat] || loggerLevel.debug);
      ...
      if ((list = loggerCfg.includes)) {
        ...
        for (i = 0; visit47_217_1(i < list.length); i++) {
          _$jscoverage['/kissy.js'].lineData[218]++;
          l = list[i];
          _$jscoverage['/kissy.js'].lineData[219]++;
          reg = l.logger;
          _$jscoverage['/kissy.js'].lineData[220]++;
          maxLevel = visit48_220_1(loggerLevel[l.maxLevel] || loggerLevel.error);
          _$jscoverage['/kissy.js'].lineData[221]++;
          minLevel = visit49_221_1(loggerLevel[l.minLevel] || loggerLevel.debug);
          _$jscoverage['/kissy.js'].lineData[222]++;
          if (visit50_222_1(visit51_222_2(minLevel <= level) && visit52_222_3(visit53_222_4(maxLevel >= level) && logger.match(reg)))) {
        ...
        if ((list = loggerCfg.excludes)) {
          ...
          for (i = 0; visit54_229_1(i < list.length); i++) {
            _$jscoverage['/kissy.js'].lineData[230]++;
            l = list[i];
            _$jscoverage['/kissy.js'].lineData[231]++;
            reg = l.logger;
            _$jscoverage['/kissy.js'].lineData[232]++;
            maxLevel = visit55_232_1(loggerLevel[l.maxLevel] || loggerLevel.error);
            _$jscoverage['/kissy.js'].lineData[233]++;
            minLevel = visit56_233_1(loggerLevel[l.minLevel] || loggerLevel.debug);
            _$jscoverage['/kissy.js'].lineData[234]++;
            if (visit57_234_1(visit58_234_2(minLevel <= level) && visit59_234_3(visit60_234_4(maxLevel >= level) && logger.match(reg)))) {
      ...
      if (visit61_240_1(matched)) {
        _$jscoverage['/kissy.js'].lineData[241]++;
        msg = logger + ': ' + msg;
      }
    }
    _$jscoverage['/kissy.js'].lineData[245]++;
    if (visit62_245_1(visit63_245_2(typeof console !== 'undefined') && visit64_245_3(console.log && matched))) {
      _$jscoverage['/kissy.js'].lineData[246]++;
      console[visit65_246_1(cat && console[cat]) ? cat : 'log'](msg);
  ...
  return (visit67_278_1(pre || EMPTY)) + guid++;
}};
  _$jscoverage['/kissy.js'].lineData[282]++;
  if (visit68_282_1('@DEBUG@')) {
