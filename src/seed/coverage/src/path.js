...
function visit524_220_2(result) {
...
function visit518_197_1(result) {
...
function visit517_186_3(result) {
...
function visit516_186_2(result) {
...
function visit513_183_1(result) {
...
function visit511_157_1(result) {
...
function visit510_156_1(result) {
...
function visit509_126_2(result) {
...
function visit508_126_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit497_41_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit498_72_1(visit499_72_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[73]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[74]++;
    if (visit500_74_1(visit501_74_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit502_78_1(path.charAt(0) == '/');
  }
  ...
  return visit503_85_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[100]++;
  var absolute = visit504_100_1(path.charAt(0) == '/'), trailingSlash = visit505_101_1(path.slice(-1) == '/');
  ...
  if (visit506_107_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[108]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[111]++;
  if (visit507_111_1(path && trailingSlash)) {
  ...
  return visit508_126_1(p && (visit509_126_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit510_156_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[157]++;
    if (visit511_157_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit512_164_1(sameIndex < fromParts.length)) {
  ...
  var result = visit513_183_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[185]++;
  basename = visit514_185_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[186]++;
  if (visit515_186_1(ext && visit516_186_2(basename && visit517_186_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit518_197_1(path.match(splitPathRe) || []), root = visit519_198_1(result[1] || ''), dir = visit520_199_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[201]++;
  if (visit521_201_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[203]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[206]++;
  if (visit522_206_1(dir)) {
  ...
  return visit523_220_1((visit524_220_2(path.match(splitPathRe) || []))[4] || '');
}};
  _$jscoverage['/path.js'].lineData[224]++;
  if (visit525_224_1(Path)) {
