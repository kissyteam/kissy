...
function visit569_210_2(result) {
...
function visit562_175_3(result) {
...
function visit561_175_2(result) {
...
function visit558_172_1(result) {
...
function visit557_153_1(result) {
...
function visit556_146_1(result) {
...
function visit555_145_1(result) {
...
function visit554_116_2(result) {
...
function visit553_116_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit542_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit543_64_1(visit544_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit545_66_1(visit546_66_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit547_70_1(path.charAt(0) === '/');
  }
  ...
  return visit548_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit549_91_1(path.charAt(0) === '/'), trailingSlash = visit550_92_1(path.slice(0 - 1) === '/');
  ...
  if (visit551_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit552_102_1(path && trailingSlash)) {
  ...
  return visit553_116_1(p && (visit554_116_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit555_145_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[146]++;
    if (visit556_146_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit557_153_1(sameIndex < fromParts.length)) {
  ...
  var result = visit558_172_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[174]++;
  basename = visit559_174_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[175]++;
  if (visit560_175_1(ext && visit561_175_2(basename && visit562_175_3(basename.slice(ext.length * -1) === ext)))) {
  ...
  var result = visit563_187_1(path.match(splitPathRe) || []), root = visit564_188_1(result[1] || ''), dir = visit565_189_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[191]++;
  if (visit566_191_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[193]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[196]++;
  if (visit567_196_1(dir)) {
  ...
  return visit568_210_1((visit569_210_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
