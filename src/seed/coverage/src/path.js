...
function visit575_210_2(result) {
...
function visit569_187_1(result) {
...
function visit568_175_3(result) {
...
function visit567_175_2(result) {
...
function visit564_172_1(result) {
...
function visit563_153_1(result) {
...
function visit562_146_1(result) {
...
function visit561_145_1(result) {
...
function visit560_116_2(result) {
...
function visit559_116_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit548_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit549_64_1(visit550_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit551_66_1(visit552_66_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit553_70_1(path.charAt(0) === '/');
  }
  ...
  return visit554_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit555_91_1(path.charAt(0) === '/'), trailingSlash = visit556_92_1(path.slice(0 - 1) === '/');
  ...
  if (visit557_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit558_102_1(path && trailingSlash)) {
  ...
  return visit559_116_1(p && (visit560_116_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit561_145_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[146]++;
    if (visit562_146_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit563_153_1(sameIndex < fromParts.length)) {
  ...
  var result = visit564_172_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[174]++;
  basename = visit565_174_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[175]++;
  if (visit566_175_1(ext && visit567_175_2(basename && visit568_175_3(basename.slice(ext.length * -1) === ext)))) {
  ...
  var result = visit569_187_1(path.match(splitPathRe) || []), root = visit570_188_1(result[1] || ''), dir = visit571_189_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[191]++;
  if (visit572_191_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[193]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[196]++;
  if (visit573_196_1(dir)) {
  ...
  return visit574_210_1((visit575_210_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
