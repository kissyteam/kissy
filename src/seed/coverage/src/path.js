...
function visit526_212_2(result) {
...
function visit520_189_1(result) {
...
function visit519_177_3(result) {
...
function visit518_177_2(result) {
...
function visit515_174_1(result) {
...
function visit514_155_1(result) {
...
function visit513_148_1(result) {
...
function visit512_147_1(result) {
...
function visit511_118_2(result) {
...
function visit510_118_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit499_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit500_65_1(visit501_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit502_67_1(visit503_67_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit504_71_1(path.charAt(0) == '/');
  }
  ...
  return visit505_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit506_92_1(path.charAt(0) == '/'), trailingSlash = visit507_93_1(path.slice(-1) == '/');
  ...
  if (visit508_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit509_103_1(path && trailingSlash)) {
  ...
  return visit510_118_1(p && (visit511_118_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit512_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit513_148_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit514_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit515_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit516_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit517_177_1(ext && visit518_177_2(basename && visit519_177_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit520_189_1(path.match(splitPathRe) || []), root = visit521_190_1(result[1] || ''), dir = visit522_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit523_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit524_198_1(dir)) {
  ...
  return visit525_212_1((visit526_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
