...
function visit557_210_2(result) {
...
function visit550_175_3(result) {
...
function visit549_175_2(result) {
...
function visit546_172_1(result) {
...
function visit545_153_1(result) {
...
function visit544_146_1(result) {
...
function visit543_145_1(result) {
...
function visit542_116_2(result) {
...
function visit541_116_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit530_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit531_64_1(visit532_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit533_66_1(visit534_66_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit535_70_1(path.charAt(0) === '/');
  }
  ...
  return visit536_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit537_91_1(path.charAt(0) === '/'), trailingSlash = visit538_92_1(path.slice(0 - 1) === '/');
  ...
  if (visit539_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit540_102_1(path && trailingSlash)) {
  ...
  return visit541_116_1(p && (visit542_116_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit543_145_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[146]++;
    if (visit544_146_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit545_153_1(sameIndex < fromParts.length)) {
  ...
  var result = visit546_172_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[174]++;
  basename = visit547_174_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[175]++;
  if (visit548_175_1(ext && visit549_175_2(basename && visit550_175_3(basename.slice(ext.length * -1) === ext)))) {
  ...
  var result = visit551_187_1(path.match(splitPathRe) || []), root = visit552_188_1(result[1] || ''), dir = visit553_189_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[191]++;
  if (visit554_191_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[193]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[196]++;
  if (visit555_196_1(dir)) {
  ...
  return visit556_210_1((visit557_210_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
