...
function visit554_210_2(result) {
...
function visit547_175_3(result) {
...
function visit546_175_2(result) {
...
function visit545_175_1(result) {
...
function visit543_172_1(result) {
...
function visit542_153_1(result) {
...
function visit541_146_1(result) {
...
function visit540_145_1(result) {
...
function visit539_116_2(result) {
...
function visit538_116_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit527_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit528_64_1(visit529_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit530_66_1(visit531_66_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit532_70_1(path.charAt(0) === '/');
  }
  ...
  return visit533_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit534_91_1(path.charAt(0) === '/'), trailingSlash = visit535_92_1(path.slice(0 - 1) === '/');
  ...
  if (visit536_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit537_102_1(path && trailingSlash)) {
  ...
  return visit538_116_1(p && (visit539_116_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit540_145_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[146]++;
    if (visit541_146_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit542_153_1(sameIndex < fromParts.length)) {
  ...
  var result = visit543_172_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[174]++;
  basename = visit544_174_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[175]++;
  if (visit545_175_1(ext && visit546_175_2(basename && visit547_175_3(basename.slice(ext.length * -1) === ext)))) {
  ...
  var result = visit548_187_1(path.match(splitPathRe) || []), root = visit549_188_1(result[1] || ''), dir = visit550_189_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[191]++;
  if (visit551_191_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[193]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[196]++;
  if (visit552_196_1(dir)) {
  ...
  return visit553_210_1((visit554_210_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
