...
function visit553_211_2(result) {
...
function visit547_188_1(result) {
...
function visit546_176_3(result) {
...
function visit545_176_2(result) {
...
function visit542_173_1(result) {
...
function visit541_154_1(result) {
...
function visit540_147_1(result) {
...
function visit539_146_1(result) {
...
function visit538_117_2(result) {
...
function visit537_117_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit526_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit527_64_1(visit528_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit529_66_1(visit530_66_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit531_70_1(path.charAt(0) == '/');
  }
  ...
  return visit532_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit533_91_1(path.charAt(0) == '/'), trailingSlash = visit534_92_1(path.slice(-1) == '/');
  ...
  if (visit535_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit536_102_1(path && trailingSlash)) {
  ...
  return visit537_117_1(p && (visit538_117_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit539_146_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[147]++;
    if (visit540_147_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit541_154_1(sameIndex < fromParts.length)) {
  ...
  var result = visit542_173_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[175]++;
  basename = visit543_175_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[176]++;
  if (visit544_176_1(ext && visit545_176_2(basename && visit546_176_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit547_188_1(path.match(splitPathRe) || []), root = visit548_189_1(result[1] || ''), dir = visit549_190_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[192]++;
  if (visit550_192_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[194]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[197]++;
  if (visit551_197_1(dir)) {
  ...
  return visit552_211_1((visit553_211_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
