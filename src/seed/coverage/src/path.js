...
function visit552_212_2(result) {
...
function visit546_189_1(result) {
...
function visit545_177_3(result) {
...
function visit544_177_2(result) {
...
function visit541_174_1(result) {
...
function visit540_155_1(result) {
...
function visit539_148_1(result) {
...
function visit538_147_1(result) {
...
function visit537_118_2(result) {
...
function visit536_118_1(result) {
...
(function(S) {
  ...
  for (i = args.length - 1; visit526_65_1(visit527_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit528_67_1(visit529_67_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit530_71_1(path.charAt(0) == '/');
  }
  ...
  return visit531_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit532_92_1(path.charAt(0) == '/'), trailingSlash = visit533_93_1(path.slice(-1) == '/');
  ...
  if (visit534_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit535_103_1(path && trailingSlash)) {
  ...
  return visit536_118_1(p && (visit537_118_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit538_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit539_148_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit540_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit541_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit542_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit543_177_1(ext && visit544_177_2(basename && visit545_177_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit546_189_1(path.match(splitPathRe) || []), root = visit547_190_1(result[1] || ''), dir = visit548_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit549_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit550_198_1(dir)) {
  ...
  return visit551_212_1((visit552_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
