...
function visit560_212_2(result) {
...
function visit553_177_3(result) {
...
function visit552_177_2(result) {
...
function visit549_174_1(result) {
...
function visit548_155_1(result) {
...
function visit547_148_1(result) {
...
function visit546_147_1(result) {
...
function visit545_118_2(result) {
...
function visit544_118_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit533_36_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit534_65_1(visit535_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit536_67_1(visit537_67_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit538_71_1(path.charAt(0) === '/');
  }
  ...
  return visit539_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit540_92_1(path.charAt(0) === '/'), trailingSlash = visit541_93_1(path.slice(-1) === '/');
  ...
  if (visit542_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit543_103_1(path && trailingSlash)) {
  ...
  return visit544_118_1(p && (visit545_118_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit546_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit547_148_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit548_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit549_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit550_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit551_177_1(ext && visit552_177_2(basename && visit553_177_3(basename.slice(-1 * ext.length) === ext)))) {
  ...
  var result = visit554_189_1(path.match(splitPathRe) || []), root = visit555_190_1(result[1] || ''), dir = visit556_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit557_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit558_198_1(dir)) {
  ...
  return visit559_212_1((visit560_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
