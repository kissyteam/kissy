...
function visit549_212_2(result) {
...
function visit543_189_1(result) {
...
function visit542_177_3(result) {
...
function visit541_177_2(result) {
...
function visit538_174_1(result) {
...
function visit537_155_1(result) {
...
function visit536_148_1(result) {
...
function visit535_147_1(result) {
...
function visit534_118_2(result) {
...
function visit533_118_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit522_36_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit523_65_1(visit524_65_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[66]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[67]++;
    if (visit525_67_1(visit526_67_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit527_71_1(path.charAt(0) === '/');
  }
  ...
  return visit528_78_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[92]++;
  var absolute = visit529_92_1(path.charAt(0) === '/'), trailingSlash = visit530_93_1(path.slice(-1) === '/');
  ...
  if (visit531_99_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[100]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[103]++;
  if (visit532_103_1(path && trailingSlash)) {
  ...
  return visit533_118_1(p && (visit534_118_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit535_147_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[148]++;
    if (visit536_148_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit537_155_1(sameIndex < fromParts.length)) {
  ...
  var result = visit538_174_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[176]++;
  basename = visit539_176_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[177]++;
  if (visit540_177_1(ext && visit541_177_2(basename && visit542_177_3(basename.slice(-1 * ext.length) === ext)))) {
  ...
  var result = visit543_189_1(path.match(splitPathRe) || []), root = visit544_190_1(result[1] || ''), dir = visit545_191_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[193]++;
  if (visit546_193_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[195]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[198]++;
  if (visit547_198_1(dir)) {
  ...
  return visit548_212_1((visit549_212_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
