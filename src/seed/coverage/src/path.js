...
function visit536_220_2(result) {
...
function visit530_197_1(result) {
...
function visit529_186_3(result) {
...
function visit528_186_2(result) {
...
function visit525_183_1(result) {
...
function visit524_164_1(result) {
...
function visit523_157_1(result) {
...
function visit522_156_1(result) {
...
function visit521_126_2(result) {
...
function visit520_126_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit509_41_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit510_72_1(visit511_72_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[73]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[74]++;
    if (visit512_74_1(visit513_74_2(typeof path != 'string') || !path)) {
    ...
    absolute = visit514_78_1(path.charAt(0) == '/');
  }
  ...
  return visit515_85_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[100]++;
  var absolute = visit516_100_1(path.charAt(0) == '/'), trailingSlash = visit517_101_1(path.slice(-1) == '/');
  ...
  if (visit518_107_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[108]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[111]++;
  if (visit519_111_1(path && trailingSlash)) {
  ...
  return visit520_126_1(p && (visit521_126_2(typeof p == 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit522_156_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[157]++;
    if (visit523_157_1(fromParts[sameIndex] != toParts[sameIndex])) {
  ...
  while (visit524_164_1(sameIndex < fromParts.length)) {
  ...
  var result = visit525_183_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[185]++;
  basename = visit526_185_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[186]++;
  if (visit527_186_1(ext && visit528_186_2(basename && visit529_186_3(basename.slice(-1 * ext.length) == ext)))) {
  ...
  var result = visit530_197_1(path.match(splitPathRe) || []), root = visit531_198_1(result[1] || ''), dir = visit532_199_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[201]++;
  if (visit533_201_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[203]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[206]++;
  if (visit534_206_1(dir)) {
  ...
  return visit535_220_1((visit536_220_2(path.match(splitPathRe) || []))[4] || '');
}};
  _$jscoverage['/path.js'].lineData[224]++;
  if (visit537_224_1(Path)) {
