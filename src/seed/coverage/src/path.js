...
function visit573_210_2(result) {
...
function visit567_187_1(result) {
...
function visit566_175_3(result) {
...
function visit565_175_2(result) {
...
function visit562_172_1(result) {
...
function visit561_153_1(result) {
...
function visit560_146_1(result) {
...
function visit559_145_1(result) {
...
function visit558_116_2(result) {
...
function visit557_116_1(result) {
...
(function(S) {
  ...
  function normalizeArray(parts, allowAboveRoot) {
    ...
    if (visit546_35_1(allowAboveRoot)) {
  ...
  for (i = args.length - 1; visit547_64_1(visit548_64_2(i >= 0) && !absolute); i--) {
    _$jscoverage['/path.js'].lineData[65]++;
    path = args[i];
    _$jscoverage['/path.js'].lineData[66]++;
    if (visit549_66_1(visit550_66_2(typeof path !== 'string') || !path)) {
    ...
    absolute = visit551_70_1(path.charAt(0) === '/');
  }
  ...
  return visit552_77_1(((absolute ? '/' : '') + resolvedPathStr) || '.');
}, 
  normalize: function(path) {
  _$jscoverage['/path.js'].functionData[4]++;
  _$jscoverage['/path.js'].lineData[91]++;
  var absolute = visit553_91_1(path.charAt(0) === '/'), trailingSlash = visit554_92_1(path.slice(0 - 1) === '/');
  ...
  if (visit555_98_1(!path && !absolute)) {
    _$jscoverage['/path.js'].lineData[99]++;
    path = '.';
  }
  _$jscoverage['/path.js'].lineData[102]++;
  if (visit556_102_1(path && trailingSlash)) {
  ...
  return visit557_116_1(p && (visit558_116_2(typeof p === 'string')));
}).join('/'));
}, 
  ...
  for (sameIndex = 0; visit559_145_1(sameIndex < commonLength); sameIndex++) {
    _$jscoverage['/path.js'].lineData[146]++;
    if (visit560_146_1(fromParts[sameIndex] !== toParts[sameIndex])) {
  ...
  while (visit561_153_1(sameIndex < fromParts.length)) {
  ...
  var result = visit562_172_1(path.match(splitPathRe) || []), basename;
  _$jscoverage['/path.js'].lineData[174]++;
  basename = visit563_174_1(result[3] || '');
  _$jscoverage['/path.js'].lineData[175]++;
  if (visit564_175_1(ext && visit565_175_2(basename && visit566_175_3(basename.slice(ext.length * -1) === ext)))) {
  ...
  var result = visit567_187_1(path.match(splitPathRe) || []), root = visit568_188_1(result[1] || ''), dir = visit569_189_1(result[2] || '');
  _$jscoverage['/path.js'].lineData[191]++;
  if (visit570_191_1(!root && !dir)) {
    _$jscoverage['/path.js'].lineData[193]++;
    return '.';
  }
  _$jscoverage['/path.js'].lineData[196]++;
  if (visit571_196_1(dir)) {
  ...
  return visit572_210_1((visit573_210_2(path.match(splitPathRe) || []))[4] || '');
}};
})(KISSY);
