    ...
    describe("timestamp for individual module works", function () {
        ...
        it("works and avoid repeated loading", function () {
            ...
            runs(function () {
                expect(S.endsWith(mods["timestamp/x"].path, "b.js")).toBe(true);
                expect(S.endsWith(mods["timestamp/z"].path, "z.js")).toBe(true);
        ...
        it("can be set later", function () {
            ...
            runs(function () {
                expect(S.endsWith(mods["timestamp/x"].path, "q.js")).toBe(true);
                expect(S.endsWith(mods["timestamp/z"].path, "z.js")).toBe(true);
