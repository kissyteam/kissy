describe("KISSY ComboLoader", function () {
    ...
    it("should works simply", function () {
        ...
        S.config({
            packages:[
                {
                    name:'tests3',
                    path:'/kissy_git/kissy/src/seed/tests/specs/combo/'
                }
            ]
        });
    ...
    it("should works for packages", function () {
        ...
        expect(urls['js']['http://' + host + '/kissy_git/kissy/src/seed/tests/specs/combo/'][0])
            .toBe("http://" + host + "/kissy_git/kissy/src/seed/tests/specs/combo/" +
