...
if (! _$jscoverage['/html-parser/scanner.js'].functionData) {
  ...
  _$jscoverage['/html-parser/scanner.js'].functionData[0] = 0;
  _$jscoverage['/html-parser/scanner.js'].functionData[1] = 0;
}
...
KISSY.add(function(S, require) {
  ...
  return visit275_14_1(SpecialScanners[nodeName] || TagScanner);
}};
});
