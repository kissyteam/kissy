...
KISSY.add(function() {
  ...
  if (visit276_14_1(node)) {
    _$jscoverage['/html-parser/scanners/cdata-scanner.js'].lineData[16]++;
    if (visit277_16_1(visit278_16_2(node.nodeType !== 1) || !(visit279_16_3(node.isEndTag() && visit280_17_1(node.tagName === tag.tagName))))) {
