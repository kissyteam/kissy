...
KISSY.add(function() {
  ...
  if (visit191_37_1(this.page)) {
    _$jscoverage['/html-parser/nodes/node.js'].lineData[38]++;
    if (visit192_38_1('startLine' in this)) {
  ...
  if (visit193_47_1(this.page)) {
    _$jscoverage['/html-parser/nodes/node.js'].lineData[48]++;
    if (visit194_48_1('endLine' in this)) {
  ...
  if (visit195_61_1(this.page && this.page.getText)) {
