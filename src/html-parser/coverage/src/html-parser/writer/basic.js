...
KISSY.add("html-parser/writer/basic", function() {
  ...
  if (visit337_42_1(el.isSelfClosed)) {
  ...
  this.append(" ", attr.name, "=\"", escapeAttrValue(visit338_56_1(attr.value || attr.name)), "\"");
}, 
  text: function(text) {
