...
if (! _$jscoverage['/router/request.js']) {
  _$jscoverage['/router/request.js'] = {};
  _$jscoverage['/router/request.js'].lineData = [];
...
if (! _$jscoverage['/router/request.js'].functionData) {
  ...
  _$jscoverage['/router/request.js'].functionData[0] = 0;
  _$jscoverage['/router/request.js'].functionData[1] = 0;
  _$jscoverage['/router/request.js'].functionData[2] = 0;
}
