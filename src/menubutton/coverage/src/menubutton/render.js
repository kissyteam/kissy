...
if (! _$jscoverage['/menubutton/render.js'].functionData) {
  ...
  _$jscoverage['/menubutton/render.js'].functionData[0] = 0;
  _$jscoverage['/menubutton/render.js'].functionData[1] = 0;
  _$jscoverage['/menubutton/render.js'].functionData[2] = 0;
  _$jscoverage['/menubutton/render.js'].functionData[3] = 0;
}
