KISSY.use("node,template", function(S, N, Template) {
    ...
    describe('template', function() {
        ...
        describe('cache', function() {
            it('have template cache', function() {
                ...
                var f = T('{{#each a}}<{{_ks_value.a}}{{/each}}');
                expect(t).toEqual(f);
            });
        });
        ...
        var tmpl = function(selector, data) {
            var html = Node.one(selector).html(),
                t = Template(html);
            return new Node(t.render(data));
        };
        describe('node', function() {
            it('have chain support for KISSY.Node', function() {
                ...
                expect(Node.one('#render').html()).toEqual('123');
