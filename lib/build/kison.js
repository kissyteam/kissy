...
KISSY.add('kison/grammar', [
    ...
    var GrammarConst = {
            ...
            PRODUCTION_INDEX: 1,
            TO_INDEX: 2
        }, serializeObject = Utils.serializeObject, END_TAG = Lexer.STATIC.END_TAG, START_TAG = '$START';
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('kison/utils', ['util'], function (S, require) {
