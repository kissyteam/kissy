 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('util/array', ['./base'], function (S, require) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('util/escape', ['./base'], function (S, require) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('util/function', ['./base'], function (S, require) {
...
KISSY.add('util/object', ['./base'], function (S, require) {
    ...
    mix(util, {
         ...
         */
        namespace: function () {
            var args = util.makeArray(arguments), l = args.length, o = null, i, j, p, global = args[l - 1] === TRUE && l--;
            for (i = 0; i < l; i++) {
 ...
 * @author yiminghe@gmail.com
 */
KISSY.add('util/string', ['./base'], function (S, require) {
    var util = require('./base');
    var undef;
 ...
 */
KISSY.add('util/type', ['./base'], function (S, require) {
 ...
 */
KISSY.add('util/web', ['./base'], function (S, require) {
    var util = require('./base');
    ...
    function fireReady() {
        ...
        for (var i = 0; i < callbacks.length; i++) {
            try {
                ...
                util.log(e.stack || e, 'error');    /*jshint loopfunc:true*/
                /*jshint loopfunc:true*/
                setTimeout(function () {
                    throw e;
                }, 0);
