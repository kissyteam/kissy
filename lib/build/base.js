 ...
 */
     ...
     */
        extend: function extend(extensions, px, sx) {
            ...
            SubClass.__extensions__ = extensions;    // stub hooks for extensions
            // stub hooks for extensions
            baseAddMembers.call(SubClass, {});    // merge extensions
            // merge extensions
            if (extensions.length) {
                var attrs = {}, prototype = {};    // [ex1,ex2]，扩展类后面的优先，ex2 定义的覆盖 ex1 定义的
                                                   // 主类最优先
