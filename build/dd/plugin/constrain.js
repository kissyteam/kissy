...
d,m,this).on("dragend"+d,o,this).on("dragalign"+d,n,this)},pluginDestructor:function(a){a.detach(d,{context:this})}},{ATTRS:{constrain:{valueFn:function(){return h(j)},setter:function(a){if(a){if(!0===a)return h(j);if(a.nodeType||f.isWindow(a)||"string"===typeof a)return h(a)}return a}}}})});
