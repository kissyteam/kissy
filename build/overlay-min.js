...
KISSY.add("overlay/overlay",function(c,b,d,e){function a(f){return c.require("uibase/"+f)}return b.create(d.ModelControl,[a("box"),a("contentbox"),a("position"),a("loading"),a("align"),a("resize"),a("mask")],{},{ATTRS:{view:{valueFn:function(){return new e}}}})},{requires:["uibase","component","./overlayrender"]});KISSY.add("overlay/dialogrender",function(c,b,d){return b.create(d,[c.require("uibase/stdmodrender"),c.require("uibase/closerender")])},{requires:["uibase","./overlayrender"]});
