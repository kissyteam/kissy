...
KISSY.add("menubutton/control", ["node", "button", "component/extension/content-box", "./menubutton-xtpl"], function(S, require) {
  var Node = require("node");
  var Button = require("button");
  var ContentBox = require("component/extension/content-box");
  var KeyCode = Node.KeyCode;
  var MenuButtonTpl = require("./menubutton-xtpl");
  return Button.extend([ContentBox], {isMenuButton:1, decorateDom:function(el) {
  ...
  }}, collapsed:{value:true, render:1, sync:0}, contentTpl:{value:MenuButtonTpl}}, xclass:"menu-button"});
