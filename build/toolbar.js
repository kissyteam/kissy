...
KISSY.add("toolbar", ["component/container", "component/extension/delegate-children", "node"], function(S, require) {
  ...
  return Container.extend([DelegateChildrenExtension], {beforeCreateDom:function(renderData) {
  ...
  }}, {xclass:"toolbar", ATTRS:{highlightedItem:{}, expandedItem:{}, defaultChildCfg:{value:{xclass:"button", handleGestureEvents:false, focusable:false}}}})
});
