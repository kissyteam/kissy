...
"ease-in-out":1};f.extend(h,l,{prepareFx:function(){var d=this._propsData,c={},a,b;for(b in d)a=d[b],"string"===typeof a.easing?!f.startsWith(a.easing,"cubic-bezier")&&!p[a.easing]&&(a.easing="ease-in"):a.easing="ease-in",a=m(b),c[o(a.propertyName)]=d[b];this._propsData=c},doStart:function(){var d=this,c=d.node,a=c.style,b=d._propsData,g=a[j],e=0,h={};f.each(b,function(b,a){var d=b.value;i.css(c,a,i.css(c,a));h[a]=d;e=Math.max(b.duration+b.delay,e)});-1!==g.indexOf("none")?g="":g&&(g+=",");a[j]=g+
