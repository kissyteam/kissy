...
this[0])},all:function(a){return b.all(a,this[0])},appendTo:function(a){if((a=b.get(a))&&a.appendChild)a.appendChild(this[0]);return this}});b.one=function(a,c){return new f(b.get(a,c))};b.Node=f});
