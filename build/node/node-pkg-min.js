...
c);return this}}});b.each(["children","siblings","next","prev","parent"],function(a){d[a]=function(){var c=h[a](this[0]);return c?new b[c.length?"NodeList":"Node"](c):null}});b.each(["hasClass","addClass","removeClass","replaceClass","toggleClass"],function(a){d[a]=function(){var c=h[a].apply(h,[this[0]].concat(b.makeArray(arguments)));return typeof c==="boolean"?c:this}});b.mix(d,b.EventTarget);d._addEvent=function(a,c){b.Event._simpleAdd(this[0],a,c)};d._removeEvent=function(a,c){b.Event._simpleRemove(this[0],
a,c)};delete d.fire;b.mix(d,{one:function(a){return b.one(a,this[0])},all:function(a){return b.all(a,this[0])},appendTo:function(a){if((a=b.get(a))&&a.appendChild)a.appendChild(this[0]);return this}});b.one=function(a,c){return new f(b.get(a,c))};b.Node=f});
