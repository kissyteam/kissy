...
*/
KISSY.add("date/popup-picker/render-xtpl",["date/picker-xtpl"],function(h,e,c,f){c=function(d,b,c,j){var i=this.nativeCommands,a=this.utils;if("1.50"!==h.version)throw Error("current xtemplate file("+this.name+")(v1.50) need to be recompiled using current kissy(v"+h.version+")!");a=a.callCommand;i=i.include;b.write('<div class="');var g={escape:1},k=[];k.push("content");g.params=k;if((a=a(this,d,g,b,"getBaseCssClasses",1))&&a.isBuffer)b=a,a=j;b.write(a,!0);b.write('">\n    ');a={};g=[];g.push("date/picker-xtpl");
