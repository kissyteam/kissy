...
KISSY.add("date/popup-picker/render-xtpl",["date/picker-xtpl"],function(g,d,f,e){e.exports=function(b,a,e){var c=this.root.utils.callFn,g=this.root.nativeCommands.include;a.write('<div class="');var h={escape:1},f=[];f.push("content");h.params=f;if((c=c(this,b,h,a,["getBaseCssClasses"],1))&&c.isBuffer)a=c,c=e;a.writeEscaped(c);a.write('">\r\n    ');c={};h=[];h.push("date/picker-xtpl");c.params=h;d("date/picker-xtpl");if((b=g.call(this,b,c,a,2))&&b.isBuffer)a=b,b=e;a.write(b);a.write("\r\n</div>");
return a};e.exports.TPL_NAME=e.name});
