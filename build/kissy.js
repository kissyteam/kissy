...
var KISSY = (function (undefined) {
    ...
    S = {
         ...
         * NOTICE: '20130407152227' will replace with current timestamp when compressing.
         * @private
         * @type {String}
         */
        __BUILD_TIME: '20130407152227',
        /**
         * KISSY Environment.
         * @private
         * @type {Object}
...
KISSY.add('dom/selector', function (S, parser, DOM) {
    ...
    var document = S.Env.host.document,
        SELECTOR_KEY = '_ks_data_selector_id_',
        caches = {},
        isContextXML,
        uuid = 0,
        subMatchesCache = {},
