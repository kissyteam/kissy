...
*/
KISSY.add("component/extension/content-render/content-tpl",'<div id="ks-content-{{id}}" class="{{getBaseCssClasses \'content\'}}">{{{content}}}</div>');
...
c.unselectable()}};d.mix(e,{ATTRS:{contentTpl:{value:g}},HTML_PARSER:{content:function(a){return a.one("."+this.getBaseCssClass("content")).html()},contentEl:function(a){return a.one("."+this.getBaseCssClass("content"))}}});return e},{requires:["./content-render/content-tpl"]});
