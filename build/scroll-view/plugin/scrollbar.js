...
KISSY.add("scroll-view/plugin/scrollbar/control", ["ua", "component/control", "event/gesture/base", "event/gesture/drag", "./scrollbar-xtpl"], function(S, require) {
  ...
  var methods = {initializer:function() {
    var self = this;
  ...
  return Control.extend(methods, {ATTRS:{minLength:{value:MIN_BAR_LENGTH}, scrollView:{}, axis:{render:1}, autoHide:{value:UA.ios}, visible:{valueFn:function() {
    ...
    return v
  }, render:1}, dragHeight:{setter:function(v) {
    var minLength = this.get("minLength");
    if(v < minLength) {
      return minLength
    }
    return v
  }, render:1}, dragLeft:{render:1, value:0}, dragTop:{render:1, value:0}, dragEl:{selector:function() {
    return"." + this.getBaseCssClass("drag")
  }}, downBtn:{selector:function() {
    return"." + this.getBaseCssClass("arrow-down")
  }}, upBtn:{selector:function() {
    return"." + this.getBaseCssClass("arrow-up")
  }}, trackEl:{selector:function() {
    return"." + this.getBaseCssClass("track")
  }}, focusable:{value:false}, contentTpl:{value:ScrollBarTpl}}, xclass:"scrollbar"})
});
