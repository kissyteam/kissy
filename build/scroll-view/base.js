...
KISSY.add("scroll-view/base", ["node", "anim/timer", "component/container", "component/extension/content-box"], function(S, require) {
  ...
  return Container.extend([ContentBox], methods, {ATTRS:{contentEl:{}, scrollLeft:{render:1, value:0}, scrollTop:{render:1, value:0}, dimension:{}, focusable:{value:true}, allowTextSelection:{value:true}, handleGestureEvents:{value:false}, snap:{value:false}, pageIndex:{value:0}}, xclass:"scroll-view"})
});
