...
arguments)}},{ATTRS:{value:{},describedby:{view:1},tooltip:{view:1},checkable:{},checked:{view:1},xrender:{value:f}}},{xclass:"button",priority:10});return e},{requires:["event","component/base","./buttonRender"]});KISSY.add("button",function(d,b,a){b.Render=a;return b},{requires:["button/base","button/buttonRender"]});
