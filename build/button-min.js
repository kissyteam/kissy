...
view:1},tooltip:{value:"",view:1},checkable:{},checked:{view:1},xrender:{value:c}}},{xclass:"button",priority:10})},{requires:["event","component/base","./render"]});KISSY.add("button",function(d,b,a){b.Render=a;return b},{requires:["button/base","button/render"]});
