...
"dom"]});
KISSY.add("event/dom/ie/submit",function(h,b,g){function d(a){var a=a.target,d=e(a);if((a="input"==d||"button"==d?a.form:null)&&!a.__submit__fix)a.__submit__fix=1,b.on(a,"submit",{fn:f,last:1})}function f(a){this.parentNode&&!a.isPropagationStopped()&&!a.synthetic&&b.fire(this.parentNode,"submit",a)}var e=g.nodeName;b.Special.submit={setup:function(){if("form"==e(this))return!1;b.on(this,"click keypress",d)},tearDown:function(){if("form"==e(this))return!1;b.remove(this,"click keypress",d);h.each(g.query("form",
this),function(a){a.__submit__fix&&(a.__submit__fix=0,b.remove(a,"submit",{fn:f,last:1}))})}}},{requires:["event/dom/base","dom"]});KISSY.add("event/dom/ie",function(){},{requires:["./ie/change","./ie/submit"]});
