...
*/
KISSY.add("event/gesture/drag",["event/gesture/util","event/dom/base"],function(m,j){function k(b,c){var a=b.lastTouches[0],d=c.timeStamp;d-b.lastTime>n&&(b.lastPos={pageX:a.pageX,pageY:a.pageY},b.lastTime=d)}function h(b,c,a){var d=b.startPos,a=a||{},e=b.lastTouches[0];a.pageX=e.pageX;a.pageY=e.pageY;a.originalEvent=c.originalEvent;a.deltaX=e.pageX-d.pageX;a.deltaY=e.pageY-d.pageY;a.startTime=b.startTime;a.startPos=b.startPos;a.touch=e;a.gestureType=c.gestureType;return a}function f(){}var l=j("event/gesture/util"),
