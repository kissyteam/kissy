...
var KISSY = (function (undefined) {
    ...
    S = {
         ...
         * NOTICE: '20130724163906' will replace with current timestamp when compressing.
         * @private
         * @type {String}
         */
        __BUILD_TIME: '20130724163906',
        /**
         * KISSY Environment.
         * @private
         * @type {Object}
...
(function (S) {
    ...
    S.config({
        ...
        modules: {
            core: {
                alias: ['dom', 'event', 'ajax', 'anim', 'base', 'node', 'json', 'cookie']
            }
        }
    });
})(KISSY);
