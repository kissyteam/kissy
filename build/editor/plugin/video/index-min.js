...
"ke_video","video",!0)}return null}for(a=0;a<d.length;a++){var c=d[a];if("param"==c.nodeName&&"movie"==c.getAttribute("name").toLowerCase()&&g(c.getAttribute("value")))return e.createFakeParserElement(b,"ke_video","video",!0)}},embed:function(b){if(!i.isFlashEmbed(b))return null;if(g(b.getAttribute("src")))return e.createFakeParserElement(b,"ke_video","video",!0)}}},4);var k=new m({editor:f,cls:"ke_video",type:"video",bubbleId:"video-bubble",contextMenuId:"video-contextmenu",contextMenuHandlers:{"视频属性":function(){var b=
this.get("editorSelectedEl");b&&k.show(b)}}});f.addButton("video",{tooltip:"插入视频",listeners:{click:{fn:function(){k.show()}}},mode:l.WYSIWYG_MODE})}}},{requires:["editor","../flashCommon/utils","../flashCommon/baseClass"]});
