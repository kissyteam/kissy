...
bubbleId:"video",contextMenuId:"video",contextMenuHandlers:{"视频属性":function(){var b=this.get("editorSelectedEl");b&&k.show(b)}}});c.addButton("video",{tooltip:"插入视频",listeners:{click:function(){k.show()}},mode:m.WYSIWYG_MODE})}});return e},{requires:["editor","../flashCommon/utils","../flashCommon/baseClass","../fakeObjects/"]});
