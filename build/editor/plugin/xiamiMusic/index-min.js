...
!0,{title:a.getAttribute("title")})}}},4);var k=new h({editor:c,cls:"ke_xiami",type:"xiamiMusic",bubbleId:"xiami-bubble",contextMenuId:"xiami-contextmenu",contextMenuHandlers:{"虾米属性":function(){var a=this.get("editorSelectedEl");a&&k.show(a)}}});c.addButton("xiamiMusic",{tooltip:"插入虾米音乐",listeners:{click:{fn:function(){k.show()}}},mode:m.WYSIWYG_MODE})}}},{requires:["editor","../flashCommon/baseClass","../flashCommon/utils"]});
