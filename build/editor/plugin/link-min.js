...
g.on("click",function(a){var c=e.get("editorSelectedEl");k.useDialog(b,"link",d.config,c);a.halt()});h.on("click",function(a){j.removeLink(b,e.get("editorSelectedEl"));a.halt()});e.on("show",function(){var a=e.get("editorSelectedEl");a&&(a=a.attr(j._ke_saved_href)||a.attr("href"),l.html(a),l.attr("href",a))})}}})}});return d});
