...
a)},destroy:function(){this.swf.destroy();delete f[this.id]}});e.EventHandler=function(a,b){"fire event: "+b.type;var c=f[a];c&&setTimeout(function(){c._eventHandler.call(c,b)},100)};return i.FlashBridge=e},{requires:["swf","editor"]});
