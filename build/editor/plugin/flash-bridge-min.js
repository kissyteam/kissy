...
a)},destroy:function(){this.swf.destroy();delete g[this.id]}});f.EventHandler=function(a,b){"fire event: "+b.type;var c=g[a];c&&setTimeout(function(){c._eventHandler.call(c,b)},100)};return i.FlashBridge=f});
