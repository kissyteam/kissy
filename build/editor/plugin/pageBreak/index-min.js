...
*/
KISSY.add("editor/plugin/pageBreak/index",function(g,i,j){function h(){}var k=g.Node;g.augment(h,{renderUI:function(a){j.init(a);var d=a.htmlDataProcessor;(d&&d.dataFilter).addRules({tags:{div:function(a){var c=a.getAttribute("style"),b;if(c)for(var e=a.childNodes,f=0;f<e.length;f++)1==e[f].nodeType&&(b=e[f]);if((b=b&&"span"==b.nodeName&&b.getAttribute("style"))&&/page-break-after\s*:\s*always/i.test(c)&&/display\s*:\s*none/i.test(b))return d.createFakeParserElement(a,"ke_pagebreak","div")}}});a.addButton("pageBreak",
...
a.execCommand("save")}}},mode:i.WYSIWYG_MODE})}});return h},{requires:["editor","../fakeObjects/"]});
