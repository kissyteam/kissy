...
b.execCommand("save");for(var e=0,f;f=c[e];e++)if(!f.collapsed){f.enlarge(m.ENLARGE_ELEMENT);var i=f.createBookmark(),a=i.startNode,d=i.endNode,g=function(a){for(var b=new n(a),e=b.elements,d=1,c;(c=e[d])&&!c.equals(b.block)&&!c.equals(b.blockLimit);d++)h.test(c.nodeName())&&a._4e_breakParent(c)};g(a);g(d);for(a=a._4e_nextSourceNode(!0,j.ELEMENT_NODE,void 0,void 0);a&&!a.equals(d);)g=a._4e_nextSourceNode(!1,j.ELEMENT_NODE,void 0,void 0),"img"==a.nodeName()&&a.attr("_ke_realelement")||(h.test(a.nodeName())?
a._4e_remove(!0):l(a,o)),a=g;f.moveToBookmark(i)}b.getSelection().selectRanges(c);b.execCommand("save")}})}}},{requires:["editor"]});
