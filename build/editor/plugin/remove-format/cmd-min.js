...
0;var d=b.getSelection().getRanges();b.execCommand("save");for(var e=0,f;f=d[e];e++)if(!f.collapsed){f.enlarge(n.ENLARGE_ELEMENT);var i=f.createBookmark(),a=i.startNode,c=i.endNode,g=function(a){for(var b=new o(a),e=b.elements,d=1,c;(c=e[d])&&!c.equals(b.block)&&!c.equals(b.blockLimit);d++)h.test(c.nodeName())&&a._4e_breakParent(c)};g(a);g(c);for(a=a._4e_nextSourceNode(!0,j.NodeType.ELEMENT_NODE,void 0,void 0);a&&!a.equals(c);)g=a._4e_nextSourceNode(!1,j.NodeType.ELEMENT_NODE,void 0,void 0),"img"==
a.nodeName()&&(a.attr("_ke_realelement")||/\bke_/.test(a[0].className))||(h.test(a.nodeName())?a._4e_remove(!0):m(a,p)),a=g;f.moveToBookmark(i)}b.getSelection().selectRanges(d);b.execCommand("save")}})}}});
