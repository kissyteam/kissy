...
a.nodeName()&&(a.attr("_keRealElement")||/\bke_/.test(a[0].className))||(h.test(a.nodeName())?a._4eRemove(!0):m(a,p)),a=g;f.moveToBookmark(i)}b.getSelection().selectRanges(d);b.execCommand("save")}})}}});
