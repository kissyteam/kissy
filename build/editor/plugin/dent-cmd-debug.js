...
KISSY.add('editor/plugin/dent-cmd', [
    ...
    var listNodeNames = {
            ol: 1,
            ul: 1
        }, Walker = Editor.Walker, Dom = require('dom'), Node = S.Node, UA = S.UA, isNotWhitespaces = Walker.whitespaces(true), INDENT_CSS_PROPERTY = 'margin-left', INDENT_OFFSET = 40, INDENT_UNIT = 'px', isNotBookmark = Walker.bookmark(false, true);
