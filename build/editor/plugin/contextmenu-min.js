...
f.baseZIndex(f.zIndexManager.POPUP_MENU);var b=new j.PopupMenu(a);k.init(b);b.on("afterRenderUI",function(){b.get("el").on("keydown",function(a){a.keyCode==h.Event.KeyCode.ESC&&b.hide()})});c.docReady(function(){var a=c.get("document");a.on("mousedown",function(a){1==a.which&&b.hide()});a.delegate("contextmenu",m,function(a){a.halt();i(a)})});d&&i(d);c.addControl(l+"/contextmenu",b);return b}},{requires:["editor","menu","./focus-fix"]});
