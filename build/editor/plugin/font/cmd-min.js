...
a.getSelection())&&!a.isInvalid){var a=a.getStartElement(),a=new h.ElementPath(a),e=a.elements,b,c,d;for(c=0;c<e.length;c++)if(b=e[c],!(a.block&&b[0]==a.block[0]||a.blockLimit&&b[0]==a.blockLimit[0]))if(d=j(b,f),!1!==d)break;return d}}}))}}},{requires:["editor"]});
