...
c.execCommand("heading",d)},afterSyncUI:function(){var d=this;c.on("selectionChange",function(){if(c.get("mode")!=f.SOURCE_MODE){var b=c.queryCommandValue("heading"),a;for(a in g)if(a==b){d.set("value",a);return}d.set("value",null)}})}}})}});return b},{requires:["editor","./heading/cmd"]});
