...
*/
KISSY.add("editor/plugin/contextmenu",["editor","menu","./focus-fix","event/dom","node"],function(n,a){var g=a("editor"),i=a("menu"),j=a("./focus-fix"),k=a("event/dom"),l=a("node").all;g.prototype.addContextMenu=function(a,m,c){function h(f){var c=l(f.target),a=f.pageX,e=f.pageY;a&&(f=g.Utils.getXY({left:a,top:e},d),a=f.left,e=f.top,setTimeout(function(){b.set("editorSelectedEl",c,{silent:1});b.move(a,e);d.fire("contextmenu",{contextmenu:b});b.show();window.focus();document.body.focus();b.focus()},
