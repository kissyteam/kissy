...
*/
KISSY.add("editor/plugin/contextmenu",["editor","menu","./focus-fix","event/dom"],function(i,a){var g=a("editor"),j=a("menu"),k=a("./focus-fix"),l=a("event/dom");g.prototype.addContextMenu=function(a,m,c){function h(f){var c=i.all(f.target),a=f.pageX,e=f.pageY;a&&(f=g.Utils.getXY({left:a,top:e},d),a=f.left,e=f.top,setTimeout(function(){b.set("editorSelectedEl",c,{silent:1});b.move(a,e);d.fire("contextmenu",{contextmenu:b});b.show();window.focus();document.body.focus();b.focus()},30))}var d=this,c=
