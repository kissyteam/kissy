...
*/
KISSY.add("editor/plugin/element-path/index",function(c,j){function f(a){this.cfg=a;this._cache=[];this._init()}function e(){}var i=c.Node;c.augment(f,{_init:function(){var a=this.cfg.editor;this.holder=new i("<span>");this.holder.appendTo(a.get("statusBarEl"),void 0);a.on("selectionChange",this._selectionChange,this);j.Utils.sourceDisable(a,this)},disable:function(){this.holder.css("visibility","hidden")},enable:function(){this.holder.css("visibility","")},_selectionChange:function(a){var g=this.cfg.editor,
...
{renderUI:function(a){var c=new f({editor:a});a.on("destroy",function(){c.destroy()})}});return e},{requires:["editor"]});
