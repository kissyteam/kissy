...
*/
KISSY.add("editor/plugin/localStorage/index",function(d,c,e,f){if(!d.UA.ie&&window.localStorage)return window.localStorage;var g=c.Utils.debugUrl("plugin/localStorage/swfstore.swf?t="+ +new Date),a=new f({movie:g,flashVars:{useCompression:!0},methods:["setItem","removeItem","getItem","setMinDiskSpace","getValueOf"]});a.swf.height=138;var b=new e({width:"0px",prefixCls:"ks-editor-",elStyle:{overflow:"hidden"},content:"<h1 style='border:1px solid black;border-bottom:none;background:white;text-align:center;'>请点击允许</h1>",
