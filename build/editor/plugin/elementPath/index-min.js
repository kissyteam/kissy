...
a=a.path.elements,c,b;c=this._cache;for(b=0;b<c.length;b++)c[b].remove();this._cache=[];for(b=0;b<a.length;b++){c=a[b];var e=c.attr("_ke_real_element_type")||c.nodeName(),f=new g("<a href='javascript(\""+e+"\")' class='ks-editor-element-path'>"+e+"</a>");this._cache.push(f);(function(a){f.on("click",function(b){b.halt();h.focus();setTimeout(function(){h.getSelection().selectElement(a)},50)})})(c);d.prepend(f)}},destroy:function(){this.holder.remove()}});return{init:function(a){var d=new e({editor:a});
a.on("destroy",function(){d.destroy()})}}},{requires:["editor"]});
