...
*/
KISSY.add("editor/plugin/elementPath/index",function(c,j){function e(a){this.cfg=a;this._cache=[];this._init()}function g(){}var h=c.Node;c.augment(e,{_init:function(){var a=this.cfg.editor;this.holder=new h("<span>");this.holder.appendTo(a.get("statusBarEl"),void 0);a.on("selectionChange",this._selectionChange,this);j.Utils.sourceDisable(a,this)},disable:function(){this.holder.css("visibility","hidden")},enable:function(){this.holder.css("visibility","")},_selectionChange:function(a){var i=this.cfg.editor,
