...
new b({node:c}),h=0,i=0,m=a.get("el"),n=a.get("el");f.on("dragstart",function(){h=m.height();i=n.width();a.fire("resizeStart")});f.on("drag",function(b){var c=b.left-this.get("startNodePos").left,b=b.top-this.get("startNodePos").top;d.inArray("y",e)&&a.set("height",h+b);d.inArray("x",e)&&a.set("width",i+c);a.fire("resize")});a.on("destroy",function(){f.destroy();c.remove()})}});return b},{requires:["editor","dd"]});
