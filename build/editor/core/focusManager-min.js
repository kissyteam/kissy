...
add:function(a){var b=j._4e_getWin(a.get("document")[0]);e.on(b,"focus",g,a);e.on(b,"blur",h,a)},register:function(a){c[a._UUID]=a},remove:function(a){delete c[a._UUID];var b=j._4e_getWin(a.get("document")[0]);e.remove(b,"focus",g,a);e.remove(b,"blur",h,a)}},k=!0,l=!1,m=null;b.refreshAll=b.refreshAll;i.focusManager=b;i.getInstances=function(){return c};return b},{requires:["./base","./dom"]});
