...
customLink:{value:[]},prefixCls:{value:"ke-"}}},{xclass:"editor"});c.HTML_PARSER={textarea:function(a){return a.one(".ks-editor-textarea")}};d.mix(c,d.EventTarget);return KISSY.Editor=c},{requires:["htmlparser","component","core"]});
