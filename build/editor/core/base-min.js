...
customLink:{value:[]}}},{xclass:"editor"});a.HTML_PARSER={textarea:function(a){return a.one("."+this.get("prefixCls")+"editor-textarea")}};b.mix(a,b.EventTarget);return KISSY.Editor=a},{requires:["htmlparser","component","core"]});
