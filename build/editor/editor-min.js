...
function(){for(var a=0;a<f.length;a++)b.usePlugin(f[a]);g&&g.call(b);h||(b.setData(e.val()),c.focus?b.focus():(a=b.getSelection())&&a.removeAllRanges(),h=n)},{global:d})})});return b};b.use=b.use;b.Config.base=d.Config.base;b.Config.debug=d.Config.debug;b.Config.componentJsName=g;b.init(e)}var l=a.DOM,n=!0,m=!1,g;g=1.2>parseFloat(a.version)?function(){return"plugin-min.js?t="+encodeURIComponent("2012-07-16 13:51:46")}:function(a,c){return a+"/plugin-min.js"+(c?c:"?t="+encodeURIComponent("2012-07-16 13:51:46"))};
